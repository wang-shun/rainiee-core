 ...
 */
@Right(id = "P2P_C_FINANCE_ADVANCELIST", moduleId = "P2P_C_FUYOU_DFDZGL", order = 0, name = "垫付对账")
public class DfdzList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TbdzEntity> result = manage.search(new TbdzCond()
        {
            ...
            {
                return OrderType.ADVANCE.toString();
            }
