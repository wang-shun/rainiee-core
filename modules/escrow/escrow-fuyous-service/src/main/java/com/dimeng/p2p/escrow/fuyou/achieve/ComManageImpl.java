...
public class ComManageImpl extends AbstractEscrowService implements ComManage
{
        ...
        throws Throwable
    {
        ...
        try (Connection connection = getConnection())
        {
            ...
            try (PreparedStatement pstmt = connection.prepareStatement(stb.toString()))
            {
                ...
                if (selectAccountNO(connection, record.getMobileNo()))
                {
        ...
        throws SQLException, Throwable
    {
        ...
        try (Connection connection = getConnection())
        {
            ...
            try
            {
                ...
                updateT6110(connection, email, userId, mobile_no);
                // 更新 T6118 用户安全认证
                updateT6118(connection, userId, mobile_no, email);
                ...
                insertT6114(connection,
                    ...
                    retMap.get("cust_nm")); //用企业名
                
                //更新T6164 企业联系信息
                updateT6164(connection, userId, mobile_no);
                // 更新T6165 企业账号审核状态
        ...
        throws Throwable
    {
            ...
            try (ResultSet rs = pstmt.executeQuery())
            {
                if (rs.next())
                {
                    try (PreparedStatement ps =
                        connection.prepareStatement("UPDATE S61.T6165 SET F02 = 'Y', F04 = CURRENT_TIMESTAMP()  WHERE F01 = ? "))
                    {
                        ps.setInt(1, F01);
                        ps.execute();
                    }
        ...
        try (PreparedStatement pstmts =
            connection.prepareStatement("INSERT INTO S61.T6165 SET F01 = ?, F02 = 'Y', F04 = CURRENT_TIMESTAMP() "))
        {
            pstmts.setInt(1, F01);
            pstmts.execute();
        }
        ...
        throws Throwable
    {
        ...
        try (PreparedStatement pstmts =
            connection.prepareStatement("INSERT INTO S61.T6114 SET F02 = ?, "
                ...
                + "F07 = ?, F08 = 'QY', F09 = CURRENT_TIMESTAMP(), F10 = 'TG',F11= ?,F12= 2"))
        {
            pstmts.setInt(1, F02);
     ...
     * @throws SQLException
     */
    private void updateT6110(Connection connection, String email, int F01, String mobile)
        throws SQLException
    {
        try (PreparedStatement ps =
     ...
     * @throws SQLException
     */
    private void updateT6164(Connection connection, int userId, String mobile)
        throws SQLException
    {
        try (PreparedStatement ps = connection.prepareStatement("UPDATE S61.T6164 SET F06 = ?  WHERE F01 = ? "))
        {
            ps.setString(1, mobile);
            ps.setInt(2, userId);
            ps.execute();
     ...
     * @throws SQLException
     */
    private void updateT6118(Connection connection, int userId, String mobile, String email)
        throws SQLException
    {
        try (PreparedStatement pstmt =
            connection.prepareStatement("UPDATE S61.T6118 SET F02 = 'TG', F06 = ?, F07 = ? WHERE F01 = ?"))
        {
        ...
        throws Throwable
    {
        ...
        if (params != null && params.size() > 0)
        {
            ...
            //法人姓名
            paramMap.put("artif_nm", params.get("artif_nm"));
            //开户行支行名称
