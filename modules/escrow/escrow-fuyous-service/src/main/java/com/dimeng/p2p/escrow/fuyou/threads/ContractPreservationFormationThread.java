 ...
 * 修改时间:  2016年6月23日
 */
package com.dimeng.p2p.escrow.fuyou.threads;
    ...
    public void run()
    {
        try (ServiceSession serviceSession = resourceProvider.getResource(ServiceProvider.class).createServiceSession())
        {
            ...
            try
            {
                ...
                if (null == t6271s || t6271s.length <= 0)
                {
                    contractPreservationManage.insertT6271(bidId);
                    t6271s = contractPreservationManage.getT6271s(bidId);
                }
                /*web工程路径*/
                ...
                for (T6271 t6271 : t6271s)
                {
                    ...
                    //  t6271.F04 = (String)valueMap.get("xy_no"); //对于电子合同，合同号都要唯一，在添加T6271时，生成合同号
                    String bidFilePathName = valueMap.get("xy_no_file") + "";
                    ...
                    String path =
                        pdfFormationExecutor.createHTML(valueMap,
                            ...
                            sb.toString(),
                            charset,
                            StringHelper.isEmpty(bidFilePathName) ? t6271.F04 : bidFilePathName);
