 ...
 */
@Right(id = "P2P_C_FINANCE_BIDQUERY", moduleId = "P2P_C_FUYOU_BIDDZGL", order = 1, name = "投标对账操作")
public class BidQuery extends AbstractDzglServlet
{
    ...
    protected void processPost(HttpServletRequest request, HttpServletResponse response, ServiceSession serviceSession)
        throws Throwable
    {
        logger.info("投标对账——IP:" + request.getRemoteAddr());
