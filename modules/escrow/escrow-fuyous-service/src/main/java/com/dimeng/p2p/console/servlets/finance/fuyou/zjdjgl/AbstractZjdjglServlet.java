package com.dimeng.p2p.console.servlets.finance.fuyou.zjdjgl;
...
public abstract class AbstractZjdjglServlet extends AbstractFuyouServlet
{
    
    protected static final Logger logger = Logger.getLogger(AbstractZjdjglServlet.class);
