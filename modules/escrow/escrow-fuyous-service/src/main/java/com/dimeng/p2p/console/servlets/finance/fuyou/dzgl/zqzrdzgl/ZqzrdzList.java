 ...
 */
@Right(id = "P2P_C_FINANCE_BID_ZQZRLIST", moduleId = "P2P_C_FUYOU_ZQZRDZGL", order = 0, name = "债权转让对账")
public class ZqzrdzList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TbdzEntity> result = manage.search(new TbdzCond()
        {
            ...
            {
                return OrderType.BID_EXCHANGE.toString();
            }
