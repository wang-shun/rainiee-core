 ...
 */
@Right(id = "P2P_C_FINANCE_GYBLIST", moduleId = "P2P_C_FUYOU_GYBDZGL", order = 0, name = "公益捐款对账")
public class GybdzList extends AbstractDzglServlet
{
    /**
     * 注释内容
     */
        ...
        throws Throwable
    {
        ...
        PagingResult<TbdzEntity> result = manage.search(new TbdzCond()
        {
            ...
            {
                return OrderType.GYBTRANSFER.toString();
            }
