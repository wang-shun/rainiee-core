 ...
 */
@Right(id = "P2P_C_FINANCE_SPGM_LIST", moduleId = "P2P_C_FUYOU_SPGM_DZGL", order = 0, name = "商品购买对账")
public class MallBuydzList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TbdzEntity> result = manage.search(new TbdzCond()
        {
            ...
            {
                return OrderType.MALLTRANSFER.toString();
            }
