 ...
 * 修改时间:  2015年11月18日
 */
@Right(id = "P2P_C_FINANCE_BID_REPAYMENTLIST", moduleId = "P2P_C_FUYOU_HKDZGL", order = 0, name = "还款对账")
public class HkdzList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TbdzEntity> result = manage.search(new TbdzCond()
        {
            ...
            {
                return OrderType.BID_REPAYMENT.toString();
            }
