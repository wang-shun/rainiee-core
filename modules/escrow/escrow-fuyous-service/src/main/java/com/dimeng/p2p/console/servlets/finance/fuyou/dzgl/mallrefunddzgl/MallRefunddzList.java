 ...
 */
@Right(id = "P2P_C_FINANCE_SPTK_LIST", moduleId = "P2P_C_FUYOU_SPTK_DZGL", order = 0, name = "商品退款对账")
public class MallRefunddzList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TbdzEntity> result = manage.search(new TbdzCond()
        {
            ...
            {
                return OrderType.MALLREFUND.toString();
            }
