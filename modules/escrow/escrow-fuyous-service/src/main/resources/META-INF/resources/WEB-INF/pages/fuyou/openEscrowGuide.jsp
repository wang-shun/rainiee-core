...
<%@page import="com.dimeng.p2p.escrow.fuyou.entity.OpenEscrowGuideEntity"%>
...
<script type="text/javascript" src="<%=controller.getStaticPath(request)%>/js/fuyou/openEscrowGuide.js"></script>
...
<script type="text/javascript">
	...
	<%--入后台前，校验实名与手机号--%>
	var _escrowCheckUrl = "<%=controller.getStaticPath(request)%>/fuyou/openEscrowGuideCheck.htm";
	<%--获取TOKEN的NAME--%>
