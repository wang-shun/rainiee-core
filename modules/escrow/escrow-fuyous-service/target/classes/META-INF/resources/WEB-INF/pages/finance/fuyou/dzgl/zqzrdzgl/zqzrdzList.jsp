...
<%@page import="com.dimeng.p2p.console.servlets.finance.fuyou.dzgl.zqzrdzgl.ZqzrQuery"%>
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, ZqzrdzList.class)%>" method="post" name="form1" id="form1">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>债权转让对账
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="tc">
                                    	<% if ("S".equals(zqzrdz.F11.name())) { %>
                                   			已对账
                                   		<%} else { if (dimengSession.isAccessableResource(ZqzrQuery.class)) { %>
...
<script type="text/javascript">
		function zdOrderNo(orderNo){
			$.ajax({
				type:"post",
				url:"/console/finance/fuyou/dzgl/zqzrdzgl/zqzrQuery.htm?orderNo=" + escape(orderNo),
