...
<form action="<%=controller.getURI(request, FyouChangeCard.class)%>" class="form1" method="post" autocomplete="off">
    <div class="clear"></div>
    <div class="dialog bank_dialog" style="top:0px;width:700px;height: 550px;margin-left:-351px">
        <div class="title">申请更换银行卡</div>
        <div class="content"   style="max-height: 520px; overflow-y: auto;">
            <ul class="text_list">
                <li>
                    ...
                    <div class="con"><span class="red"></span>
                        ...
                        <select name="type" id="type" class="select_style jy_w1">
                        	 <option value="2"><%=data.qyName %> </option>
                ...
                <li>
                    ...
                    <div class="con"><input type="text" name="banknumber" id="textfield2"
                                            class="text_style border  required textv-a max-length-30"
                ...
                <li>
                    ...
                    <div class="con"><input type="text" name="cbanknumber" onpaste="return false" id="textfield4"
                                            class="text_style border  required textv-b"
                                            onkeyup="this.value=this.value.replace(/\D/g,'').replace(/....(?!$)/g,'$& ')"/>
            ...
            <div class="prompt_mod mt20 mb30">
                ...
                2.审核通过则启动新卡，审核未通过则依使用原卡，在此期间用户可查询换卡情况。<br>
