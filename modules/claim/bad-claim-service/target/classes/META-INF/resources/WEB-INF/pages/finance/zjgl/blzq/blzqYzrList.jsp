...
<%@page import="com.dimeng.p2p.console.servlets.finance.zjgl.blzq.ExportBlzqYzr" %>
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" name="form1" action="<%=controller.getURI(request, BlzqYzrList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>已转让
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                   <li><span class="display-ib mr5">债权编号： </span>
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(ExportBlzqYzr.class)) {%>
                                ...
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <%if (dimengSession.isAccessableResource("P2P_C_LOAN_VIEWPROJECT")) {%>
                                            <a href="/console/bid/loanmanage/jkgl/viewProject.htm?loanId=<%=badClaimYzr.bidId%>&userId=<%=badClaimYzr.userId%>&operationJK=BLZQYZR"
                                    ...
                                    %>
                                    <tr>
                                        <td colspan="16" class="tc">暂无数据</td>
                                    </tr>
                                    <%} %>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, ExportBlzqYzr.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, BlzqYzrList.class)%>";
    }
