...
%>
<%if (s != 1) { %>
<p class="clearfix pt10"><a target="_blank" href="<%=controller.getURI(request, BlzqzrAgreement.class)%>?id=<%=zqzrjlId%>&zqId=<%=zqId %>&s=1"
...
<%
    ...
    Dzxy dzxy = manage.getBlzqzr(zqzrjlId,zqId,"front");
    if (dzxy == null) {
