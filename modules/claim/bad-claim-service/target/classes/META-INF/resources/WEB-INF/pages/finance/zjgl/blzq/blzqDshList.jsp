...
<%@page import="com.dimeng.p2p.console.servlets.finance.zjgl.blzq.ExportBlzqDsh" %>
...
<%
    ...
    PagingResult<BadClaimDsh> badClaimDshs = (PagingResult<BadClaimDsh>) request.getAttribute("badClaimDshPagingResult");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" name="form1" action="<%=controller.getURI(request, BlzqDshList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>待审核
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(ExportBlzqDsh.class)) {%>
                                ...
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <%if (dimengSession.isAccessableResource("P2P_C_LOAN_VIEWPROJECT")) {%>
                                            <a href="/console/bid/loanmanage/jkgl/viewProject.htm?loanId=<%=badClaimDsh.bidId%>&userId=<%=badClaimDsh.userId%>&operationJK=BLZQDSH"
                                               class="link-blue">查看</a>
                                        <%} else {%>
                                            <a href="javascript:void(0)" class="disabled">查看</a>
                                        <%}%>    
                                        <%if (dimengSession.isAccessableResource(BlzqCheck.class)) {%>
                                            <a href="<%=controller.getURI(request, BlzqCheck.class)%>?id=<%=badClaimDsh.id%>"  class="link-blue">审核</a>
                                        <%} else { %>
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, ExportBlzqDsh.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, BlzqDshList.class)%>";
    }
