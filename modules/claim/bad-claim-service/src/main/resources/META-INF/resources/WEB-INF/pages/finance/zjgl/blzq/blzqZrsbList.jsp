...
<%@page import="com.dimeng.p2p.console.servlets.finance.zjgl.blzq.ExportBlzqZrsb" %>
...
<%
    ...
    PagingResult<BadClaimDsh> badClaimDshs = (PagingResult<BadClaimDsh>) request.getAttribute("badClaimZrsbPagingResult");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" name="form1" action="<%=controller.getURI(request, BlzqZrsbList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>转让失败
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(ExportBlzqZrsb.class)) {%>
                                ...
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <%if (dimengSession.isAccessableResource("P2P_C_LOAN_VIEWPROJECT")) {%>
                                            <a href="/console/bid/loanmanage/jkgl/viewProject.htm?loanId=<%=badClaimDsh.bidId%>&userId=<%=badClaimDsh.userId%>&operationJK=BLZQZRSB"
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, ExportBlzqZrsb.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, BlzqZrsbList.class)%>";
    }
