...
public class ExportBlzqZrz extends AbstractBadClaimServlet
{
    
    /**
     * 注释内容
     */
    private static final long serialVersionUID = 7297302512071383451L;
        ...
        throws Throwable
    {
        ...
        PagingResult<BadClaimDsh> result = badClaimTransferManage.badClaimDshSearch(zrzQuery, paging);
        badClaimTransferManage.exportBlzqZrz(result.getItems(), response.getOutputStream(), "");
    }
}
