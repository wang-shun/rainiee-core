 ...
 */
@Right(id = "P2P_C_FINANCE_BLZQYZRLIST", name = "已转让", moduleId = "P2P_C_FINANCE_BLZQZRGL", order = 0)
public class BlzqYzrList extends AbstractBadClaimServlet
{
    
    /**
     * 注释内容
     */
    private static final long serialVersionUID = -8377273794235959075L;
        ...
        throws Throwable
    {
        ...
        forwardView(request, response, BlzqYzrList.class);
    }
