...
public class ExportBlzqDsh extends AbstractBadClaimServlet
{
    
    /**
     * 注释内容
     */
    private static final long serialVersionUID = -4308652218187429499L;
        ...
        throws Throwable
    {
        ...
        PagingResult<BadClaimDsh> result = badClaimTransferManage.badClaimDshSearch(dshQuery, paging);
        badClaimTransferManage.exportBlzqDsh(result.getItems(), response.getOutputStream(), "");
    }
}
