 ...
 */
@Right(id = "P2P_C_FINANCE_BLZQDSHLIST", name = "待审核", moduleId = "P2P_C_FINANCE_BLZQZRGL", order = 0)
public class BlzqDshList extends AbstractBadClaimServlet
{
    
    /**
     * 注释内容
     */
    private static final long serialVersionUID = -3519463181468112245L;
        ...
        throws Throwable
    {
        ...
        PagingResult<BadClaimDsh> badClaimDshPagingResult = badClaimTransferManage.badClaimDshSearch(dshQuery, paging);
        request.setAttribute("badClaimDshPagingResult", badClaimDshPagingResult);
        forwardView(request, response, BlzqDshList.class);
    }
