 ...
 */
@Right(id = "P2P_C_FINANCE_BLZQZRSBLIST", name = "转让失败", moduleId = "P2P_C_FINANCE_BLZQZRGL", order = 0)
public class BlzqZrsbList extends AbstractBadClaimServlet
{
    
    /**
     * 注释内容
     */
    private static final long serialVersionUID = 515627462867350602L;
        ...
        throws Throwable
    {
        ...
        PagingResult<BadClaimDsh> badClaimZrsbPagingResult =
            badClaimTransferManage.badClaimZrsbSearch(dshQuery, paging);
        request.setAttribute("badClaimZrsbPagingResult", badClaimZrsbPagingResult);
        forwardView(request, response, BlzqZrsbList.class);
    }
