 ...
 * 
 */
public abstract class AbstractRankServlet extends AbstractServlet {
	protected static final Logger logger = Logger.getLogger(AbstractRankServlet.class);
	...
	static {
		...
		COMMON_KAPTCHA_PRODUCER = new com.google.code.kaptcha.util.Config(props).getProducerImpl();
	}
