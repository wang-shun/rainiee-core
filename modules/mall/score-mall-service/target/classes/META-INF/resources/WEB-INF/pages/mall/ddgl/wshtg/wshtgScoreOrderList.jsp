...
<%@page import="com.dimeng.p2p.console.servlets.mall.ddgl.wshtg.ExportWshtgDD" %>
<%@page import="com.dimeng.p2p.console.servlets.mall.ddgl.wshtg.WshtgScoreOrderList" %>
<%@page import="com.dimeng.p2p.console.servlets.mall.ddgl.wshtg.WshtgOrderDetails" %>
...
<div class="right-container">
    <div class="viewFramework-body">
      ...
      <form id="form1" action="<%=controller.getURI(request, WshtgScoreOrderList.class)%>" method="post">
		<div class="p20">
			<div class="border">
			    <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>未审核通过</div>
			    <div class="content-container pl40 pt30 pr40">
			      <ul class="gray6 input-list-container clearfix">
			        ...
			        <li><span class="display-ib mr5">审核时间</span>
			          <input type="text" name="shStartTime" readonly="readonly" id="datepicker1" class="text border pl5 w120 date" />
			          <span class="pl5 pr5">至</span>
			          <input readonly="readonly" type="text" name="shEndTime" id="datepicker2" class="text border pl5 w120 mr20 date" />
			        </li>
			        ...
			        <li> <a href="javascript:onSubmit();" class="btn btn-blue radius-6 mr5 pl1 pr15"><i class="icon-i w30 h30 va-middle search-icon "></i>搜索</a></li>
                      <li>
                          <%
                              if (dimengSession.isAccessableResource(ExportWshtgDD.class)) {
                          %>
			    ...
			    <table class="table table-style gray6 tl">
			      ...
			      <tbody class="f12">
                     ...
                     <tr class="tc">
                          ...
                          <td>
                          <%if(dimengSession.isAccessableResource(WshtgOrderDetails.class)){ %>
...
function onSubmit(){
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, ExportWshtgDD.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, WshtgScoreOrderList.class)%>";
    }
    ...
    function showData(scoreOrderId)
    {
        ...
        var ajaxUrl  = "<%=controller.getURI(request, WshtgOrderDetails.class)%>";
