/*
 * 文 件 名:  AbstractMallServlet.java
 * 版    权:  深圳市迪蒙网络科技有限公司
 * 描    述:  <描述>
 * 修 改 人:  zhoucl
 * 修改时间:  2015年12月17日
 ...
 */
public abstract class AbstractMallServlet extends AbstractServlet
{
    ...
    public static void rendPaging(JspWriter out, PagingResult<?> paging,
        ...
        if(paging.getPageCount() > 1){
            out.print("到<input type=\"text\"  id=\"goPage\" class=\"page_input\" maxSize="+paging.getPageCount()+" maxlength=\"7\">页<input type=\"button\"  class=\"btn_ok\" value=\"确定\" onclick=\"goPageSubmit(this,'"
                    + pagingPath + "');\" />");
        }
        out.print("</div>");
    }
