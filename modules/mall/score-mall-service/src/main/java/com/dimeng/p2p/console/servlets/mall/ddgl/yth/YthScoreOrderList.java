 ...
 */
@Right(id = "P2P_C_MALL_YTHSCOREORDERLIST", isMenu = true, name = "已退货", moduleId = "P2P_C_MALL_DDGL_YTH", order = 0)
public class YthScoreOrderList extends AbstractMallServlet
{
