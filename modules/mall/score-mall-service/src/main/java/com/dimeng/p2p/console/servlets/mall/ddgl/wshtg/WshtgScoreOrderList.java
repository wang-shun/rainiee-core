 ...
 */
@Right(id = "P2P_C_MALL_WSHTGSCOREORDERLIST", isMenu = true, name = "未审核通过",moduleId="P2P_C_MALL_DDGL_WSHTG",order=0)
public class WshtgScoreOrderList extends AbstractMallServlet
{
