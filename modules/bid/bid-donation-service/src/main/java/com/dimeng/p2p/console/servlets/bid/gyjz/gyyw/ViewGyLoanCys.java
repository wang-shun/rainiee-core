 ...
 */
public class ViewGyLoanCys extends AbstractDonationServlet
{
        ...
        throws Throwable
    {
        ...
        request.setAttribute("content", info.t6243.F02);
            ...
            try {
                ...
                if (flag == 1 ) {
                    ...
                    sendRedirect(request, response,
                            getController().getURI(request, GyLoanList.class));
