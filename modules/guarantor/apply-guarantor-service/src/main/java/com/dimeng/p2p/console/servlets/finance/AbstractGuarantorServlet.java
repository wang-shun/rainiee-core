 ...
 * 修改时间: 2016/4/23
 */
package com.dimeng.p2p.console.servlets.finance;
 ...
 */
public class AbstractGuarantorServlet extends AbstractServlet {
    protected static final Logger logger = Logger.getLogger(AbstractGuarantorServlet.class);
