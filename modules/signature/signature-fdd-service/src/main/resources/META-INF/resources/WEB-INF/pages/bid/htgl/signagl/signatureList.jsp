...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form2" action="<%=controller.getURI(request, SignatureList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">未签名<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                    <li><a href="<%=controller.getURI(request, YqmSignatureList.class)%>" class="tab-btn ">已签名</a>
                                    </li>
                                </ul>
                            </div>
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <td align="center">
                                        	<%if(dzqm.F10 == T6273_F10.JKR){ %>
                                        	<%--借款人不能在后台签名 --%>
                                        	<a href="javascript:void(0);"
                                               class="disabled">签名</a>
                                        	<%}else{ %>
                                             <!-- target="_blank" -->
                                           <a   href="<%=configureProvider.format(FddVariable.FDD_EXTSIGN_AUTO_URL) %>?qmId=<%=dzqm.qmId %>&t=qm"
                                               class="link-blue">签名</a>
                                            <%} %>
                                        </td>
                                    </tr>
                                    <%
...
<%
	...
	if (StringHelper.isEmpty(warringMessage)){
	    warringMessage = controller.getPrompt(request, response, PromptLevel.ERROR);
	}
    if (!StringHelper.isEmpty(warringMessage)) {
%>
<script type="text/javascript">
