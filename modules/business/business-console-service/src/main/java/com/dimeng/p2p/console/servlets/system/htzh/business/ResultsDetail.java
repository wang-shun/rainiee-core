...
public class ResultsDetail extends AbstractBuisnessServlet {
        ...
        throws Throwable
    {
        ...
        request.setAttribute("chargeTotalAmount", map.get("chargeTotalAmount"));
        request.setAttribute("withdrawTotalAmount", map.get("withdrawTotalAmount"));
        forwardView(request, response, ResultsDetail.class);
    }
