...
function showBankCard(){
	var formDiv = "<form id='form1' action='' class='form1' method='post' autocomplete='off'>";
        ...
        formDiv += "</li>";
        formDiv += "<li>";
        formDiv += "<div class='til'><span class='red'>*</span>银行预留手机号：</div>";
        formDiv += "<div class='con'>";
        formDiv += "<input type='text' name='phoneNO' id='textfield' class='text_style border  required max-length-11 fl'/>";
        formDiv += "<p tip></p>";
        formDiv += "<p errortip class='' style='display: none'></p>";
        formDiv += "</div>";
        formDiv += " </li>";
