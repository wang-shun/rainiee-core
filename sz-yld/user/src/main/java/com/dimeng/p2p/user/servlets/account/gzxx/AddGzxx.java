...
public class AddGzxx extends AbstractAccountServlet{
	...
	protected void processPost(HttpServletRequest request,
		...
		sendRedirect(request, response, getController().getViewURI(request, UserBases.class)+"?userBasesFlag=3");
	}
        ...
        throws ServletException, IOException
    {
        ...
        if (throwable instanceof ParameterException || throwable instanceof SQLException)
        {
            ...
            sendRedirect(request, response, getController().getURI(request, AddGzxx.class));
        }
