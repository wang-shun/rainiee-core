...
@PagingServlet(itemServlet = Tbzdzq.class)
public class Tbzdzq extends AbstractFinancingServlet
{
        ...
        throws Throwable
    {
        ...
        //得到查询结果
        PagingResult<com.dimeng.p2p.modules.bid.user.service.entity.Tbzdzq> result = wdzqManage.getLoanAssests(paging);
        ...
        jsonMap.put("tbzdzqList", result.getItems());
