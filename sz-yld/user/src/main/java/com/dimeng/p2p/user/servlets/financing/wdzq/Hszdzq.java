...
@PagingServlet(itemServlet = Hszdzq.class)
public class Hszdzq extends AbstractFinancingServlet
{
    /**
     * 
     */
        ...
        throws Throwable
    {
        ...
        String pageStr = this.rendPaging(result);//wdzqManage.rendPaging(result);
        Map<String, Object> jsonMap = new HashMap<String, Object>();
        jsonMap.put("pageStr", pageStr);
        jsonMap.put("pageCount", result.getPageCount());
        jsonMap.put("hszdzqList", result.getItems());
