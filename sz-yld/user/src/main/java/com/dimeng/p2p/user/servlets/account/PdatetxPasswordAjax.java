...
public class PdatetxPasswordAjax extends AbstractAccountServlet
{
        ...
        throws Throwable
    {
        ...
        String mtest =
            configureProvider.getProperty(SystemVariable.NEW_TXPASSWORD_REGEX).substring(1,
                configureProvider.getProperty(SystemVariable.NEW_TXPASSWORD_REGEX).length() - 1);//"^[a-zA-Z](?![a-zA-Z]*$)[a-zA-Z0-9]{7}$";
