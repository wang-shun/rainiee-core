...
public class AddCcxx extends AbstractAccountServlet{
	...
	protected void processPost(HttpServletRequest request,
		...
		sendRedirect(request, response, getController().getViewURI(request, UserBases.class)+"?userBasesFlag=5");
	}
        ...
        throws ServletException, IOException
    {
        ...
        if (throwable instanceof ParameterException || throwable instanceof SQLException)
        {
            ...
            sendRedirect(request, response, getController().getURI(request, AddCcxx.class));
        }
