...
public class VerifyCommon extends AbstractUserServlet
{
        ...
        throws Throwable
    {
        ...
        else if ("tsjy".equals(verifyType))
        {
            type = "TSJY"; //提交投诉建议
        }
        else if ("updateSecurity".equals(verifyType))
        {
            type = "UPDATE_SECURITY"; //找回密保问题：验证手机
        }
