...
public class AddQyFcxx extends AbstractAccountServlet
{
        ...
        throws Throwable
    {
        ...
        sendRedirect(request, response, getController().getViewURI(request, QyBases.class) + "?qyBasesFlag=6");
    }
        ...
        throws ServletException, IOException
    {
        ...
        if (throwable instanceof ParameterException || throwable instanceof SQLException)
        {
            ...
            sendRedirect(request, response, getController().getURI(request, AddQyFcxx.class));
        }
