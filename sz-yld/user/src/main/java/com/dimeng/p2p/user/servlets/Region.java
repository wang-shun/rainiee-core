...
public class Region extends AbstractUserServlet
{
        ...
        throws Throwable
    {
        ...
        writer.write("width: 105,");
        writer.write("optionHeight: 28,");
        writer.write("height: 28,");
        ...
        writer.write("city_data = region[i].children;");
        writer.write("if (city_data.length > 0) {");
        writer.write("sheng.after(\"<select name='shi' id='shi' class=' select6' ></select>\");");
        ...
        writer.write("area_data = city_data[i].children;");
        writer.write("if (area_data.length > 0) {");
        writer.write("shi.after(\"<select name='xian' id='xian' class='required select6'></select>\");");
