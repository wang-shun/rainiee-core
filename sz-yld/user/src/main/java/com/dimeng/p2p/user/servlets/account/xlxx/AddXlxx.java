...
public class AddXlxx extends AbstractAccountServlet{
	...
	protected void processPost(HttpServletRequest request,
		...
		manage.addXlxx(entity);
        sendRedirect(request, response, getController().getViewURI(request, UserBases.class)+"?userBasesFlag=2");
	}
        ...
        throws ServletException, IOException
    {
        ...
        if (throwable instanceof ParameterException || throwable instanceof SQLException)
        {
            ...
            sendRedirect(request, response, getController().getURI(request, AddXlxx.class));
        }
