                    ...
                    <div class="til clearfix Men_bt">
                        ...
                        <div class="Menubox">
                            <ul>
                                ...
                                <li>
                                    <a href="<%=controller.getViewURI(request, com.dimeng.p2p.user.servlets.financing.tyjlc.Cyztyj.class)%>">持有中的体验金投资</a>
                                </li>
                                <li style="border-right:1px #d7dfe3 solid;" class="hover">已截止的体验金投资</li>
                            </ul>
                        </div>
                    </div>
                    <form action="<%=controller.getViewURI(request, com.dimeng.p2p.user.servlets.financing.tyjlc.Yjztyj.class)%>"
                          method="post">
                        <div class="bs_bg pt10">
                            <div class="no_table user_bolr bot">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="user_table tc">
                                    ...
                                    <%
                                        PagingResult<MyExperience> raList = service.searMyExperience("YJZ", paging);
                                        int index = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td><%=Formater.formatDate(myExperience.F06)%>
                                        </td>
                                    </tr>
                                    <%
                                            }
                            ...
                            <div class="page"><%AbstractFinancingServlet.rendPagingResult(out, raList); %></div>
                        </div>
                    </form>
                    <div class="clear"></div>
                </div>
