                            ...
                            <div class="no_table user_bolr bot">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="user_table tc">
                                    ...
                                    <tr>
                                        <td>
                                            <a class="blue"
                                               href="<%configureProvider.format(out, URLVariable.FINANCING_YX_XQ); %><%=sbf.planId + rewriter.getViewSuffix()%>">
                                                <%StringHelper.filterHTML(out, sbf.name); %>
                                            </a>
                                        </td>
                                        <td><%=Formater.formatAmount(sbf.addMoney) %>元</td>
                                        <td><%=Formater.formatRate(sbf.rate) %>
                                        </td>
                                        <td><%=sbf.jkTime %>
                                        </td>
                                        ...
                                        <td><a target="_blank"
                                               href="<%=controller.getViewURI(request, com.dimeng.p2p.user.servlets.financing.agreement.Yxlc.class) %>?id=<%=sbf.planId %>">合同</a>
                                        </td>
                                    </tr>
                                    <%
                                            }
