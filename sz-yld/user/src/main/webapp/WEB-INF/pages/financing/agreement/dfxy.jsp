...
<%@page import="com.dimeng.p2p.user.servlets.financing.agreement.Dfxy"%>
...
<%
    ...
    Map<String, Object> valueMap = contractMng.getAdvanceContentMap(bId, serviceSession.getSession().getAccountId());
    if (null == valueMap) {
...
<%
    if (s != 1) {
%>
<p class="clearfix pt10"><a target="_blank" href="<%=controller.getURI(request, Dfxy.class)%>?id=<%=bId%>&s=1"
