        ...
        <div class="r_main">
            <div class="user_mod">
                <div id="con_one_1" class="p25">
                    <form action="<%=controller.getURI(request, ByjCharge.class)%>" method="post"
                          onsubmit="return onSubmit();">
                        <div class="gray3 f16">填写转入保证金金额</div>
                        <div class="user_mod_gray mt10 pt30 pb30">
                            <div class="form_info topup_form">
                                <ul class="cell">
                                    ...
                                    <li>
                                        <div class="til">
                                            <span class="red">*</span>转入金额：
                                        </div>
                                        <div class="info">
                                            <input onkeyup="return onlyNumber(this);" id="amount" name="amount" type="text" class="text fl mr5"
