    ...
    <div class="about">
        ...
        <div class="container fr">
            <div class="p15">
                ...
                %>
                <div class="tj_lsbg f20 mb40">您在<%configureProvider.format(out, SystemVariable.SITE_NAME); %>
                    总计借款 <%=Formater.formatAmount(creditTotal.total) %>
                    元，总计需支付 <%=Formater.formatAmount(creditTotal.totalPay) %>
                    元的利息和费用
                </div>
                <div class="mb40">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr class="ta_dls">
                            <td>借款利息</td>
                            <td><%=Formater.formatAmount(creditTotal.accMoney) %>
                            </td>
                        </tr>
                        <tr class="ta_dhs">
                            <td>逾期费用</td>
                            <td><%=Formater.formatAmount(creditTotal.arrMoney) %>
                            </td>
                        </tr>
                        <!-- <tr class="ta_dls">
								<td>借款管理费</td>
                        ...
                        <tr class="ta_dls">
                            <td>总计</td>
                            <td><%=Formater.formatAmount(allTotal) %>
                            </td>
                        </tr>
                    </table>
                    <div class="fr">
                ...
                <div class="tj_lsbg f20 mb40">您在<%configureProvider.format(out, SystemVariable.SITE_NAME); %>
                    的借款待还总额为 <%=Formater.formatAmount(notPayCreditTotal.notPayTotal) %>元
                </div>
                <div class="mb40">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                           class="fl tj_table">
                        <tr class="ta_dls">
                            <td>待还本金</td>
                            <td><%=Formater.formatAmount(notPayCreditTotal.notPayMoney) %>
                            </td>
                        </tr>
                        <tr class="ta_dhs">
                            <td>待还利息</td>
                            <td><%=Formater.formatAmount(notPayCreditTotal.notPayAccMoney) %>
                            </td>
                        </tr>
                        <tr class="ta_dls">
                            <td>待还逾期费用</td>
                            <td><%=Formater.formatAmount(notPayCreditTotal.notPayArrMoney) %>
                            </td>
                        </tr>
                        <!-- <tr class="ta_dhs">
								<td>待还借款管理费</td>
								<td><%=Formater.formatAmount(notPayCreditTotal.notPayManageMoney) %></td>
							</tr> -->
                        <tr class="ta_dhs">
                            <td>总计</td>
                            <td><%=Formater.formatAmount(notPayCreditTotal.notPayTotal) %>
                            </td>
                        </tr>
                    </table>
                    <div class="fr">
                ...
                <div class="tj_lsbg f20 mb40">您在<%configureProvider.format(out, SystemVariable.SITE_NAME); %>
                    的借款已还总额为 <%=Formater.formatAmount(payCreditTotal.payTotalMoney) %> 元
                </div>
                <div class="mb40">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                           class="fl tj_table">
                        <tr class="ta_dls">
                            <td>已还本金</td>
                            <td><%=Formater.formatAmount(payCreditTotal.payMoney) %>
                            </td>
                        </tr>
                        <tr class="ta_dhs">
                            <td>已还利息</td>
                            <td><%=Formater.formatAmount(payCreditTotal.payAccMoney) %>
                            </td>
                        </tr>
                        <tr class="ta_dls">
                            <td>已交逾期费用</td>
                            <td><%=Formater.formatAmount(payCreditTotal.payArrMoney) %>
                            </td>
                        </tr>
                        <!-- <tr class="ta_dhs">
								<td>已交提前还款违约金</td>
								<td><%=Formater.formatAmount(payCreditTotal.payBeforeMoney) %></td>
							</tr> -->
                        <!-- <tr class="ta_dls">
								<td>已交借款管理费</td>
								<td><%=Formater.formatAmount(payCreditTotal.payManageMoney) %></td>
							</tr> -->
                        <tr class="ta_dhs">
                            <td>总计</td>
                            <td><%=Formater.formatAmount(payCreditTotal.payTotalMoney) %>
                            </td>
                        </tr>
                    </table>
                    <div class="fr">
                ...
                %>
                <div class="tj_lsbg f20 mb40">最近一年您在<%configureProvider.format(out, SystemVariable.SITE_NAME); %>
                    成功借款 <%=Formater.formatAmount(manage.getYnjk()) %> 元
                </div>
                <%
                ...
                <div class="mb40">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr class="<%=i%2==0?"ta_dls":"ta_dhs" %>">
                            ...
                            <td><%=Formater.formatAmount(yearCreditTotal.money) %>
                            </td>
                        </tr>
                        <%} %>
                        <tr class="<%=(i+1)%2==0?"ta_dls":"ta_dhs" %>">
                            <td>总计</td>
                            <td><%=Formater.formatAmount(yTotal) %>
                            </td>
                        </tr>
                    </table>
                    <div class="fr">
                ...
                %>
                <div class="tj_lsbg f20 mb40">最近六个月您在<%configureProvider.format(out, SystemVariable.SITE_NAME); %>
                    产生的还款总计为 <%=Formater.formatAmount(manage.getLgyjk()) %> 元
                </div>
                <%
                ...
                <div class="mb40">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr class="<%=i%2==0?"ta_dls":"ta_dhs" %>">
                            ...
                            <td><%=Formater.formatAmount(monthCreditTotal.money) %>
                            </td>
                        </tr>
                        <%} %>
                        <tr class="<%=(i+1)%2==0?"ta_dls":"ta_dhs" %>">
                            <td>总计</td>
                            <td><%=Formater.formatAmount(mTotal) %>
                            </td>
                        </tr>
                    </table>
                    <div class="fr">
