	...
	<div class="w1002 clearfix">
        ...
        <div class="nav fr">
          ...
          <%if(dimengSession == null || !dimengSession.isAuthenticated()){ %> 
            <li><a href="<%configureProvider.format(out, URLVariable.LOGIN);%>">登录</a></li>
            <li class="line"></li>
            <li><a href="<%configureProvider.format(out, URLVariable.REGISTER);%>">免费注册</a></li>
          <%}else{ 
          ...
          <!--已登录-->
            ...
            <%if(userType==T6110_F06.ZRR && is_mall){
             ...
             %>
            <li class="letter"><a href="<%configureProvider.format(out, URLVariable.MALLSHOPPINGCAR_URL);%>"><i class="top_car_ico"></i>购物车<span class="number"><%=carCount > 0 ? carCount : "0" %></span></a></li>
            <li class="line"></li>
            <%} %>
           ...
           <%}%>
            ...
            <li class="line"></li>
            <li><a href="<%configureProvider.format(out, URLVariable.XXPL_BAXX);%>">信息披露</a></li>
            <li class="line"></li>
