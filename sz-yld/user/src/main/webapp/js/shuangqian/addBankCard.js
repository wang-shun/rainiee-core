...
function showBankCard(){
	var formDiv = "<form id='form1' action='' class='form1' method='post' autocomplete='off'>";
		...
		formDiv += "<select name='bankname' id='bankNameDiv' class='select_style jy_w1'>";
        formDiv += "</select>";
        formDiv += "</div>";
        formDiv += "</li>";
        formDiv += "<li>";
        ...
        formDiv += "<div class='con'>";
        formDiv += "<select name='sheng' class='select_style jy_w1' style='width:120px;'>";
        formDiv += "</select>";
        formDiv += "<select name='shi' class='select_style jy_w1 required' style='width:120px;'>";
        formDiv += "</select>";
        formDiv += "<p tip></p>";
        ...
        success: function (data) {
        	if(data != null){
        		if(data.num == '0000'){
        			...
        			//开户名
        			var userNameDiv ="<span class=\"red\"></span>";
        			if(t6110.F06 == "ZRR"){
        				userNameDiv += "<input type=\"hidden\" id=\"userName\" name=\"userName\" value='"+safety.name+"' />";
        				userNameDiv += "<input type=\"hidden\" name=\"type\" value=\"1\"/>"+safety.name;
        			}else{
        				userNameDiv += "<input type=\"hidden\" id=\"userName\" name=\"userName\" value='"+safety.qyName+"' />";
        				userNameDiv += "<input type=\"hidden\" name=\"type\" value=\"2\"/>"+safety.qyName;
        			}
