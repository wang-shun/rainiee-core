define(['text!userTemplate/personal/raise.html',
		'text!userTemplate/personal/raiseList.html',
		'commonClass/scroll/PTRScroll',
], function(raiseTemplate, listTemplate,PTRScroll) {
    var raiseView = DMJS.DMJSView.extend({
        id: 'raiseContent',
        name: 'raiseContent',
        tagName: 'div',
        className: "raiseContent",
        events: {
        ...
        render: function() {
            ...
            self.$el.html(_.template(raiseTemplate,{}));
            ...
            self.raiseList(self.page); 
            return this;
        },
        raiseList:function(page,callBack){
        	var self=this;
        	var __call=function(){
        	...
        	self.controller.userModel.myRewardList({'data':{type:2,pageIndex:page.pageIndex,pageSize:page.pageSize},'cancelLightbox':true,
        	"noCache":true,
