package com.dimeng.p2p.app.utils;
...
public final class CreateDirectoryUtils {
	...
	public static void main(String[] args) throws IOException {
	   ...
	   /* list.add("SubAccntServlet.java");
	    list.add("RSAUtils.java");
	    list.add("trans.jsp");
	    list.add("index.jsp");
	    list.add("web.xml");*/
		
		list.add("NewProbindCommitServlet.java");
		list.add("NewProbindMsgServlet.java");
		list.add("NewProCommitServlet.java");
		list.add("NewProOrderServlet.java");
		list.add("NewProQueryServlet.java");
		list.add("NewProSendmsgServlet.java");
		list.add("NewProQueryListServlet.java");
		list.add("NewProUnbindServlet.java");
		
		list.add("NewProtocolBindXmlBeanReq.java");
		list.add("NewProtocolOrderXmlBeanReq.java");
		list.add("NewProtocolPayXmlBeanReq.java");
		
		list.add("new_protocol_bindCommit.jsp");
		list.add("new_protocol_bindMsg.jsp");
		list.add("new_protocol_commit.jsp");
		list.add("new_protocol_order.jsp");
		list.add("new_protocol_query.jsp");
		list.add("new_protocol_querylist.jsp");
		list.add("new_protocol_sendmsg.jsp");
		list.add("new_protocol_unbind.jsp");
		
		list.add("web.xml");
		list.add("index.jsp");
		
	    list.add("HttpPoster.java");
		
	    list.add("init.properties");
		
		createFinalDirectory(list, "e:/更新包/ms变更20180508");
