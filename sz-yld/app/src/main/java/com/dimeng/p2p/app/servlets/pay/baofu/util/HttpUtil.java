 ...
 *
 */
package com.dimeng.p2p.app.servlets.pay.baofu.util;
...
import com.dimeng.p2p.app.servlets.pay.baofu.http.HttpFormParameter;
import com.dimeng.p2p.app.servlets.pay.baofu.http.HttpMethod;
import com.dimeng.p2p.app.servlets.pay.baofu.http.HttpSendModel;
import com.dimeng.p2p.app.servlets.pay.baofu.http.SimpleHttpClient;
import com.dimeng.p2p.app.servlets.pay.baofu.http.SimpleHttpResponse;
...
public class HttpUtil
{
    ...
    public static SimpleHttpResponse doRequest(HttpSendModel httpSendModel, String getCharSet)
        throws Exception
    {
     ...
     * @throws Exception 
     */
    protected static HttpRequestBase buildHttpRequest(HttpSendModel httpSendModel)
        throws Exception
    {
