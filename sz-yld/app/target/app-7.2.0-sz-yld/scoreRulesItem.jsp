...
.udis{
	...
	<body class="bg-c-gray" >
		<div class="bg-c-withe bd-b pd-b-2">
		    <div class="xm">积分说明</div>
			<div class="ub ">
				<div class="rd ub-f1" id="descItem"></div>
			</div>
			<div class="xm">积分规则</div>
			<div class="ub ">
				<div class="rd ub-f1" id="rulesItem"></div>
			</div>
		</div>
	</body>
	...
	var obj={
		...
		"rulesItem":document.getElementById("rulesItem")
	}
			var sc=document.createElement('script');
			sc.src='<%=url%>'+'/app/user/mall/scoreRules.htm?callback=callback';
			document.body.appendChild(sc);
			function callback(response){
				console.log(response);
				if(!!response&&response.data&&response.code=="000000"){
					var data=response.data;
					obj['descItem'].innerHTML=data.scoreDesc;
					obj['rulesItem'].innerHTML=data.scoreRule;
				}
			}
