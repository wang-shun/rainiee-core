...
%>
<!--investment list-->	
<div class="invest_rec pb40 pt40">
            <div class="invest_item money_item">
                <div class="left_wrap man_l">
                    <div class="l_con">
                        <div class="l_til">理财投资</div>
                        <div class="in_mou_bg"></div>
                        <span class="in_bg in_cloud"></span>
                        <span class="in_bg in_cloud2"></span>
                        <span class="in_bg in_mou_point"></span>
                        <span class="in_bg in_mou_point2"></span>
                        <span class="in_bg in_mou"></span>
                    </div>
                </div>
                <div class="right_wrap man_r">
                    <div class="man_til">
                        <div class="hd clearfix">
                            <ul class="fl clearfix">
                                <li id="manager1" onMouseOver="initInvestData('sbtz')" class="hover">投资项目</li>
                                <li id="manager2" onMouseOver="initInvestData('zqzr')">债权转让</li>
                            </ul>
                            <a class="fr mr40" href="<%=controller.getViewURI(request, com.dimeng.p2p.front.servlets.financing.sbtz.Index.class)%>">更多&gt;</a>
                        </div>     
                    </div>                  
                    <div class="man_con investment-list tab-bd-container" id="investmentList"> </div>      
                </div>
            </div>
        </div>
