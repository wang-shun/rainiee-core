...
<head>
    ...
    <title><%=articleManage.getCategoryNameByCode("SFBZ") %> 信息披露</title>
...
<div class="disclosure wrap">
	<%
         ...
         CURRENT_SUB_CATEGORY = "SFBZ";
         T5010_F04 categoryStatus = articleManage.getCategoryStatusByCode(CURRENT_SUB_CATEGORY);
         if(categoryStatus == T5010_F04.TY){
             controller.sendRedirect(request, response,controller.getViewURI(request, Zdsx.class));
         }
     %>
	<%@include file="/WEB-INF/include/xxpl/menu.jsp" %>
	<div class="disclosure_con content">
		<h2><span>·</span><%=articleManage.getCategoryNameByCode("SFBZ") %></h2>
		<div class="bd">
			 <%
                T5011 article = articleManage.get(T5011_F02.SFBZ);
                if (article != null) {
