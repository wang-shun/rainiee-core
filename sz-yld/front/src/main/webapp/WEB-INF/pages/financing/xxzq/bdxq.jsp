        ...
        <div class="plan_tab_con clearfix">
            <ul class="plan_tabli">
                ...
                <li>本期融资金额：<%
                    ...
                    if (creditInfo.F05.doubleValue() >= 10000) {%><%=creditInfo.F05.doubleValue() / 10000%>万元
                ...
                <%if (t6231.F06 != null) { %>
                <li>还款日期：<%=DateParser.format(t6231.F06) %>
                </li>
                <%} %>
                <li>年化利率：<%=Formater.formatRate(creditInfo.F06)%>
                </li>
                <li>投资截止日期：<%=TimestampParser.format(creditInfo.jsTime) %>
                </li>
                <li>借款用途：<%StringHelper.filterHTML(out, t6231.F08);%></li>
                <li>还款来源：<i
                        title="<%StringHelper.filterHTML(out, t6231.F16);%>"><%StringHelper.truncation(out, t6231.F16, 10); %></i>
                </li>
            </ul>
        </div>
