...
<div class="contain clearfix">
    <div class="w1002 top_title">
        <span class="fl"><a
                href="<%=controller.getViewURI(request, com.dimeng.p2p.front.servlets.financing.Index.class)%>">我要理财</a> &gt;   优选理财计划</span>
      <span class="fr">
      </span>
    </div>
    <div class="contain_main clearfix">
        <div class="pub_title clearfix">
                ...
                %>
				<a href="<%=controller.getPagingItemURI(request, com.dimeng.p2p.front.servlets.financing.yxlc.Yxxq.class,caInfo.F01)%>"
                   class="gray3 ml15"><em class="ml5 blue f14 ">查看详情</em></a></span>
        ...
        <div class="plan_given clearfix">
            <ul class="tender w620 fl clearfix">
                <li>
                    ...
                    <div class="list02">
                        <em class="f20"><%=caInfo.F05 == null ? "0%" : Formater.formatRate(caInfo.F05.doubleValue())%>
                        </em>每年
                    </div>
                </li>
                <li>
                    ...
                    <div class="list02">
                        参见<a target="_blank"
                             href="<%=controller.getPagingItemURI(request, Term.class, TermType.BXBZ.name())%>"
            ...
            <div class="fr m_invest w240 mt15">
                <form method="post" action="<%configureProvider.format(out,URLVariable.TB_YXLC);%>">
                    ...
                    <div class="text">
                        ...
                        <input name="gmMoney" maxlength="10" type="text" class="input_border w240" id="gmMoney" value=""
            ...
            <ul>
                <li>
                    ...
                    <p>
                        ...
                        <em class="f20"><%=Formater.formatAmount(fpCount.totleMoney.doubleValue() / 100000000)%>
                        </em>亿元
                        <%} else if (fpCount.totleMoney.doubleValue() >= 10000 && fpCount.totleMoney.doubleValue() < 100000000) {%>
                        <em class="f20"><%=Formater.formatAmount(fpCount.totleMoney.doubleValue() / 10000)%>
                        </em>万元
                        <%} else {%>
                        <em class="f20"><%=Formater.formatAmount(fpCount.totleMoney)%>
                        </em>元
                        <%}%>
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        <em class="f20"><%=fpCount.joinCount%>
                        </em>次
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        <em class="f20"><%=Formater.formatRate(fpCount.moneyUse)%>
                        </em>
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        ...
                        <em class="f20"><%=Formater.formatAmount(fpCount.userEarnMoney.doubleValue() / 100000000)%>
                        </em>亿元
                        <%} else if (fpCount.userEarnMoney.doubleValue() >= 10000 && fpCount.userEarnMoney.doubleValue() < 100000000) {%>
                        <em class="f20"><%=Formater.formatAmount(fpCount.userEarnMoney.doubleValue() / 10000)%>
                        </em>万元
                        <%} else {%>
                        <em class="f20"><%=Formater.formatAmount(fpCount.userEarnMoney)%>
                        </em>元
                        <%}%>
                    </p>
                </li>
    ...
    <div class="contain_main clearfix plan_intr">
        <div class="w620 fl">
            ...
            <div class="pt20">
               <%--  <a target="_blank" href="<%=controller.getPagingItemURI(request, Term.class, TermType.YXLCXY.name())%>"
                   class="blue">点此查看计划说明书 &gt;&gt;</a> --%>
            </div>
        </div>
    </div>
</div>
...
<div class="dialog d_error w510" id="gmDialog" style="margin:-150px 0 0 -255px; display: none;">
    ...
    <div class="con clearfix">
        ...
        <div class="info fr">
            ...
            您此次购买金额为<i class="red"><span id="zxMoney"></span></i>元，加入费为<i class="red"><span id="jrfMoney"></span></i>元，总需为<i
                class="red"><span id="zgxMoney"></span></i>确认购买？
        </div>
        <div class="clear"></div>
