...
<head>
    ...
    <title><%=ArticleType.XSZY.getName()%>
    </title>
...
<div class="contain clearfix">
    <div class="lead">
        ...
        <%
            ...
            PagingResult<T5011> result = articleManage.search(T5011_F02.XSZY, new Paging() {
        ...
        <div class="fr clearfix ">
            <div class="lead_tab clearfix ">
                <ul>
                    <%for (int i = 0, idx = 1, max = articles.length; i < articles.length; i++, idx++) {%>
