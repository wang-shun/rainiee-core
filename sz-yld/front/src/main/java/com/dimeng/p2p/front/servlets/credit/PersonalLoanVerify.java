...
public class PersonalLoanVerify extends AbstractCreditServlet {
	...
	protected void processPost(HttpServletRequest request,
		...
		session.invalidVerifyCode("PS_LOAN_INTENT");
		final String verifyCode = session.getVerifyCode("PS_LOAN_INTENT");
