...
public class Region extends AbstractFrontServlet
{
        ...
        throws Throwable
    {
        ...
        writer.write("$(\"#shengId\").val(pro_val);");
        ...
        writer.write("if(!city_data){");
        writer.write("var pro_val = $(\"select[name='sheng']\").val();");
        writer.write("for ( var i = 0; i < region.length; i++) {");
        writer.write("if (region[i].id == pro_val) {");
        writer.write("city_data = region[i].children;");
        writer.write("break;");
        ...
        writer.write("$(\"#shiId\").val(city_val);");
        writer.write("area.children().remove();");
        writer.write("for (var i = 0; i < city_data.length; i++) {");
        ...
        writer.write("}");
        writer.write("});");
        writer.write("area.change(function() {");
        writer.write("var area_val = $(this).val();");
        writer.write("$(\"#xianId\").val(area_val);");
        writer.write("});");
