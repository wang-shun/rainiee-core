...
public class UpdatePassword extends AbstractFrontServlet {
	...
	protected void processPost(HttpServletRequest request,
		...
		try {
			...
			String passwordOne = StringHelper.isEmpty(request.getParameter("passwordOne")) ? "" : request.getParameter("passwordOne");
			String passwordTwo = StringHelper.isEmpty(request.getParameter("passwordTwo")) ? "" : request.getParameter("passwordTwo");
            passwordOne = RSAUtils.decryptStringByJs(passwordOne);
            passwordTwo = RSAUtils.decryptStringByJs(passwordTwo);
