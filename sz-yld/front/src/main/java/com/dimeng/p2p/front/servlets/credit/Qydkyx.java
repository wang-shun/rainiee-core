...
public class Qydkyx extends AbstractCreditServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		authentication.setVerifyCodeType("EP_LOAN_INTENT");
	...
	protected void onThrowable(HttpServletRequest request,
		...
		//sendRedirect(request, response, getController().getViewURI(request, Qydkyx.class));
		forward(request, response, getController().getViewURI(request, Qydkyx.class));
	}
}
