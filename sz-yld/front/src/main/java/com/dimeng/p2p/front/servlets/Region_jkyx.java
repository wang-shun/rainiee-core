...
public class Region_jkyx extends AbstractFrontServlet
{
        ...
        throws Throwable
    {
        ...
        writer.write("initRegion();");
        writer.write("});");
        writer.write("function initRegion(){");
        ...
        writer.write("}");
        writer.write("}");
        writer.write("$(\"#sheng\").selectlist({");
        writer.write("width: 180,");
        writer.write("height: 36,");
        writer.write("onChange: function(){");
        writer.write("provinceChange();");
        writer.write("checkValue($(\"input[name='sheng']\"));");
        writer.write("}");
        writer.write("});");
        
        writer.write("$(\"#shi\").selectlist({");
        writer.write("width: 180,");
        writer.write("height: 36,");
        writer.write("onChange: function(){");
        writer.write("cityChange();");
        writer.write("checkValue($(\"input[name='shi']\"));");
        writer.write("}");
        writer.write("});");
        writer.write("$(\"#xian\").selectlist({");
        writer.write("width: 180,");
        writer.write("height: 36,");
        writer.write("onChange: function(){");
        writer.write("checkValue($(\"input[name='xian']\"));");
        writer.write("}");
        writer.write("});");
        
        writer.write("if($(\"#sheng\").hasClass(\"required\")){");
        writer.write("$(\"input[name='sheng']\").addClass(\"required\");");
        writer.write("$(\"input[name='shi']\").addClass(\"required\");");
        writer.write("$(\"input[name='xian']\").addClass(\"required\");");
        writer.write("}");
        ...
        /* writer.write("var province = $(\"select[name='sheng']\");");
         ...
         writer.write("var shengId = $(\"#sheng\").val();");
         writer.write("var shiId = $(\"#shi\").val();");
         writer.write("var xianId = $(\"#xian\").val();");
         writer.write("var city_data = null;");
         writer.write("var area_data = null;");
         writer.write("province.html(getSelectHtml(region, shengId));");
         writer.write("city_data = null;");
        ...
        writer.write("function checkValue($eve){");
        writer.write("var flg = true;");
        writer.write("if($eve== undefined){");
        writer.write("return false;");
        writer.write("}");
        writer.write("if($eve.attr(\"class\")== undefined){");
        writer.write("return false;");
        writer.write("}");
        writer.write("var msg = $eve.attr(\"class\").split(\" \");");
        writer.write("var value = $eve.val();");
        writer.write("$error = $eve.nextAll(\"p[errortip]\");");
        writer.write("$tip = $eve.nextAll(\"p[tip]\");");
        writer.write("if(!$error || $error.length == 0){");
        writer.write("$error = $eve.parent().nextAll(\"p[errortip]\");");
        writer.write("}");
        writer.write("if(!$tip || $tip.length == 0){");
        writer.write("$tip = $eve.parent().nextAll(\"p[tip]\");");
        writer.write("}");
        writer.write("for(var i=0;i<msg.length;i++){");
        writer.write("var temp = $.trim(msg[i]);");
        writer.write("if(temp.length>0){");
        writer.write("if(temp == \"required\"){");
        writer.write("if($.trim(value) == \"\"){");
        writer.write("$error.addClass(\"red\");");
        writer.write("$error.html(\"请选择！\");");
        writer.write("$tip.hide();");
        writer.write("$error.show();");
        writer.write("flg = false;");
        writer.write("flgs = false;");
        writer.write("return false;");
        writer.write("}");
        writer.write("}");
        writer.write("}");
        ...
        writer.write("return false;");
        writer.write("}else{");
        writer.write("$error.removeClass(\"red\");");
        writer.write("$error.hide();");
        writer.write("$tip.show();");
        writer.write("}");
        writer.write("}");
        
        writer.write("function provinceChange(){");
        writer.write("var $province = $(\"input[name='sheng']\");");
        writer.write("var sheng = $(\"#sheng\");");
        writer.write("var pro_val = $province.val();");
        writer.write("$(\"#shi\").remove();");
        writer.write("$(\"#xian\").remove();");
        writer.write("for ( var i = 0; i < region.length; i++) {");
        writer.write("if (region[i].id == pro_val) {");
        writer.write("city_data = region[i].children;");
        writer.write("if (city_data.length > 0) {");
        writer.write("sheng.after(\"<select name='shi' id='shi' class=' select' ></select>\");");
        writer.write("$(\"#shi\").html(getSelectHtml(city_data,0));");
        writer.write("$(\"#shi\").show();");
        writer.write("$(\"#shi\").selectlist({");
        writer.write("width: 180,");
        writer.write("height: 36,");
        writer.write("onChange: function(){");
        ...
        writer.write("function cityChange(){");
        writer.write("var $city = $(\"input[name='shi']\");");
        writer.write("var shi = $(\"#shi\");");
        writer.write("var city_val = $city.val();");
        writer.write("$(\"#xian\").remove();");
        writer.write("if(city_data ==  null){");
        writer.write("var pro_val = $(\"#shengId\").val();");
        writer.write("$(\"#xian\").remove();");
        writer.write("for ( var i = 0; i < region.length; i++) {");
        writer.write("if (region[i].id == pro_val) {");
        writer.write("city_data = region[i].children;");
        ...
        writer.write("area_data = city_data[i].children;");
        writer.write("if (area_data.length > 0) {");
        writer.write("shi.after(\"<select name='xian' id='xian' class='required select'></select>\");");
        writer.write("$(\"#xian\").html(getSelectHtml(area_data,0));");
        writer.write("$(\"#xian\").show();");
        writer.write("$(\"#xian\").selectlist({");
        writer.write("width: 180,");
        writer.write("height: 36,");
        writer.write("onChange: function(){");
        ...
        writer.write("function getSelectHtml2(type,shengId,shiId,xianId) {");
        writer.write("if(type==\"sheng\"){var obj = region;");
        writer.write("var html = \"<option value=''>请选择</option>\";");
        writer.write("for (var i = 0; i < obj.length; i++) {");
        writer.write("if (obj[i].id == shengId) {");
        writer.write("html = html + \"<option value=\"+ obj[i].id+\" selected='selected'>\" + obj[i].name + \"</option>\";");
        writer.write("} else {");
        writer.write("html = html + \"<option value=\" + obj[i].id +\">\" + obj[i].name+ \"</option>\";");
        writer.write("}");
        ...
        writer.write("if(type==\"shi\"){var obj=null;");
        writer.write(" for ( var i = 0; i < region.length; i++) {");
        writer.write(" if (region[i].id == shengId) {");
        writer.write("		obj = region[i].children;");
        writer.write("	} }");
        writer.write("var html = \"<option value=''>请选择</option>\";");
        writer.write("if(obj !=null){for (var i = 0; i < obj.length; i++) {");
        writer.write("if (obj[i].id == shiId) {");
        writer.write("html = html + \"<option value=\"+ obj[i].id+\" selected='selected'>\" + obj[i].name + \"</option>\";");
        writer.write("} else {");
        writer.write("html = html + \"<option value=\" + obj[i].id +\">\" + obj[i].name+ \"</option>\";");
        writer.write("}");
        ...
        writer.write("if(type==\"xian\"){var shiobj=null;var obj=null;");
        writer.write(" for ( var i = 0; i < region.length; i++) {");
        writer.write(" if (region[i].id == shengId) {");
        writer.write("		shiobj = region[i].children;");
        writer.write("	} }");
        
        writer.write(" if(shiobj !=null){for ( var i = 0; i < shiobj.length; i++) {");
        writer.write(" if (shiobj[i].id == shiId) {");
        writer.write("		obj = shiobj[i].children;");
        writer.write("	} }}");
        
        writer.write("var html = \"<option value=''>请选择</option>\";");
        writer.write("if(obj !=null){for (var i = 0; i < obj.length; i++) {");
        writer.write("if (obj[i].id == xianId) {");
        writer.write("html = html + \"<option value=\"+ obj[i].id+\" selected='selected'>\" + obj[i].name + \"</option>\";");
        writer.write("} else {");
        writer.write("html = html + \"<option value=\" + obj[i].id +\">\" + obj[i].name+ \"</option>\";");
        writer.write("}");
