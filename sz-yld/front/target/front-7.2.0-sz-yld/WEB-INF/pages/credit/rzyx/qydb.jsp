...
<%@page import="com.dimeng.p2p.front.servlets.credit.rzyx.Qydb" %>
...
<form action="<%=controller.getURI(request, Qydb.class)%>" class="form1" method="post">
    <div class="contain clearfix">
        <div class="want_loan"><span>企业担保融资</span></div>
            ...
            <div class="loan_con clearfix">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="info"><textarea name="F13" cols="" rows=""
                    ...
                    <li>
                        ...
                        <input type="hidden" name="F20" value="S"/>

                        <div class="info"><input type="submit" class="btn btn01 sumbitForme" fromname="form1"
