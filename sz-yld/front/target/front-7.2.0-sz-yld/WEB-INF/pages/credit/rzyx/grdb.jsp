...
<%@page import="com.dimeng.p2p.front.servlets.credit.rzyx.Grdb" %>
...
<form action="<%=controller.getURI(request, Grdb.class)%>" class="form1" method="post">
    <div class="contain clearfix">
        <div class="want_loan"><span>个人担保融资</span></div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="info">
                            ...
                            <input type="hidden" name="F17" value="S"/>
