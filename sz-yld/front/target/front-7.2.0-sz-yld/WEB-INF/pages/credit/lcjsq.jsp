...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=controller.getStaticPath(request)%>/js/jquery-easyui-1.4.5/themes/default/easyui.css">
    <link rel="stylesheet" type="text/css" href="<%=controller.getStaticPath(request)%>/js/jquery-easyui-1.4.5/themes/icon.css">
</head>
<body>
...
<div class="main_bg">
    <div class="w1002">
        <div class="main_tab">
            <ul class="clearfix">
                <li id="calcul1" class="hover">理财计算器</li>
                <li id="calcul2" onclick="location.href='<%configureProvider.format(out, URLVariable.JK_JKJSQ); %>'">
                    借款计算器
                </li>
            </ul>
        </div>
    </div>
    <div class="main_mod" id="con_calcul_1">
        <form action="" method="get" class="form1">
            <div class="main_form mt50 calculator_form">
                <ul>
                    <li class="item">
                        <div class="til">出借金额：</div>
                        <div class="con">
                            <input name="" id="cjje" type="text"
                                   class="text jejs required isint  min-size-1"
                                   maxlength="11"/>元
                            <input id="min_amount" type="hidden"
                                   value="<%=configureProvider.format(SystemVariable.AUTO_BIDING_MIN_AMOUNT)%>"/>
        ...
        <div class="calculator_notes" style="display: none;" id="showjs">
            <div class="main_hd"><i class="icon"></i><span class="gray3 f18">收益描述</span></div>
            <div class="loanamount clearfix">
                <div class="til">
                    <p>出借金额：<span class="orange bold" id="mtoal">0.0</span>元</p>
                    <p>应收利息：<span class="orange bold" id="ghbx">0.0</span>元</p>
                </div>
                <div class="info"><i class="ico"></i>您将在<span class="f18 orange bold" id="mthns">3</span>后收回全部本息</div>
            </div>
            <div class="main_hd"><i class="icon"></i><span class="gray3 f18">本息回收时间表</span></div>
...
<script type="text/javascript" src="<%=controller.getStaticPath(request)%>/js/lcjsq.js"></script>
<script type="text/javascript" src="<%=controller.getStaticPath(request)%>/js/jquery-easyui-1.4.5/jquery.easyui.min.js"></script>
</body>
</html>
