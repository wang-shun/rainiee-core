...
<head>
    ...
    <title><%=articleManage.getCategoryNameByCode("GSJJ") %> 关于我们</title>
...
<div class="disclosure wrap">
	<%
         ...
         if(categoryStatus == T5010_F04.TY){
             controller.sendRedirect(request, response,controller.getViewURI(request, Gltd.class));
         }
     %>
	<%@include file="/WEB-INF/include/xxpl/menu.jsp" %>
	<div class="disclosure_con content">
		<h2><span>·</span><%=articleManage.getCategoryNameByCode("GSJJ") %></h2>
		<div class="bd">
			 <%
