...
<head>
    ...
    <title><%=articleManage.getCategoryNameByCode("FLHG") %> 安全保障</title>
...
<div class="disclosure wrap">
	<%
         ...
         if(categoryStatus == T5010_F04.TY){
             controller.sendRedirect(request, response,controller.getViewURI(request, Hzjg.class));
         }
     %>
	<%@include file="/WEB-INF/include/xxpl/menu.jsp" %>
	<div class="disclosure_con content">
		<h2><span>·</span><%=articleManage.getCategoryNameByCode("FLHG") %></h2>
		<div class="bd">
			 <%
                T5011 article = articleManage.get(T5011_F02.FLHG);
                if (article != null) {
