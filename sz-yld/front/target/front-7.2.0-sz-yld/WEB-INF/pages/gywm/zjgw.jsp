...
%>
<title><%=articleManage.getCategoryNameByCode("ZJGW")%> 关于我们</title>
	...
	<div class="disclosure wrap">
		<%
            ...
            if(categoryStatus == T5010_F04.TY){
                controller.sendRedirect(request, response,controller.getViewURI(request, Hzhb.class));
            }
		%>
		<%@include file="/WEB-INF/include/xxpl/menu.jsp"%>
		<div class="disclosure_con about_team">
			<h2>
				<span>·</span><%=articleManage.getCategoryNameByCode("ZJGW")%></h2>
			...
			<div class="bd">
				...
				<dl>
					<dt>
						<%
						    if (!StringHelper.isEmpty(article.F09)) {
						%><img
							src="<%=fileStore.getURL(article.F09)%>" />
						<%
						    }
						%>
					</dt>
