...
<head>
    ...
    <title><%=articleManage.getCategoryNameByCode("WDHYZX") %>  最新动态</title>
        ...
        <div class="news_list">
            <ul>
                ...
                <li><span class="fr gray9"><%=Formater.formatDate(article.F12) %></span>
                    <a target="_blank"
                       href="<%=controller.getPagingItemURI(request, Wdhyzx.class,article.F01 )%>">
