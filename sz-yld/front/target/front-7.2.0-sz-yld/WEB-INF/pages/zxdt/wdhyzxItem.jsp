...
<%
    ...
    T5011 article = articleManage.get(IntegerParser.parse(request.getParameter("id")), T5011_F02.WDHYZX);
    if (article == null) {
...
<head>
    ...
    <title>
        ...
        %><%=articleManage.getCategoryNameByCode("WDHYZX") %>
        关于我们
    </title>
    ...
    <div class="about_content">
        ...
        <div class="article_details_til">
            <div class="fr">
                <%
                    if (article != null) {
                        out.print(DateParser.format(article.F12));
                    }
                %>
            </div>
            <h1>
