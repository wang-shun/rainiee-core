...
<head>
    ...
    <title>优选理财计划<%=configureProvider.getProperty(SystemVariable.SITE_TITLE)%>
    </title>
...
<div class="contain clearfix">
    <div class="w1002 top_title">
        <span class="fl"><a
                href="<%=controller.getViewURI(request, com.dimeng.p2p.front.servlets.financing.Index.class)%>">我要理财</a> &gt;   <a
                href="<%=controller.getViewURI(request, com.dimeng.p2p.front.servlets.financing.yxlc.Index.class)%>">优选理财计划</a>&gt;  优选理财计划详情</span>
      <span class="fr">
      </span>
    </div>
        ...
        <div class="plan_given clearfix">
            <ul class="tender w620 fl clearfix">
                <li>
                    ...
                    <div class="list02">
                        <em class="f20"><%=Formater.formatAmount(caInfo.F03) %>
                        </em>元
                    </div>
                    <div class="list01">预期收益</div>
                    <div class="list02"><em
                            class="f20"><%=caInfo.F05 == null ? "0%" : Formater.formatRate(caInfo.F05.doubleValue())%>
                    </em>每年
                    </div>
                </li>

                <li>
                    <div class="list01">投资范围</div>
                    <div class="list02">
                    ...
                    <div class="list02">
                        参见<a href="<%=controller.getPagingItemURI(request, Term.class, TermType.BXBZ.name())%>"
                             class="ml5 blue">本息保障计划</a>
                    </div> --%>
                </li>
                <li>
                    ...
                    <ul class="plan_charge clearfix fl">
                        <li>
                            ...
                            <div class="list04">
                                ...
                                <div class="tips_content">
                                    <span class="ui_plan_bj ui_i_tips ml5" style="margin-top: 7px;"
                                          onmouseover="mouseOver(3)" onmouseout="mouseOut(3)"></span>

                                    <div class="ui-pop-con" style="display: none;" id="txfy3">
                                        <div class="fl ui-pop-pic"></div>
                                        <div class="ui-pop-info">
                                            初期额外收取加入计划金额的<%=Formater.formatRate(caInfo.F15)%>
                                            作为加入费用，归<%=configureProvider.getProperty(SystemVariable.SITE_NAME)%>所有。
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="list04">
                                ...
                                <div class="tips_content">
                                    <span class="ui_plan_bj ui_i_tips ml5" style="margin-top: 7px;"
                                          onmouseover="mouseOver(2)" onmouseout="mouseOut(2)"></span>

                                    <div class="ui-pop-con" style="display: none;" id="txfy2">
                                        <div class="fl ui-pop-pic"></div>
                                        <div class="ui-pop-info">
                                            计划中收取投资所得利息收益的<%=Formater.formatRate(caInfo.F16)%>
                                            作为服务费，归<%=configureProvider.getProperty(SystemVariable.SITE_NAME)%>所有。
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="list04">
                                ...
                                <div class="tips_content">
                                    <span class="ui_plan_bj ui_i_tips ml5" style="margin-top: 7px;"
                                          onmouseover="mouseOver(0)" onmouseout="mouseOut(0)"></span>

                                    <div class="ui-pop-con" style="display: none;" id="txfy0">
                                        <div class="fl ui-pop-pic"></div>
                                        <div class="ui-pop-info">
                                            退出计划时收取退出计划金额的<%=Formater.formatRate(caInfo.F17)%>
                                            作为退出费，归<%=configureProvider.getProperty(SystemVariable.SITE_NAME)%>所有。
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="fr m_invest w240 mt15">
                <form method="post" action="<%configureProvider.format(out,URLVariable.TB_YXLC);%>">
                    ...
                    <input type="hidden" id="yxlcSucc" name="yxlcSucc"
                           value="<%configureProvider.format(out, URLVariable.USER_YXLC);%>">
                    <input type="hidden" id="yxlcSqz" name="yxlcSqz"
                           value="<%configureProvider.format(out, URLVariable.USER_YXLC_SQZ);%>">

                    <div class="text">
                        剩余金额<br/> <em class="f20"><%= Formater.formatAmount(caInfo.F04)%>
                    </em>元
                    </div>
                    <div class="text mb20 clearfix">
                        <span class="f12 fl mr15"><em>每人可加入金额上限</em><br/> <em
                                class="f16"><%=Formater.formatAmount(caInfo.F23)%>
                        </em>元</span>
                        ...
                        %>
					<span class="f12 fl"><em>可用金额（<a href="<%configureProvider.format(out,URLVariable.USER_CHARGE);%>"
                                                     class="blue">充值</a>）
                        <input type="hidden" id="kyMoney" name="kyMoney" value="<%=userInfo.F06%>">
                    </em><br/>
					<em class="f16"><%=Formater.formatAmount(userInfo.F06)%>
                    </em>元
					</span>
                        <%} else {%>
                    ...
                    <input type="hidden" id="charge" name="charge"
                           value="<%configureProvider.format(out,URLVariable.USER_CHARGE);%>">


                    <div class="text">
                        <div class="yuan">元</div>
                        <input name="gmMoney" type="text" maxlength="10" class="input_border w240" id="gmMoney"
                               onKeyUp="value=(parseInt((value=value.replace(/\D/g,''))==''?'0':value,10))" value=""/>
                    ...
                    <div class="text">
                        <div class="yuan">元</div>
                        <input name="gmMoney1" type="text" maxlength="10" class="input_border w240" id="gmMoney1"
                               onKeyUp="value=(parseInt((value=value.replace(/\D/g,''))==''?'0':value,10))" value=""/>
                    ...
                    <div class="text">
                        ...
                        <input name="textfield" type="text" maxlength="10"
                               onKeyUp="value=(parseInt((value=value.replace(/\D/g,''))==''?'0':value,10))"
                               class="input_border w240" id="textfield" value=""/>
    ...
    <div class="contain_main clearfix add_record" id="con_one_2" style="display:none;">
        <div class="plan_tab_con01 clearfix">
            <div class="mt50 mb50 tc f18">请<a href="<%configureProvider.format(out,URLVariable.LOGIN);%>"
                                              class="blue mr10 ml10">登录</a>或<a
                    href="<%configureProvider.format(out,URLVariable.REGISTER);%>" class="blue mr10 ml10">注册</a>后查看
            </div>
        </div>
    </div>
    <%} else if (!(caInfo.F07 == T6410_F07.YFB && caInfo.F09.after(caInfo.currentTime))) {%>
    <div class="contain_main clearfix add_record" id="con_one_2" style="display:none;">
        <div class="clearfix">
            <div class="table pt10 fl">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <%
                        ...
                        if (planRecodes != null && planRecodes.length > 0) {
                            for (T6411 planRecode : planRecodes) {
                                if (planRecode == null) {
                                    continue;
                                }%>
                    <tr>
                        <td align="center"><%
                            StringHelper.filterHTML(out, userInfoManage.getUserName(planRecode.F03).substring(0, 4) + "***");%></td>
                        <td align="center"><%=Formater.formatAmount(planRecode.F04) %>元</td>
                        <td align="center"><%=TimestampParser.format(planRecode.F06, "yyyy-MM-dd") %>
                        </td>
                    </tr>
                    <%
                            }
            ...
            <div class="plan_record"><span class="f20">加入总人次</span><br/><span
                    class="f30 orange"><%=planRecodes == null ? 0 : planRecodes.length %></span>人次
            </div>
        </div>
    </div>
    <%} %>
...
<div class="dialog d_error w510" id="gmDialog" style="margin:-150px 0 0 -255px; display: none;">
    ...
    <div class="con clearfix">
        ...
        <div class="info fr">
            ...
            您此次购买金额为<i class="red"><span id="zxMoney"><%=gmMoney%></span></i>元，加入费为<i class="red"><span
                id="jrfMoney"><%=jrfMoney%></span></i>元，总需为<i class="red"><span
                id="zgxMoney"><%=Formater.formatAmount(gmMoney.add(jrfMoney)) %></span></i>确认购买？

        </div>
        <div class="clear"></div>
        <div class="dialog_btn"><a href="javascript:void(0)" id="ok" class="btn btn01">确 定</a><a
                href="javascript:void(0)" id="cancel" class="btn btn05">取 消</a></div>
    </div>
</div>
