...
<div class="contain clearfix">
    <div class="w1002 top_title">
        <span class="fl"><a
                ...
                href="<%=controller.getViewURI(request, com.dimeng.p2p.front.servlets.financing.yxlc.Index.class)%>">优选理财计划</a>&gt;往期优选理财计划列表</span>
      <span class="fr">
      	</span>
    </div>
    ...
    <div class="financial">
        ...
        <div class="condition">
            <table width="100%" border="0">
                <tr>
                    <td><i></i>加入条件：<span class="f18 orange"><b><%=caInfo.F22%>
                    </b></span>元
                    </td>
                    <td><i></i>计划总额：<span class="f18 orange"><b><%=caInfo.F03%>
                    </b></span>元
                    </td>
                    <td>预期收益：<span class="f18 orange"><b><%=Formater.formatRate(caInfo.F05, false)%>
                    </b></span>%
                    </td>
                </tr>
            </table>
    ...
    <div class="contain_main clearfix">
        ...
        <div class="pt10">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tc overdue">
                ...
                <%
                    YxlbEntity[] financingPlans = result.getItems();
                    if (financingPlans != null) {
                        for (YxlbEntity financingPlan : financingPlans) {
                            if (financingPlan == null) {
                                continue;
                            }
                %>
                <tr class="all_bj">
                    <td><em class="f16 blue"><a
                            href="<%=controller.getPagingItemURI(request, Yxxq.class,financingPlan.F01)%>"><%=financingPlan.F02%>
                    </a></em></td>
                    <td><em class="f16"><%=financingPlan.F03%>
                    </em><em class="f12">元</em></td>
                    <td><em class="f16"><%=financingPlan.jrrc%>
                    </em><em class="f12">人</em></td>
                    <td><em class="f16"><%=Formater.formatRate(financingPlan.pjsyl)%>
                    </em><em class="f12"></em></td>
                    <td><em class="f16"><%=Formater.formatRate(financingPlan.F05)%>
                    </em><em class="f12"></em></td>
                    <td><em class="f16"><%=Formater.formatAmount(financingPlan.yzje)%>
                    </em><em class="f12">元</em></td>
                    <td><em class="f14"><%=DateParser.format(financingPlan.F09)%>
                    </em></td>
                </tr>
                <%
                        }
