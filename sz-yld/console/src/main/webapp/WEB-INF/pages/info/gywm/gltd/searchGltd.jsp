...
<%@page import="com.dimeng.p2p.console.servlets.info.gywm.gltd.DeleteGltd" %>
<%@page import="com.dimeng.p2p.console.servlets.info.gywm.gltd.UpdateGltd" %>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("GLTD");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, SearchGltd.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    <li><span class="display-ib mr5">团队名称：</span>
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddGltd.class)) {%>
                                        <a href="<%=controller.getURI(request, AddGltd.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteGltd.class)) {%>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                %>
                                <tr class="title" align="center">
                                    <td class="tc"><input name="id" type="checkbox"
                                                          value="<%=record.id%>"/></td>
                                    <td class="tc"><%=index++%>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <%StringHelper.filterHTML(out, record.publisherName);%>
                                    </td>
                                    <td><%=record.sortIndex%>
                                    </td>
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateGltd.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateGltd.class)%>?id=<%=record.id%>"
    	...
    	<div class="popup-content-container-2" style="max-height:550px;">
            <div class="p30">
                <ul class="gray6">
					...
					<input id="articleName" type="text" onblur="checkTitleName();" class="text border w150 pl5" name="articleName" value="<%StringHelper.filterHTML(out, category.F03);%>"/>
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteGltd.class)%>';
    var upateUrl = '<%=controller.getURI(request, UpdateCategoryName.class)%>';
    var reloadUrl = '<%=controller.getURI(request, SearchGltd.class)%>';
...
<script type="text/javascript">
    function updateNameLol(){
        updateName('GLTD')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showGYWMMenu("GLTD");
    }
</script>
