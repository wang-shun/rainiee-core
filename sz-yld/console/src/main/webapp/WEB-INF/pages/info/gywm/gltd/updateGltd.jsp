                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改<%=xcglmanage.getCategoryNameByCode("GLTD") %>
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, UpdateGltd.class)%>"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
                                        <span class="display-ib w200 tr mr5"><span class="red">*</span>团队名称：</span>
                                    ...
                                    <li class="mb10">
                                        <span class="display-ib w200 tr mr5 fl"><span class="red">*</span>团队简介：</span>
