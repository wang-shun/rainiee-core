...
<%@page import="com.dimeng.p2p.console.servlets.info.xxpl.sjbg.AddSjbg"%>
...
<%@page import="com.dimeng.p2p.console.servlets.info.xxpl.sjbg.DeleteSjbg"%>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("SJBG");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchSjbg.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="con">
                                ...
                                <div class="content-container pl40 pt30 pr40">
                                    <ul class="gray6 input-list-container clearfix">
                                        ...
                                        <li>
                                            <%if (dimengSession.isAccessableResource(AddSjbg.class)) {%>
                                            <a href="<%=controller.getURI(request, AddSjbg.class)%>"
                                               class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                        ...
                                        <li>
                                            <%if (dimengSession.isAccessableResource(DeleteSjbg.class)) {%>
                                        ...
                                        <li>
                                     <%if (dimengSession.isAccessableResource(SearchSjbg.class)) {%>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title" align="center">
                                    ...
                                    <td>
                                        <%if (dimengSession.isAccessableResource(UpdateSjbg.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateSjbg.class)%>?id=<%=record.id %>"
                        ...
                        <% SearchSjbg.rendPagingResult(out, result);%>
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteSjbg.class) %>';
    var upateUrl = '<%=controller.getURI(request, UpdateCategoryName.class)%>';
    var reloadUrl = '<%=controller.getURI(request, SearchSjbg.class)%>';
...
<script type="text/javascript">
    function updateNameLol(){
        updateName('SJBG')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showZXDTMenu("SJBG");
    }
</script>
