                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增/修改 <%=xcglmanage.getCategoryNameByCode("XMFK") %>
                        </div>

                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form action="<%=controller.getURI(request, UpdateXmfk.class)%>" method="post"
...
<script type="text/javascript">
    $(function(){
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showAQBZMenu("XMFK");
    });
</script>
<script>
    var editor1;
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, UpdateXmfk.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
