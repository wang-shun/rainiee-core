...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <div class="p20">
                    <form name="example" method="post" action="<%=controller.getURI(request, AddTzyhkWtlx.class)%>"
                          class="form1" enctype="multipart/form-data" onsubmit="return checkImage();">
                          <%=FormToken.hidden(serviceSession.getSession()) %>
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>新增投资与回款问题类型
                            </div>
                                ...
                                <ul class="gray6">
                                    ...
                                    <li>
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button" value="取消" class="btn-blue2 btn white radius-6 pl20 pr20 ml40" onclick="javascript:window.location.href='<%=controller.getURI(request, SearchTzyhkWtlx.class) %>';"/>
                                        </div>
                                </ul>
                            </div>
                        </div>
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, SearchTzyhkWtlx.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
