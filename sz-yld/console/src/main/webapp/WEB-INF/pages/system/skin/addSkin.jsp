                    ...
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            ...
                            <form method="post" id="form1">
                                <input type="hidden" name="pic" <%if(!StringHelper.isEmpty(fileCode)){%>
                                       value="<%=fileStore.getURL(fileCode)%>" <%}%>>
                                <ul class="cell noborder yw_jcxx">
                                    <li>
                                        ...
                                        <div class="info orange">
                                            <input type="text" name="name" id="name" onblur="nameCheck()"
                                                   value="<%StringHelper.filterSingleQuoter(out, request.getParameter("name"));%>"
                                                   class="text yhgl_ser yw_w4 required"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <select name="location" class="yhgl_ser yw_w1">
                                                ...
                                                %>
                                                <option value="<%=skinStatus.name()%>" <%if (skinStatus.name().equals(request.getParameter("location"))) {%>
                                                        selected="selected" <%}%>><%=skinStatus.getName()%>
                                                </option>
                                                <%
                                                    }
                                                %>
                                    ...
                                    <li>
                                        ...
                                        <div class="info orange">
                                            <img id="imgFile" <%if(!StringHelper.isEmpty(fileCode)){%>
                                                 src="<%=fileStore.getURL(fileCode)%>" <%}%> class="bm10 bo_xxk">
                                            <input type="file" name="file" onblur="fileCheck()" id="uploadFile"
                                                   value="选择文件" onchange="upload()" class="required">
