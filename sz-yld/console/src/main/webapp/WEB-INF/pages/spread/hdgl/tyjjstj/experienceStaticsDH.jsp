...
<%@ page import="com.dimeng.p2p.console.servlets.spread.tyjgl.*" %>
...
<%@ page import="com.dimeng.p2p.console.servlets.spread.hdgl.tyjjstj.ExportStaticsDH" %>
<html>
<head>
...
<%
    ...
    ExperienceStatistics searchDhAmount = ObjectHelper.convert(request.getAttribute("searchDhAmount"), ExperienceStatistics.class);
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, ExperienceStaticsDH.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                                ...
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">还款日</span>
                                        <input type="text" name="repaymentStartTime" readonly="readonly"
                                               id="datepicker3" class="text border pl5 pr5 w120 date"
                                        ...
                                        <input type="text" name="repaymentEndTime" readonly="readonly"
                                               id="datepicker4" class="text border pl5 w120 mr20 date"
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(ExportStaticsDH.class)) {
                                        %>
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    <li><a href="javascript:void(0)" class="tab-btn select-a">待付<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                    <li><a href="<%=controller.getURI(request, ExperienceStaticsYH.class)%>"
                                           class="tab-btn">已付</a></li>
                                </ul>
                            </div>
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <td><%=DateParser.format(list.time)%>
                                        </td>
                                    </tr>
                                    <%
                                            }
                        ...
                        <p class="mt5">
	                        <span class="mr30">体验金总金额：<em class="red"><%=Formater.formatAmount(searchDhAmount.experience)%>
	                        </em> 元</span>
	                        <span class="mr30">应还总金额：<em class="red"><%=Formater.formatAmount(searchDhAmount.amount)%>
	                        </em> 元</span>
	                    </p>
                        <!--分页-->
                        <%
...
<script type="text/javascript">
    ...
    function exportList() {
        var del_url = '<%=controller.getURI(request, ExportStaticsDH.class)%>';
        var form = document.forms[0];
        form.action = del_url;
        form.submit();
        form.action = '<%=controller.getURI(request, ExperienceStaticsDH.class)%>';
    }
