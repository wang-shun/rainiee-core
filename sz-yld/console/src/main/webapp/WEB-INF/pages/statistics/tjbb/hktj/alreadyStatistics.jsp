...
<%@page import="com.dimeng.p2p.console.servlets.statistics.tjbb.hktj.ExportAlreadyStatistics"%>
...
<%
    ...
    BigDecimal total = ObjectHelper.convert(request.getAttribute("alreadyTotal"), BigDecimal.class);
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form_loan" action="<%=controller.getURI(request, AlreadyStatistics.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>已还统计表
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">实际还款日期： </span>
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(ExportAlreadyStatistics.class)) {%>
                        ...
                        <div class="border mt20">
                        	<div class="tabnav-container">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="javascript:void(0)" class="tab-btn select-a">已还<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                </ul>
                            </div>
                            ...
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="tc">
                                    ...
                                    <td><%StringHelper.filterHTML(out, repayment.subject); %></td>
                                    <td><%=Formater.formatAmount(repayment.repaymentPrice) %></td>
                                    <td><%StringHelper.filterHTML(out, repayment.loandeadline); %></td>
                                    <td><%=DateParser.format(repayment.shouldTheDate) %></td>
                                    <td><%=DateParser.format(repayment.actualDate) %></td>
                                </tr>
                                <%
                                    }
                                } else {
                        ...
                        <p class="mt5">金额共计：<em class="red"><%=Formater.formatAmount(total)%>
                        </em> 元</p>
                        <!--分页-->
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form_loan").action = "<%=controller.getURI(request, ExportAlreadyStatistics.class)%>";
        $("#form_loan").submit();
        document.getElementById("form_loan").action = "<%=controller.getURI(request, AlreadyStatistics.class)%>";
    }
</script>
</body>
</html>