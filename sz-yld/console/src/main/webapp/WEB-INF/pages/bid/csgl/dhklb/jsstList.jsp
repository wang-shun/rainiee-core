...
<%@page import="com.dimeng.p2p.console.servlets.bid.csgl.dhklb.DcJsst" %>
...
<%@page import="com.dimeng.p2p.modules.bid.console.service.entity.Near30" %>
...
<%
    ...
    PagingResult<Near30> near30s = (PagingResult<Near30>) request.getAttribute("near30s");
    Near30[] near30Array = near30s.getItems();
    Near30 near30SearchAmount = (Near30)request.getAttribute("near30SearchAmount");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                ...
                <div class="p20">
                    <form id="form1" action="<%=controller.getURI(request, JsstList.class)%>" method="post">
                        <div class="border">
                        ...
                        <div class="border mt20">
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">下一还款日</span>
                                        ...
                                        <input type="text" readonly="readonly" name="createTimeEnd" id="datepicker2"
                                               class="text border pl5 mr20 date"/>
                                    </li>
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(DcJsst.class)) {
                                        %>
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">近30天待还款<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                    <li><a href="<%=controller.getURI(request, YqList.class)%>"
                                           class="tab-btn ">逾期待还款</a></li>
                            ...
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <%
                                        if (near30Array != null) {
                                            for (int i = 0; i < near30Array.length; i++) {
                                                Near30 near30 = near30Array[i];
                                                if (near30 == null) {
                                                    continue;
                                                }
                                    %>
                                    <tr class="tc">
                                        <td align="center"><input type="checkbox" name="checkbox" id="checkbox"
                                                                  value="<%=near30.userId %>,<%=near30.loanRecordId %>,<%=near30.collectionId %>,<%=near30.mobile %>,<%=near30.email %>"
                                                                  onclick="selectThis()"/></td>
                                        <td class="tc"><%=i + 1%>
                                        </td>
                                        <td><%
                                            StringHelper.filterHTML(out, StringHelper.truncation(near30.loanRecordTitle, 10)); %></td>
                                        <td align="center" id="userName"><%
                                            StringHelper.filterHTML(out, near30.userName);%></td>
                                        <td align="center"><%=Formater.formatAmount(near30.loanAmount)%>
                                        </td>
                                        <td align="center"><%StringHelper.filterHTML(out, near30.loandeadline); %></td>
                                        <td align="center"><%=Formater.formatAmount(near30.principalAmount)%>
                                        </td>
                                        <td align="center"><%=Formater.formatAmount(near30.residueAmount)%>
                                        </td>
                                        <td align="center"><%=near30.distanceRefund %>天</td>
                                        <td align="center"><%=Formater.formatDate(near30.refundDay)%>
                                        </td>
                                        <td align="center">
                                            <%if (T6110_F06.ZRR == near30.userType) { %>
                                            <%
                                                if (dimengSession.isAccessableResource(com.dimeng.p2p.console.servlets.account.vipmanage.grxx.JbxxView.class)) {
                                            %>
                                            <a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.vipmanage.grxx.JbxxView.class)%>?userId=<%=near30.userId%>&status=1"
                                               class="link-blue mr10 link_url" showObj="GRXX" data-title="user">个人资料</a>
                                            <%} else { %>
                                            <a href="javascript:void(0)" class="disabled">个人资料</a>
                                            <%} %>
                                            <%} else if (T6110_F06.FZRR == near30.userType && T6110_F10.F == near30.dbf) { %>
                                            <%
                                                if (dimengSession.isAccessableResource(com.dimeng.p2p.console.servlets.account.vipmanage.qyxx.ViewQyxx.class)) {
                                            %>
                                            <a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.vipmanage.qyxx.ViewQyxx.class)%>?id=<%=near30.userId%>&status=1"
                                               class="link-blue mr10 link_url" showObj="QY" data-title="user">企业资料</a>
                                            <%} else { %>
                                            <a href="javascript:void(0)" class="disabled">企业资料</a>
                                            <%} %>
                                            <%} else if (T6110_F10.S == near30.dbf) { %>
                                            <%
                                                if (dimengSession.isAccessableResource(com.dimeng.p2p.console.servlets.account.vipmanage.jgxx.ViewJgxx.class)) {
                                            %>
                                            <a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.vipmanage.jgxx.ViewJgxx.class)%>?id=<%=near30.userId%>&status=1"
                        ...
                        <div class="mb10">
                            <span class="mr30">借款总金额：<em
                                    class="red"><%=Formater.formatAmount(near30SearchAmount.loanAmount) %>
                            </em> 元</span>
                            <span class="mr30">本期应还总金额：<em
                                    class="red"><%=Formater.formatAmount(near30SearchAmount.principalAmount) %>
                            </em> 元</span>
                            <span class="mr30">剩余应还总额：<em
                                    class="red"><%=Formater.formatAmount(near30SearchAmount.residueAmount) %>
                            </em> 元</span>
                        </div>
                        <!--分页-->
                        <%
                            AbstractConsoleServlet.rendPagingResult(out, near30s);
                        %>
                        <!--分页 end-->
                    </form>
                    <%
                        if (near30Array != null && near30Array.length > 0) {
                            for (int i = 0; i < near30Array.length; i++) {
                                Near30 near30 = near30Array[i];
                                if (near30 == null) {
                                    continue;
                                }
                                StayRefundInfo stayRefundInfo = collectionManage.findStayRefund(near30.collectionId);
                                if (stayRefundInfo == null) {
                                    continue;
                                }
                    ...
                    <div id="cs_<%=i%>" class="popup-box hide">
                        ...
                        <div class="popup-content-container-2" style="max-height:550px;">
                            <form action="<%=controller.getURI(request, Cscl.class)%>" method="post" class="form<%=i%>">
                                ...
                                <input type="hidden" name="collectionId" value="<%=near30.collectionId %>"/>
                                <input type="hidden" name="bidNum" value="<%=stayRefundInfo.bidNum %>"/>
            ...
            <div class="p30">
                <ul class="gray6">
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl">催收方式：</span>
                        <div class="pl120">
                            <label for="Xianxia-tel">
                                <input name="collectionType" type="radio" value="ZNX" onclick="show(this);" checked="checked" class="mr5"/>站内信</label>
                            <label for="Xianxia-tel">
                    ...
                    <li class="mb15" id="mail" style="display: none"><span class="display-ib tr mr5 w120 fl">
                    	<em class="red mr5">*</em>邮箱：</span>
                        <div class="pl120">
                            ...
                            <span tip></span>
                            <span errortip class="red display-b ww90 mt10" style="display: none"></span>
                        </div>
                    </li>
                    <li class="mb15" id="title"><span class="display-ib tr mr5 w120 fl"><em
                            class="red mr5">*</em>标题：</span>
                    ...
                    <li class="mb15" id="number" style="display: none"><span class="display-ib tr mr5 w120 fl"><em
                            class="red mr5">*</em>电话号码：</span>
                        <div class="pl120">
                    ...
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl"><em class="red mr5">*</em>内容：</span>
                        <div class="pl120">
                            <textarea name="comment" id="keyWord"
                                      class="ww60 border required max-length-150" style="width: 446px;height: 180px;"></textarea>
                            <span tip>150字以内</span>
                            <span errortip class="red display-b ww90 mt10" style="display: none"></span>
                        </div>
                    </li>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        <%if (near30Array != null) {for (int i =0;i<near30Array.length;i++){Near30 near30=near30Array[i];if (near30 == null) {continue;}%>
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, DcJsst.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, JsstList.class)%>";
    }

    function showCs(i) {
    	//清空之前的数据
    	var csid = "#cs_" + i;
    	$(csid + " textarea[name='resultDesc']").val("");
    	$(csid+" input[name='collectionPerson']").val("");
    	$(csid+" input[name='collectionTime']").val("");
    	$(csid+" textarea[name='comment']").val("");
