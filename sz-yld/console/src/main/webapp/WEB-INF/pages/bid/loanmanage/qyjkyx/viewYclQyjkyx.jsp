                        ...
                        <div class="content-container pl40 pt30 pr40">
                            <ul class="gray6">
                                ...
                                <li class="mb10"><span class="display-ib w200 tr mr5">借款类型：</span>
                                    <input type="checkbox" <%if (qyjkyx.F18 == T6281_F18.S) { %> checked="checked"<%}%>
                                           disabled/>抵押
                                    <input type="checkbox" <%if (qyjkyx.F19 == T6281_F19.S) { %> checked="checked"<%}%>
                                           disabled/>实地认证
                                    <input type="checkbox" <%if (qyjkyx.F20 == T6281_F20.S) { %> checked="checked"<%}%>
                                           disabled/>担保
                                </li>
                                <li class="mb10"><span
                                ...
                                <li class="mb10"><span
                                        class="display-ib w200 tr mr5">处理人：</span><%StringHelper.filterHTML(out, qyjkyx.clr);%>
                                </li>
                                <li class="mb10"><span
                                        class="display-ib w200 tr mr5">处理时间：</span><%=TimestampParser.format(qyjkyx.F17)%>
                                </li>
                                <li class="mb10"><span
                                        class="display-ib w200 tr mr5">处理结果描述：</span><%StringHelper.filterHTML(out, qyjkyx.F21);%>
                                </li>
                                <li class="mb10">
                                    <div class="pl200 ml5">
