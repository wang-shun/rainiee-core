...
<%@page import="com.dimeng.p2p.console.servlets.bid.lcgl.zqgl.YfkExport" %>
...
<%
    ...
    BigDecimal yfkAmountCount = (BigDecimal)request.getAttribute("yfkAmountCount");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, YfkList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                                ...
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">投资时间</span> <input
                                            ...
                                            class="pl5 pr5">至</span> <input type="text"
                                                                            ...
                                                                            id="datepicker2"
                                                                            class="text border pl5 mr20 w120 date"/></li>
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(YfkExport.class)) {
                        ...
                        <div class="mb10">持有债权总金额：
                        	<em class="red"><%=Formater.formatAmount(yfkAmountCount) %></em>元
                        </div>
                        <!--分页-->
                        <%
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, YfkExport.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, YfkList.class)%>";
    }
</script>
</body>
</html>