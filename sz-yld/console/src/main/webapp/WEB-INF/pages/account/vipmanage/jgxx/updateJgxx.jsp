                ...
                <div class="p20">
                    ...
                    <div class="border mt20">
                        ...
                        <div class="tab-content-container p20">
                            ...
                            <div class="tab-item">
                                <form id="form1" action="<%=controller.getURI(request, UpdateJgxx.class)%>" method="post"
                                      class="form1">
                                    ...
                                    <ul class="gray6">
                                        ...
                                        <li class="mb10"><span class="display-ib w200 tr mr5 fl"><em
                                                class="red pr5">*</em>担保机构介绍：</span>
                                            <textarea name="jgmx" cols="" rows=""
                                                      class="w400 h120 border p5 required max-length-255"><%StringHelper.format(out, entity.jgmx, fileStore); %></textarea>
                                            <span tip></span>
                                            <span errortip class="red" style="display: none"></span>
                                        </li>
                                        <% 
							           ...
							           <input name="F21" maxlength="20"  type="text" class="text border w300 pl5 yhgl_ser required" value="<%StringHelper.filterHTML(out,entity.F21);%>" />
							            <span tip></span>
										 <span errortip class="red" style="display: none"></span>
							            </li>
							            <% } %>
                                        ...
                                        %>
	                                     <li class="mb10"><span
	                                        ...
	                                        <label class="cursor-p display-ib mr50 pt5 pb5" for="ChoiceIs"> 
	                                        	<input type="radio" name="isBuyBadClaim" class="mr10" value="S" <%if(T6110_F19.S == t6110_f19){ %>checked="checked"<%} %>/>是
	                                        </label>
	                                        <label class="cursor-p display-ib mr50 pt5 pb5" for="ChoiceNo"> 
	                                        	<input type="radio" name="isBuyBadClaim" class="mr10" value="F" <%if(T6110_F19.F == t6110_f19){ %>checked="checked"<%} %>/>否
	                                        </label>
