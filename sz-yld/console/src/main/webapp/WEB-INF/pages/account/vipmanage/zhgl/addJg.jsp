...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <div class="p20">
                    <form action="<%=controller.getURI(request, AddJg.class)%>"
                          method="post" class="form1">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>增加机构账号
                            </div>
                            <div class="content-container pl40 pt40 pr40 pb20">
                                <ul class="gray6">
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>企业名称：</span> <input name="F04" maxlength="20"
                                                                                     type="text"
                                               ...
                                               value="<%=request.getParameter("F20")%>"> <label
                                                ...
                                                for="ChoiceIs"> <input type="radio" name="szhy"
                                                        ...
                                                        for="ChoiceNo"> <input id="szhy2" type="radio"
                                                                               ...
                                                                               onclick="szhyCheck()"
                                                                               <%if("N".equals(request.getParameter("F20")) || StringHelper.isEmpty(request.getParameter("F20"))){ %>checked="checked"<%} %>/>否
                                        </label>

                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>
                                    <li id="shxy" class="mb10 sszhy"><span
                                            class="display-ib w200 tr mr5"><em class="red pr5">*</em>社会信用代码：</span>
                                        <input id="idF19" name="F19" maxlength="18" type="text" mtest="/^([A-Za-z0-9]+){18}$/" mtestmsg="长度为18位，由字母,数字组成"
                                        ...
                                        <span id="idShxy" style="display: none; color: red;"></span></li>
                                    <li id="yyzz" class="mb10 nszhy"><span
                                            class="display-ib w200 tr mr5"><em class="red pr5">*</em>营业执照登记注册号</span>
                                        ...
                                        <span errortip class="" style="display: none"></span>
                                        <span id="idShxy" style="display: none; color: red;"></span></li>
                                    <li id="nsh" class="mb10 nszhy"><span
                                            class="display-ib w200 tr mr5"><em class="red pr5">*</em>企业纳税号：</span>
                                        ...
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>
                                    <li id="jgdm" class="mb10 nszhy"><span
                                            class="display-ib w200 tr mr5"><em class="red pr5">*</em>组织机构代码：</span>
                                        ...
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>注册年份：</span> <input name="F07" maxlength="4"
                                                                                      type="text"
                                                                                      class="text border w300 pl5 required isyear max-length-4 min-length-4"
                                                                                      value="<%StringHelper.filterHTML(out, request.getParameter("F07"));%>"/><span
                                            class="ml5">年</span>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>注册资金：</span> <input name="F08" type="text"
                                                                                      class="text border w300 pl5 required"
                                                                                      maxlength="15"
                                                                                      mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/"
                                                                                      mtestmsg="必须为数字格式，且最多为两位小数"
                                                                                      value="<%StringHelper.filterHTML(out, request.getParameter("F08"));%>"/><span
                                            class="ml5">万元</span>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>行业：</span> <input name="F09" maxlength="20"
                                                                                    type="text"
                                                                                    class="text border w300 pl5 required"
                                    ...
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>企业规模：</span> <input name="F10" maxlength="9"
                                                                                      minlength="1" type="text"
                                                                                      class="text border w300 pl5 required isint"
                                                                                      value="<%StringHelper.filterHTML(out, request.getParameter("F10"));%>"/><span
                                            class="ml5">人</span>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>

                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>法人：</span> <input name="F11" maxlength="11"
                                                                                    type="text"
                                                                                    class="text border w300 pl5 required"
                                        ...
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>法人身份证号：</span> <input name="F12"
                                        ...
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>资产净值：</span> <input name="F14" type="text"
                                                                                      class="text border w300 pl5 required"
                                                                                      maxlength="15"
                                                                                      mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/"
                                                                                      mtestmsg="必须为数字格式，且最多为两位小数"
                                                                                      value="<%StringHelper.filterHTML(out, request.getParameter("F14"));%>"/><span
                                            class="ml5">万元</span>
                                        ...
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>上年度经营现金流入：</span> <input name="F15"
                                                                                           type="text"
                                                                                           class="text border w300 pl5 required"
                                                                                           maxlength="15"
                                                                                           mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/"
                                                                                           mtestmsg="必须为数字格式，且最多为两位小数"
                                                                                           value="<%StringHelper.filterHTML(out, request.getParameter("F15"));%>"/><span
                                            class="ml5">万元</span>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>法人手机号码：</span> <input name="mobile"
                                        ...
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>法人邮箱地址：</span> <input name="email"
                                                                                        maxlength="50" type="text"
                                                                                        class="text border w300 pl5 required email"
                                                                                        value="<%StringHelper.filterHTML(out, request.getParameter("email"));%>"/>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span></li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5">企业联系人：</span> <input name="realName"
                                    ...
                                    <li class="mb10">
                                        <span class="display-ib w200 tr mr5 fl"><em class="red pr5">*</em>担保机构介绍：</span>
                                        <textarea name="dbjgms" cols="" rows=""
                                                  class="w400 h120 border p5 required max-length-255"><%StringHelper.format(out, request.getParameter("dbjgms"), fileStore); %></textarea>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span>
                                    </li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5 fl"><em
                                            class="red pr5"></em>担保情况描述：</span>

                                        <div class="pl200 ml5">
                                            <textarea name="jgjs" cols="" rows=""
                                                      class="area required max-length-60000"> <%StringHelper.format(out, request.getParameter("jgjs"), fileStore); %></textarea>
                                    ...
                                    %>
									<li class="mb10"><span class="display-ib w200 tr mr5"><em
                                            class="red pr5">*</em>开户银行许可证：</span> <input name="F21"
                                                                                       maxlength="20" type="text"
                                                                                       class="text border w300 pl5 required yhgl_ser"
                                    ...
                                    %>
                                     <li class="mb10"><span
	                                        ...
	                                        <label class="cursor-p display-ib mr50 pt5 pb5" for="ChoiceIs"> 
	                                        	<input type="radio" name="isBuyBadClaim" class="mr10" value="S" <%if("S".equals(request.getParameter("isBuyBadClaim"))){ %>checked="checked"<%} %>/>是
	                                        </label>
	                                        <label class="cursor-p display-ib mr50 pt5 pb5" for="ChoiceNo"> 
	                                        	<input type="radio" name="isBuyBadClaim" class="mr10" value="F" <%if("F".equals(request.getParameter("isBuyBadClaim")) || StringHelper.isEmpty(request.getParameter("isBuyBadClaim"))){ %>checked="checked"<%} %>/>否
	                                        </label>
                                        ...
                                        <div class="pl200 ml5">
                                            <input type="submit"
                                                   ...
                                                   value="提交" fromname="form1"/> <input type="button"
                                                                                        onclick="window.location.href='<%=controller.getURI(request, ZhList.class)%>'"
...
<script type="text/javascript">
    ...
    KindEditor.ready(function (K) {
        editor1 = K.create('textarea[name="jgjs"]', {
