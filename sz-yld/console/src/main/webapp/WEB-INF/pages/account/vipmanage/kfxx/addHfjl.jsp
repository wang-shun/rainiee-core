                        ...
                        <form action="<%=controller.getURI(request, AddHfjl.class)%>" method="post" class="form1">
                            <ul class="cell noborder no_wi">
                                ...
                                <li>
                                    ...
                                    <div class="info fl">
                                        <textarea name="F03" class="yhgl_ser required  max-length-100" cols="100"
                                                  rows="8"
                                                  style="width:400px;height:200px;"><%StringHelper.format(out, request.getParameter("content"), fileStore); %></textarea>
                                ...
                                <li>
                                    ...
                                    <div class="info">
                                        <input type="text" readonly="readonly" id="datepicker1" name="F04"
                            ...
                            <div class="tc w220">
                                ...
                                <input type="button" class="btn4"
                                       onclick="window.location.href='<%=controller.getURI(request, KfList.class)%>'"
                                       value="返回"/></div>
                            <div class="clear"></div>
                        </form>
                    </div>
