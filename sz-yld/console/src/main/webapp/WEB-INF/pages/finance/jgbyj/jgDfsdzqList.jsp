...
<%@page import="com.dimeng.p2p.console.servlets.finance.jgbyj.ExportDfsdzq" %>
...
<%
    Dfsdzq dfsdzq = ObjectHelper.convert(request.getAttribute("dfsdzq"), Dfsdzq.class);
    PagingResult<DfsdzqRecord> result = (PagingResult<DfsdzqRecord>) request.getAttribute("result");
%>
<%
    CURRENT_CATEGORY = "CWGL";
    CURRENT_SUB_CATEGORY = "JGXBYJGL";
%>
<body>
...
<div class="w_main">
    <div class="main clearfix">
        <div class="wrap">
            <div class="r_main">
                <form action="<%=controller.getURI(request, JgDfsdzqList.class)%>" name="form1" method="post"
                      id="searchForm">
                    ...
                    <div class="home_main">
                        <div class="box box1 mb15">
                            ...
                            <div class="con">
                                ...
                                <ul class="yhxq_li">
                                    <li>
                                        垫付返还金额：<span
                                            class="blue"><%=Formater.formatAmount(dfsdzq.paymentRestore)%></span>元
                                    </li>
                                </ul>
                                <ul class="yhxq_li">
                                    <li>
                            ...
                            <div class="con">
                                <div class="admin_input admin_pb">
                                    <div class="table">
                                        ...
                                        <p>
                                            <span>垫付时间：</span>
                                            <input type="text" name="startPaymentTime" id="datepicker1"
                                                   readonly="readonly"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("startRechargeTime"));%>"
                                                   class="yhgl_input date"/>至
                                            <input type="text" name="endPaymentTime" id="datepicker2"
                                                   readonly="readonly"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("endRechargeTime"));%>"
                                        ...
                                        <div class="mt10">
                                            ...
                                            %>
                                            <a href="javascript:void(0)" onclick="showExport()" class="btn3"><span
                                                    class="ico"></span>导出</a>
                                            <%} else { %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                            ...
                            <tr class="dhsbg">
                                ...
                                <td><%=DateTimeParser.format(record.paymentTime, "yyyy-MM-dd HH:mm")%>
                                </td>
                                <td><%=Formater.formatAmount(record.paymentAmount)%>
                                </td>
                                <td><%=record.id%>
                                </td>
                                <td><%
                                    StringHelper.filterHTML(out, record.loginName);
                                %></td>
                                <td><%=Formater.formatAmount(record.paymentRestore)%>
                                </td>
                                <td><%=record.residueDeadLine%>/<%=record.day%>
                                </td>
                                <td><%=Formater.formatAmount(record.restoreAmount)%>
                                </td>
                                <td><%=DateParser.format(record.nextRestoreTime)%>
                                </td>
...
<script type="text/javascript">
    function showExport() {
        ...
        $("#searchForm").submit();
        document.getElementById("searchForm").action = "<%=controller.getURI(request, JgDfsdzqList.class)%>";
    }
    $(function () {
