...
<%@page import="com.dimeng.p2p.console.servlets.finance.txgl.txsb.TxglView" %>
                    ...
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>提现失败
                            </div>
