                    ...
                    <div class="border mt20">
                        <div class="tabnav-container">
                            <ul class="clearfix pr pr80">
                                ...
                                <li><a href="javascript:void(0);" class="tab-btn-click select-a">个人信息<i
                        ...
                        <div class="tab-content-container p20">
                            ...
                            <div class="tab-item">
                                <ul class="gray6">
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em class="red pr5">*</em>真实姓名：</span>
                                        <%StringHelper.filterHTML(out, user.name);%>
                                    </li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em class="red pr5">*</em>身份证号：</span>
                                        <%StringHelper.filterHTML(out, StringHelper.decode(user.sfzh));%>
                                    </li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em class="red pr5">*</em>手机：</span>
                                        <%StringHelper.filterHTML(out, user.phone);%>
                                    </li>
                                    <li class="mb10"><span class="display-ib w200 tr mr5"><em class="red pr5"><%if(BooleanParser.parse(mYxrz)){%>*<%}%></em>邮箱：</span>
