package com.dimeng.p2p.console.servlets.info.tzgl.wylc;
...
public class UpdateWylc extends AbstractWylcServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.WYLC.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.WYLC);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.WYLC, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.WYLC);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("WYLC");
