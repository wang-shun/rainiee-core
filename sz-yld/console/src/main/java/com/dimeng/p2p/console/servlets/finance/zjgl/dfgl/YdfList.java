...
public class YdfList extends AbstractFinanceServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<DfRecord> dfRecord = collectionManage.ydfSearch(yqddfQuery, new Paging()
        {
        ...
        DfRecord ydfSearchAmount = collectionManage.ydfSearchAmount(yqddfQuery);
        request.setAttribute("dfRecord", dfRecord);
        request.setAttribute("ydfSearchAmount", ydfSearchAmount);
