...
public class SearchHlwjryj extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        ...
        ArticleQuery query = new ArticleQuery()
        {
            ...
            {
                return TimestampParser.parse(request.getParameter("pulishTimeStart"));
            }
            
            @Override
            public Timestamp getPublishTimeEnd()
            {
                return TimestampParser.parse(request.getParameter("pulishTimeEnd"));
            }
            ...
            {
                return TimestampParser.parse(request.getParameter("lastUpdateTimeStart"));
            }
            
            @Override
            public Timestamp getLastUpdateTimeEnd()
            {
                return TimestampParser.parse(request.getParameter("lastUpdateTimeEnd"));
            }
        };
