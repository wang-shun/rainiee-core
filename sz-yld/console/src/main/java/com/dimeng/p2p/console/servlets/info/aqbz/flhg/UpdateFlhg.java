package com.dimeng.p2p.console.servlets.info.aqbz.flhg;
...
public class UpdateFlhg extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.FLHG.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.FLHG);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.FLHG, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.FLHG);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("FLHG");
