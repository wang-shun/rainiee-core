...
public class AddCzytxWtlx extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        ...
        try
        {
            ...
            manage.addQuestionType(T5011_F02.CZYTX, question);
            sendRedirect(request, response, getController().getURI(request, SearchCzytxWtlx.class));
        }
