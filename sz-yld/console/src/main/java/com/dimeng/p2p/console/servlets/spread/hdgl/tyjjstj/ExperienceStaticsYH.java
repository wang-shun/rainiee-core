...
public class ExperienceStaticsYH extends AbstractSpreadServlet {
        ...
        throws Throwable
    {
        ...
        PagingResult<ExperienceStatistics> result = experienceManage.searchYh(experienceStatisticsQuery, new Paging()
        {
        ...
        ExperienceStatistics searchYhAmount = experienceManage.searchYhAmount(experienceStatisticsQuery);
        ...
        request.setAttribute("searchYhAmount", searchYhAmount);
