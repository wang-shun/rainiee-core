...
public class PaymentAccountStatistics extends AbstractStatisticsServlet {
	...
	protected void processPost(final HttpServletRequest request,
        ...
        RepaymentStatisticsEntity paymentAccountTotal = repaymentInfoManage.getPaymentAccountTotal(query);
		request.setAttribute("result", result);
        request.setAttribute("paymentAccountTotal", paymentAccountTotal);
