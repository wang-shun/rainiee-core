package com.dimeng.p2p.console.servlets.spread.tgjl.tgjlgy;
...
@Right(id = "P2P_C_SPREAD_TGTJ_SEARCH", isMenu=true, name = "推广奖励概要列表", moduleId = "P2P_C_SPREAD_TGJL_GYLIST", order = 0)
public class SearchTgtj extends AbstractSpreadServlet{
	...
	protected void processPost(final HttpServletRequest request,
        ...
        SpreadTotalList searchTotalListAmount = manage.searchTotalListAmount(query);
		request.setAttribute("result", result);
		request.setAttribute("totalInfo", totalInfo);
        request.setAttribute("searchTotalListAmount", searchTotalListAmount);
