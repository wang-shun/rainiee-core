...
@Right(id = "P2P_C_FINANCE_PTZJMX",  name = "平台资金明细", moduleId="P2P_C_FINANCE_PT_ZJMX", order = 0)
public class PtzjDetail extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<ZjDetailView> ptzjDetailViewList = fundsManage.queryGrzjDetail(query,
				new Paging() {
		...
		request.setAttribute("ptzjDetailViewList", ptzjDetailViewList);
		request.setAttribute("ptzjDetailCount", fundsManage.queryAmountCount(query));
