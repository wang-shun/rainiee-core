...
@Right(id = "P2P_C_SYS_SETMENU", name = "分配权限",moduleId="P2P_C_SYS_HTZH_YHZGL",order=2)
public class SetMenu extends AbstractSystemServlet
{
        ...
        throws Throwable
    {
        ...
        request.setAttribute("rightBeans", rightBeans);
        ...
        throws Throwable
    {
        ...
        if (roleId > 0)
        {
            ...
            rightManage.setRoleRights(roleId, rightIds.toArray(new String[rightIds.size()]));
            userManage.writeLog("操作日志", "修改角色菜单");
        }
        sendRedirect(request, response, getController().getURI(request, RoleList.class)+"?fromUrl=SetMenu");
    }
