...
public class ViewCreditor extends AbstractBidServlet
{
        ...
        throws Throwable
    {
        ...
        CreditorInfo[] list = null;
        if (viewTransfer != null)
        {
            list = creditorTransferManage.findCreditorInfo(viewTransfer.jkId);
        }
        
        request.setAttribute("viewTransfer", viewTransfer);
        request.setAttribute("creditorInfo", list);
