...
public class UpdateZcydl extends AbstractInformationServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return T5011_F02.ZCYDL.getChineseName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.ZCYDL);
			if (exist == null) {
				manage.add(T5011_F02.ZCYDL, article);
			} else {
	...
	protected void processGet(HttpServletRequest request,
		...
		String content = manage.getContent(T5011_F02.ZCYDL);
