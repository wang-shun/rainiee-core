package com.dimeng.p2p.console.servlets.base.bussettings.bfjlx;
...
@Right(id = "P2P_C_BASE_BFJLXUPDATE", name = "修改标附件类型状态", moduleId = "P2P_C_BASE_OPTSETTINGS_BFJLX")
public class TyBfjlx extends AbstractBaseServlet {
	...
	protected void onThrowable(HttpServletRequest request,
		...
		if (throwable instanceof SQLException) {
			...
			sendRedirect(request, response,
					getController().getURI(request, TyBfjlx.class));
