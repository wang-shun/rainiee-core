package com.dimeng.p2p.console.servlets.spread.tgjl.tgxq;
...
@Right(id = "P2P_C_SPREAD_TGXQ_SEARCH", isMenu=true, name = "推广详情列表", moduleId = "P2P_C_SPREAD_TGJL_XQ", order = 0)
public class SearchTgxq extends AbstractSpreadServlet{
	...
	protected void processPost(final HttpServletRequest request,
        ...
        request.setAttribute("spreadRewardMoney", manage.searchSpreadDetailListAmount(query));
