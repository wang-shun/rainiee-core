...
{
    protected static final Logger logger = Logger.getLogger(AbstractConsoleServlet.class);
        ...
        throws Throwable
    {
        ...
        {
            rtnPageStr.append("<a href=\"javascript:void(0);\" class='disabled previous'>&lt;</a>");
        }
        if (currentPage > 1)
        {
            rtnPageStr.append("<a href='javascript:void(0);' class='number previous'>&lt;</a>");
        }
