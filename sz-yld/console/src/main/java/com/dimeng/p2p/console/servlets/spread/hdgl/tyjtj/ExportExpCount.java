...
/**
 * 功能描述：导出体验金统计列表 详细描述： 1. 默认导出全部的体验金列表 2. 导出根据条件查询出的体验金统计列表
 * 
 * @version [v3.1.2, 2015年10月9日]
 */
@Right(id = "P2P_C_SPREAD_HDGL_EXPORTEXPTJ", name = "导出体验金统计列表", moduleId = "P2P_C_SPREAD_HDGL_TYJTJ")
public class ExportExpCount extends AbstractSpreadServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		ActivityCountEntity[] list = manage.exportActivityExpCountList(query,
		...
		try (BufferedWriter out = new BufferedWriter(
            ...
            for (ActivityCountEntity ace : list) {
                ...
                writer.write(ace.activityType.getChineseName());
				writer.write(ace.expectedTerm);
                writer.write(ace.expStatus.getChineseName());
