 ...
 */
@Right(id = "P2P_C_STATISTICS_QUARTEREXPORT", name = "季度统计导出", moduleId = "P2P_C_STATISTICS_ZJTJ_PT", order = 2)
public class QuarterExport extends AbstractStatisticsServlet
{
