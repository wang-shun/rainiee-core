...
public class UpdateZhyaqWt extends AbstractInformationServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		try {
			...
			manage.updateQuestion(T5011_F02.ZHYAQ,question,IntegerParser.parse(request.getParameter("id")));
			sendRedirect(request, response,getController().getURI(request, SearchZhyaqWt.class));
