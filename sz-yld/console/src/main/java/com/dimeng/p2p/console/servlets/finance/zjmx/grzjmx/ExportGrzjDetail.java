package com.dimeng.p2p.console.servlets.finance.zjmx.grzjmx;
...
@Right(id = "P2P_C_FINANCE_EXPORTGRZJMX", name = "导出", moduleId="P2P_C_FINANCE_GR_ZJMX", order = 1)
public class ExportGrzjDetail extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<ZjDetailView> grzjDetailViewList = fundsManage.queryGrzjDetail(
					new GrzjDetailQuery() {
		...
		fundsManage.exportGrzjDetail(grzjDetailViewList.getItems(),
