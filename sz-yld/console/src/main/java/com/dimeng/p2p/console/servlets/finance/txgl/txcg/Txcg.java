package com.dimeng.p2p.console.servlets.finance.txgl.txcg;
...
@Right(id = "P2P_C_WITHDRAW_TXCG", name = "提现成功", moduleId = "P2P_C_FINANCE_TXGL_TXCG", order = 0)
public class Txcg extends AbstractFinanceServlet
{
