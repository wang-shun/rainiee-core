...
//@Right(id = "P2P_C_FINANCE_PTDF_EXPORT", name = "导出", moduleId="P2P_C_FINANCE_ZJGL_PTDFGL", order = 2)
public class DcYqddf extends AbstractSystemServlet
{
        ...
        throws Throwable
    {
        ...
        DfRecord[] dfRecord = null;
        if (dfType != null && !T5131_F02.N.name().equals(dfType.name()))
        {
            dfRecord = collectionManage.yqddfSearch(new DfQuery()
            {
                @Override
        ...
        collectionManage.exportYqddf(dfRecord, response.getOutputStream(), "");
    }
