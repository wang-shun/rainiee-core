package com.dimeng.p2p.console.servlets.system.syslog.operlog;
...
@Right(id = "P2P_C_SYS_OPERLOGLIST", isMenu = true, name = "后台日志",moduleId="P2P_C_SYS_SYSLOG_HTRZ")
public class OperLogList extends AbstractSystemServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		OperLogQuery query = new OperLogQuery() {
            ...
            {
                return EnumParser.parse(ConsoleLogType.class, request.getParameter("type"));
            }
		};
