package com.dimeng.p2p.console.servlets.info.xxpl.zzxx;
...
public class UpdateZzxx extends AbstractXxplServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return T5011_F02.ZZXX.getChineseName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.ZZXX);
			...
			if (exist == null) {
				manage.add(T5011_F02.ZZXX, article);
			} else {
	...
	protected void processGet(HttpServletRequest request,
		...
		String content = manage.getContent(T5011_F02.ZZXX);
		request.setAttribute("content", content);
		T5010 t5010 = manage.getArticleTypeByCode("ZZXX");
