...
public class DcDfyjq extends AbstractSystemServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<DfRecord> dfRecord = collectionManage.dfyjqSearch(new DfQuery()
        {
        ...
        collectionManage.exportDffh(dfRecord.getItems(), response.getOutputStream(), "");
    }
