package com.dimeng.p2p.console.servlets.info.aqbz.byjdf;
...
public class UpdateByjdf extends AbstractInformationServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return T5011_F02.BYJDFWB.getChineseName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.BYJDFWB);
			if (exist == null) {
				manage.add(T5011_F02.BYJDFWB, article);
			} else {
				manage.update(exist.id, article);
			}
			String content = manage.getContent(T5011_F02.BYJDFWB);
