...
public class YqList extends AbstractBidServlet {
        ...
        throws Throwable
    {
        ...
        Less30Query less30Query = new Less30Query()
        {
            ...
            {
                return EnumParser.parse(IsHovestatus.class, request.getParameter("state"));
            }
        ...
        PagingResult<Less30> less30s = collectionManage.less30Search(less30Query, new Paging()
        {
        ...
        Less30 less30SearchAmount = collectionManage.less30SearchAmount(less30Query);
        request.setAttribute("stayRefundGather", stayRefundGather);
        request.setAttribute("less30s", less30s);
        request.setAttribute("less30SearchAmount", less30SearchAmount);
