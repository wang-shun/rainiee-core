...
@Right(id = "P2P_C_BASE_XYRZXVIEW", name = "修改信用认证项", moduleId = "P2P_C_BASE_OPTSETTINGS_XYRZX")
public class ViewXyrzx extends AbstractBaseServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        if (throwable instanceof SQLException)
        {
            ...
            sendRedirect(request, response, getController().getURI(request, ViewXyrzx.class));
