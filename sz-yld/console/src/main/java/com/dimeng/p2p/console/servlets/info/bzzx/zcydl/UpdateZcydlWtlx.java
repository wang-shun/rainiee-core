...
public class UpdateZcydlWtlx extends AbstractInformationServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		try {
			...
			manage.updateQuestionType(T5011_F02.ZCYDL,article,IntegerParser.parse(request.getParameter("id")));
			sendRedirect(request, response,
					getController().getURI(request, SearchZcydlWtlx.class));
