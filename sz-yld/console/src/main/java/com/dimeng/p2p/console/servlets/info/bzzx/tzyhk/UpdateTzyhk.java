...
public class UpdateTzyhk extends AbstractInformationServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return T5011_F02.TZYHK.getChineseName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.TZYHK);
			if (exist == null) {
				manage.add(T5011_F02.TZYHK, article);
			} else {
	...
	protected void processGet(HttpServletRequest request,
		...
		String content = manage.getContent(T5011_F02.TZYHK);
