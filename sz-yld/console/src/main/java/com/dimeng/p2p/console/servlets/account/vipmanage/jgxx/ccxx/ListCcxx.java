package com.dimeng.p2p.console.servlets.account.vipmanage.jgxx.ccxx;
...
@Right(id = "P2P_C_ACCOUNT_JGLIST", isMenu=true, name = "机构信息",moduleId="P2P_C_ACCOUNT_JGXX",order=0)
public class ListCcxx extends AbstractAccountServlet {
