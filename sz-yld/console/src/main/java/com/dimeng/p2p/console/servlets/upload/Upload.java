	...
	protected void processPost(HttpServletRequest request,
		...
		if (parts != null && parts.size() > 0) {
			for (Part part : parts) {
				...
				{
					String postfix=String.valueOf(FileUploadUtils.getType(part.getInputStream()))!=null?String.valueOf(FileUploadUtils.getType(part.getInputStream())):"";
					String rtnMsg = "不支持" + postfix + "此类文件上传！";
					out.print("{\"error\":1,\"message\":\""+rtnMsg+"\"}");
					return;
				}
