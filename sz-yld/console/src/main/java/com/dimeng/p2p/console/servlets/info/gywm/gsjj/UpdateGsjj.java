package com.dimeng.p2p.console.servlets.info.gywm.gsjj;
...
import com.dimeng.p2p.console.servlets.info.tzgl.lxhfy.AbstractLxhfyServlet;
...
public class UpdateGsjj extends AbstractLxhfyServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.GSJJ.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.GSJJ);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.GSJJ, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.GSJJ);
            T5010 t5010 = manage.getArticleTypeByCode("GSJJ");
