...
@Right(id = "P2P_C_BASE_DYWSXVIEW", name = "修改抵押物属性")
public class ViewDywsx extends AbstractBaseServlet {
	...
	protected void onThrowable(HttpServletRequest request,
		...
		if (throwable instanceof SQLException) {
			...
			sendRedirect(request, response,
					getController().getURI(request, ViewDywsx.class));
