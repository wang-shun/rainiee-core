...
public class GrxlxxView extends AbstractAccountServlet
{

    /**
     * 注释内容
     */
    private static final long serialVersionUID = -5609189736279812115L;
    ...
    protected void processPost(final HttpServletRequest request,
        ...
        PagingResult<T6142> resultXlxx = manage.seachXlxx(paging,userId);
        request.setAttribute("basicInfo", basicInfo);
        request.setAttribute("resultXlxx", resultXlxx);
