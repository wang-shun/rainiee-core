...
@Right(id = "P2P_C_BUSI_ZQZRXJ", name = "下架[批量下架]", moduleId = "P2P_C_BID_LCGL_ZQZRGL", order = 2)
public class ZqzrxjManage extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,final HttpServletResponse response,
		...
		creditorTransferManage.zqzrxj(ids);
