...
public class ExportOverdueStatistics extends AbstractFinanceServlet
{
        ...
        throws Throwable
    {
        ...
        repaymentInfoManage.exportOverdue(result.getItems(),
            repaymentInfoManage.getOverdueTotal(query),
