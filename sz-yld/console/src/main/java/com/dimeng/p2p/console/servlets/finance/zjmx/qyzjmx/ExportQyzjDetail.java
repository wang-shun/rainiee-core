...
@Right(id = "P2P_C_FINANCE_EXPORTQYZJMX", name = "导出", moduleId="P2P_C_FINANCE_QY_ZJMX", order = 1)
public class ExportQyzjDetail extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<ZjDetailView> qyzjDetailViewList = fundsManage.queryGrzjDetail(
					new GrzjDetailQuery() {
		...
		fundsManage.exportGrzjDetail(qyzjDetailViewList.getItems(),
