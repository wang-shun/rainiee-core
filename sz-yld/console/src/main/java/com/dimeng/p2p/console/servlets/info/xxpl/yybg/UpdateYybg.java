package com.dimeng.p2p.console.servlets.info.xxpl.yybg;
...
public class UpdateYybg extends AbstractXxplServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            t5011_3.F06 = year;
            ArticleManage manage = serviceSession.getService(ArticleManage.class);
            manage.update(IntegerParser.parse(request.getParameter("id")), T5011_F02.YYBG, article, t5011_3, file);
            sendRedirect(request, response, getController().getURI(request, SearchYybg.class));
        }
