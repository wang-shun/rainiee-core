...
@Right(id = "P2P_C_BASE_REGION_ENABLE", name = "区域启用", moduleId = "P2P_C_BASE_OPTSETTINGS_REGION")
public class Enable extends AbstractBaseServlet {
