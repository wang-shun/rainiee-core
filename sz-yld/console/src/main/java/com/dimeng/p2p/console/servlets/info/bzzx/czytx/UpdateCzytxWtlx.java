...
public class UpdateCzytxWtlx extends AbstractInformationServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		try {
			...
			manage.updateQuestionType(T5011_F02.CZYTX,article,IntegerParser.parse(request.getParameter("id")));
