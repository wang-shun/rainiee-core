...
@Right(id = "P2P_C_BASE_REGION_DISABLEALL", isMenu = true, name = "区域全部停用", moduleId = "P2P_C_BASE_OPTSETTINGS_REGION")
public class DisableAll extends AbstractBaseServlet {
