...
public class TransferFinishList extends AbstractBidServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TransferDshEntity> transferDshs =
            creditorTransferManage.transferDshSearch(transferDshQuery, T6260_F07.YJS, new Paging()
            {
        ...
        TransferDshEntity transferYjsAmount = creditorTransferManage.transferDshAmount(transferDshQuery, T6260_F07.YJS);
        request.setAttribute("transferYjsAmount", transferYjsAmount);
