...
public class UpdateCzytx extends AbstractInformationServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return T5011_F02.CZYTX.getChineseName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.CZYTX);
			if (exist == null) {
				manage.add(T5011_F02.CZYTX, article);
			} else {
	...
	protected void processGet(HttpServletRequest request,
		...
		String content = manage.getContent(T5011_F02.CZYTX);
