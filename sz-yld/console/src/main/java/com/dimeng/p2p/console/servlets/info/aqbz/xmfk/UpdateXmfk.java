package com.dimeng.p2p.console.servlets.info.aqbz.xmfk;
...
public class UpdateXmfk extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.XMFK.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.XMFK);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.XMFK, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.XMFK);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("XMFK");
