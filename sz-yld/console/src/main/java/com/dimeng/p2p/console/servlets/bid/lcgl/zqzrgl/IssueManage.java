...
@Right(id = "P2P_C_BUSI_ZQSHTG", name = "通过[批量发布]", moduleId = "P2P_C_BID_LCGL_ZQZRGL", order = 3)
public class IssueManage extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,final HttpServletResponse response,
		...
		creditorTransferManage.shtg(ids);

		// 重定向
		sendRedirect(request, response, getController().getURI(request, TransferProceedList.class));
	}
