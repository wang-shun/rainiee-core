...
public class TbzList extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,final HttpServletResponse response,
        ...
        PagingResult<Creditor> creditors = creditorManage.creditorTbzSearch(creditorQuery, new Paging()
        {
        ...
        request.setAttribute("tbzAmountCount", creditorManage.creditorTbzAmountCount(creditorQuery));
