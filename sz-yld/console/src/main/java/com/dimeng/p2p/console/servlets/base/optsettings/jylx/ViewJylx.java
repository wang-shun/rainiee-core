...
@Right(id = "P2P_C_BASE_JYLXVIEW", name = "修改", moduleId = "P2P_C_BASE_OPTSETTINGS_TRANTYPE", order = 1)
public class ViewJylx extends AbstractBaseServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        if (throwable instanceof SQLException)
        {
            ...
            sendRedirect(request, response, getController().getURI(request, ViewJylx.class));
