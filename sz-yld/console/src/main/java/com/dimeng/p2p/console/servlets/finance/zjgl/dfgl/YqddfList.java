...
public class YqddfList extends AbstractFinanceServlet
{
        ...
        throws Throwable
    {
        ...
        T5131_F02 dfType = collectionManage.selectT5131();
        DfRecord yqddfSearchAmount = null;
        PagingResult<DfRecord> dfRecord = null;
        if (dfType == null || T5131_F02.N.name().equals(dfType.name()))
        {
            yqddfSearchAmount = new DfRecord();
        }
        else
        {
            DfQuery yqddfQuery = new DfQuery()
            {
                ...
                {
                    return T5131_F02.parse(request.getParameter("hkfs"));
                }
            };
            dfRecord = collectionManage.yqddfSearch(yqddfQuery, new Paging()
            {
            ...
            yqddfSearchAmount = collectionManage.yqddfSearchAmount(yqddfQuery);
        }
        request.setAttribute("yqddfSearchAmount", yqddfSearchAmount);
        request.setAttribute("dfRecord", dfRecord);
        request.setAttribute("dfType", dfType);
