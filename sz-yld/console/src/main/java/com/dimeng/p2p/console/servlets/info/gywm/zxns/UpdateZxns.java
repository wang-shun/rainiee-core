package com.dimeng.p2p.console.servlets.info.gywm.zxns;
...
public class UpdateZxns extends AbstractLxhfyServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            ArticleRecord exist = manage.get(T5011_F02.ZXNS);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.ZXNS, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.ZXNS);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("ZXNS");
