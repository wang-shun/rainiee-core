package com.dimeng.p2p.console.servlets.info.xxpl.sfbz;
...
public class UpdateSfbz extends AbstractXxplServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.SFBZ.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.SFBZ);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.SFBZ, article);
            }
            else
            {
    ...
    {
        ArticleManage manage = serviceSession.getService(ArticleManage.class);
        String content = manage.getContent(T5011_F02.SFBZ);
        request.setAttribute("content", content);
        T5010 t5010 = manage.getArticleTypeByCode("SFBZ");
