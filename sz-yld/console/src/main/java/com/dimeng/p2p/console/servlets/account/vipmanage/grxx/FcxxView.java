...
public class FcxxView extends AbstractAccountServlet
{

    /**
     * 注释内容
     */
    private static final long serialVersionUID = 7448018943876804645L;
    ...
    protected void processPost(final HttpServletRequest request,
        ...
        PagingResult<T6112> resultFcxx = manage.seachFcxx(paging,userId);
        request.setAttribute("basicInfo", basicInfo);
        request.setAttribute("resultFcxx", resultFcxx);
