package com.dimeng.p2p.console.servlets.info.aqbz.gctm;
...
public class UpdateGctm extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.GCTM.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.GCTM);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.GCTM, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.GCTM);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("GCTM");
