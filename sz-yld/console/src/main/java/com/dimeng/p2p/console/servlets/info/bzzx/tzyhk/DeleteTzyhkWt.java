...
public class DeleteTzyhkWt extends AbstractInformationServlet {
	...
	protected void processGet(HttpServletRequest request,
		...
		manage.deleteQuestion(IntegerParser.parseArray(request.getParameterValues("id")));
		sendRedirect(request, response,
				getController().getURI(request, SearchTzyhkWt.class));
	}
