...
public class UpdateTzyhkWtlx extends AbstractInformationServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		try {
			...
			manage.updateQuestionType(T5011_F02.TZYHK,article,IntegerParser.parse(request.getParameter("id")));
			sendRedirect(request, response,
					getController().getURI(request, SearchTzyhkWtlx.class));
