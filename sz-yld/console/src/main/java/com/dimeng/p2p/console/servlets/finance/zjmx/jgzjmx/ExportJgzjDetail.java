...
@Right(id = "P2P_C_FINANCE_EXPORTJGZJMX", name = "导出", moduleId="P2P_C_FINANCE_JG_ZJMX", order = 1)
public class ExportJgzjDetail extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<ZjDetailView> jgzjDetailViewList = fundsManage.queryGrzjDetail(
					new GrzjDetailQuery() {
		...
		fundsManage.exportGrzjDetail(jgzjDetailViewList.getItems(),
