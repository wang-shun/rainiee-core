package com.dimeng.p2p.console.servlets.info.gywm.lxwm;
...
public class UpdateLxwm extends AbstractLxhfyServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.LXWM.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.LXWM);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.LXWM, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.LXWM);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("LXWM");
