...
public class YjqList extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,final HttpServletResponse response,
        ...
        PagingResult<Creditor> creditors = creditorManage.creditorYjqSearch(creditorQuery, new Paging()
        {
        ...
        request.setAttribute("yjqAmountCount", creditorManage.creditorYjqAmountCount(creditorQuery));
