...
public class KxrzView extends AbstractAccountServlet
{
        ...
        throws Throwable
    {
        ...
        Attestation[] notNeedAttestation = manage.notNeedAttestation(userId);
        
        request.setAttribute("xyrzTotal", xyrzTotal);
        request.setAttribute("notNeedAttestation", notNeedAttestation);
