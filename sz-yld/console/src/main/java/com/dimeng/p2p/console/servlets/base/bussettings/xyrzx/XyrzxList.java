...
@Right(id = "P2P_C_BASE_XYRZXLIST", isMenu = true, name = "信用认证项管理", moduleId = "P2P_C_BASE_OPTSETTINGS_XYRZX", order = 0)
public class XyrzxList extends AbstractBaseServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<T5123> result = creditCertificationManage.search(new AttestationQuery()
        {
            
            @Override
            public T5123_F03 getType()
            {
                return EnumParser.parse(T5123_F03.class, request.getParameter("type"));
            }
            
            @Override
            public T5123_F04 getStatus()
            {
                return EnumParser.parse(T5123_F04.class, request.getParameter("status"));
            }
            ...
            {
                return EnumParser.parse(T5123_F06.class, request.getParameter("userType"));
            }
        }, new Paging()
        {
