...
public class YfkList extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,final HttpServletResponse response,
        ...
        PagingResult<Creditor> creditors = creditorManage.creditorYfkSearch(creditorQuery, new Paging()
        {
        ...
        request.setAttribute("yfkAmountCount", creditorManage.creditorYfkAmountCount(creditorQuery));
