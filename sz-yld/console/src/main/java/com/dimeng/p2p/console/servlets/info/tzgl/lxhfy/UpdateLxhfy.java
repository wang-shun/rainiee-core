package com.dimeng.p2p.console.servlets.info.tzgl.lxhfy;
...
public class UpdateLxhfy extends AbstractLxhfyServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.LXHFY.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.LXHFY);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.LXHFY, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.LXHFY);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("LXHFY");
