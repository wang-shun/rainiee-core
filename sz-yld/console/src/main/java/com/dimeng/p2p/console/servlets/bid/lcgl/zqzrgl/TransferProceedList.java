...
public class TransferProceedList extends AbstractBidServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<TransferDshEntity> transferDshs =
            creditorTransferManage.transferDshSearch(transferDshQuery, T6260_F07.ZRZ, new Paging()
            {
        ...
        TransferDshEntity transferZrzAmount = creditorTransferManage.transferDshAmount(transferDshQuery, T6260_F07.ZRZ);
        request.setAttribute("transferZrzAmount", transferZrzAmount);
