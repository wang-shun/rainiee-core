...
public class SearchYjbg extends AbstractYjbgServlet
{
        ...
        throws Throwable
    {
        ...
        PerformanceReportQuery query = new PerformanceReportQuery()
        {
            ...
            {
                return EnumParser.parse(PerformanceReportPublishStatus.class, request.getParameter("publishStatus"));
            }
        ...
        PagingResult<PerformanceReportRecord> result = manage.search(query, paging);
