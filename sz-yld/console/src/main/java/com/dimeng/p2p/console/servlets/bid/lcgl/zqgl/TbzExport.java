...
public class TbzExport extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,final HttpServletResponse response,
		...
		PagingResult<Creditor> creditors = creditorManage.creditorTbzSearch(new CreditorQuery() {
		...
		creditorManage.exportTbz(creditors.getItems(), response.getOutputStream(), "");
	}
