 ...
 * @since [产品/模块版本]
 */
@Right(id = "P2P_C_SPREAD_TYJTJ_EXPORT", name = "导出体验金结算统计", moduleId = "P2P_C_SPREAD_HDGL_TYJJSTJ", order = 2)
public class ExportStaticsDH extends AbstractSpreadServlet {
	...
	protected void processPost(final HttpServletRequest request,
        ...
        PagingResult<ExperienceStatistics> result = experienceManage.searchDh(
        ...
        experienceManage.exportexportDH(result.getItems(), response.getOutputStream());
	}
}
