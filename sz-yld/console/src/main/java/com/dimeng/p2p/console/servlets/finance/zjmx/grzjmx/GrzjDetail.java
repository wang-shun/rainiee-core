...
@Right(id = "P2P_C_FINANCE_GRZJMX", name = "个人资金明细", moduleId="P2P_C_FINANCE_GR_ZJMX", order = 0)
public class GrzjDetail extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		request.setAttribute("grzjDetailViewList", grzjDetailViewList);
		request.setAttribute("grzjDetailCount", fundsManage.queryAmountCount(query));
