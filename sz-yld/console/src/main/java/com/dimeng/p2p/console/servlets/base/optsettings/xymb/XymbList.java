package com.dimeng.p2p.console.servlets.base.optsettings.xymb;
...
@Right(id = "P2P_C_BASE_XYMBLIST", isMenu = true, name = "协议模板管理", moduleId = "P2P_C_BASE_OPTSETTINGS_XYMB", order = 0)
