...
@Right(id = "P2P_C_BUSI_QYJKYXLIST", isMenu = true, name = "企业借款意向管理",moduleId="P2P_C_BID_JKGL_QYJKYX",order=0)
public class QyjkyxList extends AbstractBidServlet {
        ...
        throws Throwable
    {
        ...
        QyIntentionQuery qyIntentionQuery = new QyIntentionQuery()
        {
            ...
            {
                return EnumParser.parse(T6281_F14.class, request.getParameter("loanIntentionState"));
            }
        ...
        PagingResult<Qyjkyx> loanIntentions = bidWillManage.searchEnterprise(qyIntentionQuery, new Paging()
        {
        ...
        request.setAttribute("searchEnterpriseAmount", bidWillManage.searchEnterpriseAmount(qyIntentionQuery));
