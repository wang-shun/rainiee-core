...
@Right(id = "P2P_C_BASE_JYLXLIST", isMenu = true, name = "交易类型管理", moduleId = "P2P_C_BASE_OPTSETTINGS_TRANTYPE", order = 0)
public class JylxList extends AbstractBaseServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<T5122> result = tradeTypeManage.search(new TradetypeQuery()
        {
            
            @Override
            public T5122_F03 getStatus()
            {
                return EnumParser.parse(T5122_F03.class, request.getParameter("status"));
            }
