package com.dimeng.p2p.console.servlets.finance.zjmx.jgzjmx;
...
@Right(id = "P2P_C_FINANCE_JGZJMX", name = "机构资金明细", moduleId="P2P_C_FINANCE_JG_ZJMX", order = 0)
public class JgzjDetail extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<ZjDetailView> jgzjDetailViewList = fundsManage.queryGrzjDetail(query,
				new Paging() {
		...
		request.setAttribute("jgzjDetailViewList", jgzjDetailViewList);
		request.setAttribute("jgzjDetailCount", fundsManage.queryAmountCount(query));
