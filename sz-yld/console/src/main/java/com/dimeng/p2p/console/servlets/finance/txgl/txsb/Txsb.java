package com.dimeng.p2p.console.servlets.finance.txgl.txsb;
...
@Right(id = "P2P_C_WITHDRAW_TXSB", name = "提现失败", moduleId = "P2P_C_FINANCE_TXGL_TXSB", order = 0)
public class Txsb extends AbstractFinanceServlet
{
