...
public class ExportRepaymentStatistics extends AbstractFinanceServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<RepaymentStatisticsEntity> result = repaymentInfoManage.getRepaymentList(query, new Paging()
        {
        ...
        repaymentInfoManage.export(result.getItems(),
            repaymentInfoManage.getRepaymentTotal(query),
