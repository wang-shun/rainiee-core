...
public class UpdateZhyaq extends AbstractInformationServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return T5011_F02.ZHYAQ.getChineseName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.ZHYAQ);
			if (exist == null) {
				manage.add(T5011_F02.ZHYAQ, article);
			} else {
	...
	protected void processGet(HttpServletRequest request,
		...
		String content = manage.getContent(T5011_F02.ZHYAQ);
