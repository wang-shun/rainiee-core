package com.dimeng.p2p.console.servlets.info.tzgl.wyjk;
...
public class UpdateWyjk extends AbstractWyjkServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return ArticleType.WYJK.getName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.WYJK);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.WYJK, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.WYJK);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("WYJK");
