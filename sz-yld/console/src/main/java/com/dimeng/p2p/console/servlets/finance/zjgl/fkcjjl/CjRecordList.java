package com.dimeng.p2p.console.servlets.finance.zjgl.fkcjjl;
...
@Right(id = "P2P_C_FINANCE_CJRECORD", name = "成交记录", moduleId = "P2P_C_FINANCE_ZJGL_FKCJJL", order = 3)
public class CjRecordList extends AbstractFinanceServlet
{
        ...
        throws Throwable
    {
        ...
        CjRecordQuery cjRecordQuery = new CjRecordQuery()
        {
        ...
        PagingResult<CjRecord> result = fkshManage.search(cjRecordQuery, new Paging()
        {
            @Override
            public int getSize()
            {
        ...
        CjRecord searchCjAmount = fkshManage.searchCjAmount(cjRecordQuery);
        request.setAttribute("totalAmount", totalAmount);
        request.setAttribute("totalFkAmount", totalFkAmount);
        request.setAttribute("result", result);
        request.setAttribute("searchCjAmount", searchCjAmount);
