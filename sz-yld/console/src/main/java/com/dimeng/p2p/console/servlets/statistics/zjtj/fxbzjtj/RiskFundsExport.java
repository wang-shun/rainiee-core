package com.dimeng.p2p.console.servlets.statistics.zjtj.fxbzjtj;
...
@Right(id = "P2P_C_STATISTICS_RFEXPORT", name = "平台风险保证金数据导出", moduleId = "P2P_C_STATISTICS_ZJTJ_FXBZJ")
