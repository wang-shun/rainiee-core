package com.dimeng.p2p.console.servlets.info.xxpl.baxx;
...
public class UpdateBaxx extends AbstractXxplServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.BAXX.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.BAXX);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.BAXX, article);
            }
            else
            {
    ...
    {
        ArticleManage manage = serviceSession.getService(ArticleManage.class);
        String content = manage.getContent(T5011_F02.BAXX);
        request.setAttribute("content", content);
        T5010 t5010 = manage.getArticleTypeByCode("BAXX");
