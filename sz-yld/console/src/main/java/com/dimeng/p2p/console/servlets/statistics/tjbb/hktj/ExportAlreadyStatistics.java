...
public class ExportAlreadyStatistics extends AbstractFinanceServlet
{
        ...
        throws Throwable
    {
        ...
        repaymentInfoManage.exportAlready(result.getItems(),
            repaymentInfoManage.getAlreadyTotal(query),
