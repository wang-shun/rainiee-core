...
/**
 * 功能描述：导出加息券统计列表 详细描述： 1. 默认导出所有加息券统计列表 2. 导出根据条件查询出的所有的加息券统计列表
 * 
 * @author xiaoqi
 * @version [v3.1.2, 2015年10月9日]
 */
@Right(id = "P2P_C_SPREAD_HDGL_EXPORTJXQTJ", name = "导出加息券统计列表", moduleId = "P2P_C_SPREAD_HDGL_JXQTJ")
public class ExportJxqCount extends AbstractSpreadServlet {
	private static final long serialVersionUID = -6582210769362316664L;
