package com.dimeng.p2p.console.servlets.info.gywm.aqbz;
...
public class UpdateAqbz extends AbstractLxhfyServlet {
		...
		try {
			...
			Article article = new Article() {
				...
				public String getTitle() {
					return ArticleType.AQBZ.getName();
				}
			...
			ArticleRecord exist = manage.get(T5011_F02.AQBZ);
			if (exist == null) {
				manage.add(T5011_F02.AQBZ, article);
			} else {
	...
	protected void processGet(HttpServletRequest request,
		...
		String content = manage.getContent(T5011_F02.AQBZ);
