...
public class AddTzyhkWtlx extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        ...
        try
        {
            ...
            manage.addQuestionType(T5011_F02.TZYHK, question);
            sendRedirect(request, response, getController().getURI(request, SearchTzyhkWtlx.class));
        }
