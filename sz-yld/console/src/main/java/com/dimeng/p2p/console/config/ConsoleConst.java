...
public abstract interface ConsoleConst extends P2PConst {
	...
	* 360极速模式下，导入CSV格式
    */
    public static final String CVS_JS_STR = "application/vnd.ms-excel";
    ...
    */
	 ...
	 * 导入EXCLE格式-2007
	 */
	public static final String EXCLE_STR_ELLQ = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
