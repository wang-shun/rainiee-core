package com.dimeng.p2p.console.servlets.info.xxpl.zdsx;
...
public class UpdateZdsx extends AbstractXxplServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.ZDSX.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.ZDSX);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.ZDSX, article);
            }
            else
            {
    ...
    {
        ArticleManage manage = serviceSession.getService(ArticleManage.class);
        String content = manage.getContent(T5011_F02.ZDSX);
        request.setAttribute("content", content);
        T5010 t5010 = manage.getArticleTypeByCode("ZDSX");
