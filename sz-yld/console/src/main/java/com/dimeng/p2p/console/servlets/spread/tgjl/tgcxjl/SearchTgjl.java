package com.dimeng.p2p.console.servlets.spread.tgjl.tgcxjl;
...
@Right(id = "P2P_C_SPREAD_TGJL_SEARCH",isMenu=true, name = "推广持续奖励详情列表", moduleId = "P2P_C_SPREAD_TGJL_CXJL", order = 0)
public class SearchTgjl extends AbstractSpreadServlet{
	...
	protected void processPost(final HttpServletRequest request,
        ...
        SpreadList searchSpreadListAmount = manage.searchSpreadListAmount(query);
        request.setAttribute("searchSpreadListAmount", searchSpreadListAmount);
