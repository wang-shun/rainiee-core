...
public class SearchShzr extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        ...
        ArticleQuery query = new ArticleQuery()
        {
            ...
            {
                return TimestampParser.parse(request.getParameter("publishTimeStart"));
            }
            
            @Override
            public Timestamp getPublishTimeEnd()
            {
                return TimestampParser.parse(request.getParameter("publishTimeEnd"));
            }
