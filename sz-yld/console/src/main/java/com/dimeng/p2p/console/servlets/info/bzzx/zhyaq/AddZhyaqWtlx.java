...
public class AddZhyaqWtlx extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        ...
        try
        {
            ...
            manage.addQuestionType(T5011_F02.ZHYAQ, question);
            sendRedirect(request, response, getController().getURI(request, SearchZhyaqWtlx.class));
        }
