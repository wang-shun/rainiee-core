package com.dimeng.p2p.console.servlets.bid.loanmanage.grjkyx;
...
@Right(id = "P2P_C_BUSI_GRJKYXLIST", isMenu = true, name = "个人借款意向管理",moduleId="P2P_C_BID_JKGL_GRJKYX",order=0)
public class GrjkyxList extends AbstractBidServlet {
        ...
        throws Throwable
    {
        ...
        GrIntentionQuery grIntentionQuery = new GrIntentionQuery()
        {
            ...
            {
                return EnumParser.parse(T6282_F11.class, request.getParameter("loanIntentionState"));
            }
        ...
        PagingResult<Grjkyx> loanIntentions = bidWillManage.searchPersonal(grIntentionQuery, new Paging()
        {
        ...
        request.setAttribute("searchPersonalAmount", bidWillManage.searchPersonalAmount(grIntentionQuery));
