package com.dimeng.p2p.console.servlets.info.tzgl.ptzh;
...
public class UpdatePtzh extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.PTZH.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.PTZH);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.PTZH, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.PTZH);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("PTZH");
