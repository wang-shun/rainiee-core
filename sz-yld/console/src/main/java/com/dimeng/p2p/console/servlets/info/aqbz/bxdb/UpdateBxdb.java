package com.dimeng.p2p.console.servlets.info.aqbz.bxdb;
...
@Right(id = "P2P_C_INFO_AQBZ_MENU", isMenu = true, name = "安全保障", moduleId = "P2P_C_INFO_AQBZ", order = 0)
public class UpdateBxdb extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.BXDB.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.BXDB);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.BXDB, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.BXDB);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("BXDB");
