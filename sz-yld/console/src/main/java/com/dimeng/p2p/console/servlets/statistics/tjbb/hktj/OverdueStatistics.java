...
public class OverdueStatistics extends AbstractStatisticsServlet {
	...
	protected void processPost(final HttpServletRequest request,
        ...
        PagingResult<RepaymentStatisticsEntity> result = repaymentInfoManage.getOverdueList(query, new Paging()
        {
        ...
        RepaymentStatisticsEntity overdueTotal = repaymentInfoManage.getOverdueTotal(query);
		request.setAttribute("result", result);
        request.setAttribute("overdueTotal", overdueTotal);
