...
@Right(id = "P2P_C_BUSI_CS_XSCSLIST",name = "催收记录" , moduleId="P2P_C_BID_CSGL_CSJL",order=0)
public class XscsList extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		//PagingResult<CollectionRecordInfo> collectionRecords = collectionManage.CollectionRecordSearch(collectionRecordQuery, csType, paging)
		
		PagingResult<CollectionRecordInfo> collectionRecords = collectionManage
				.CollectionXscsRecordSearch(new CollectionRecordQuery() {
