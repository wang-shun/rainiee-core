package com.dimeng.p2p.console.servlets.info.aqbz.hzjg;
...
public class UpdateHzjg extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.HZJG.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.HZJG);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.HZJG, article);
            }
            else
            {
    ...
    {
        ArticleManage manage = serviceSession.getService(ArticleManage.class);
        String content = manage.getContent(T5011_F02.HZJG);
        request.setAttribute("content", content);
        T5010 t5010 = manage.getArticleTypeByCode("HZJG");
