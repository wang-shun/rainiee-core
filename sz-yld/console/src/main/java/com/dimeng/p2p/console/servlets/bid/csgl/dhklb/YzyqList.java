...
public class YzyqList extends AbstractBidServlet {
        ...
        throws Throwable
    {
        ...
        Greater30Query greater30Query = new Greater30Query()
        {
        ...
        PagingResult<Less30> greater30s = collectionManage.Greater30Search(greater30Query, new Paging()
        {
        ...
        Less30 greater30SearchAmount = collectionManage.Greater30SearchAmount(greater30Query);
        request.setAttribute("stayRefundGather", stayRefundGather);
        request.setAttribute("greater30s", greater30s);
        request.setAttribute("greater30SearchAmount", greater30SearchAmount);
