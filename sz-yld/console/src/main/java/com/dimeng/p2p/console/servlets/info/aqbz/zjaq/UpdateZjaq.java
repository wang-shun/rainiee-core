package com.dimeng.p2p.console.servlets.info.aqbz.zjaq;
...
public class UpdateZjaq extends AbstractInformationServlet
{
        ...
        throws Throwable
    {
        try
        {
            ...
            Article article = new Article()
            {
                ...
                {
                    return T5011_F02.ZJAQ.getChineseName();
                }
            ...
            ArticleRecord exist = manage.get(T5011_F02.ZJAQ);
            ...
            if (exist == null)
            {
                manage.add(T5011_F02.ZJAQ, article);
            }
            else
            {
                manage.update(exist.id, article);
            }
            String content = manage.getContent(T5011_F02.ZJAQ);
            request.setAttribute("content", content);
            T5010 t5010 = manage.getArticleTypeByCode("ZJAQ");
