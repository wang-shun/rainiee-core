...
@Right(id = "P2P_C_BASE_DISABLEPRODUCT", name = "停用产品", moduleId = "P2P_C_BASE_OPTSETTINGS_PRODUCT")
public class DisableProduct extends AbstractBaseServlet {
