...
返回<a href="#" onclick="parent.location.href='<%configureProvider.format(out,URLVariable.INDEX);%><%=request.getContextPath() %>'" style="color:#00a7e5;"><%configureProvider.format(out,SystemVariable.SITE_NAME);%>首页</a></p>
</div>
</body>
</html>
