                        ...
                        <div class="con">
                            ...
                            <form id="form1" method="post" class="form1">
                                <input type="hidden" name="pic" <%if(!StringHelper.isEmpty(fileCode)){%>
                                       value="<%=fileStore.getURL(fileCode)%>" <%}else{%> value="<%=skin.pic%>" <%}%>>
                                    ...
                                    <li>
                                        ...
                                        <div class="info orange">
                                            <input type="text" name="name" id="name" onblur="nameCheck()"
                                                   ...
                                                   value="<%StringHelper.filterHTML(out, skin.name);%>"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <select name="location" class="yhgl_ser yw_w1">
                                                ...
                                                %>
                                                <option value="<%=skinStatus.name()%>" <%if (skinStatus.equals(skin.location)) {%>
                                    ...
                                    <li>
                                        ...
                                        <div class="info orange">
                                            <img id="imgFile" <%if(!StringHelper.isEmpty(fileCode)) {%>
                                                 src="<%=fileStore.getURL(fileCode)%>" <%}else{%>
                                                 src="<%=skin.pic%> <%}%>" class="bm10 bo_xxk">
                                            <input type="file" name="file" value="选择文件" onchange="upload()"
                                                   class="required">
