...
<%@page import="com.dimeng.p2p.console.servlets.account.vipmanage.grxx.Szkhjl" %>
                        ...
                        <form action="<%=controller.getURI(request, Szkhjl.class)%>" method="post" class="form1">
                            <ul class="cell noborder no_wi">
                                ...
                                <li>
                                    ...
                                    <div class="info">
                                        <input name="name" maxlength="18" type="text" class="text yhgl_ser required"
                                        ...
                                        <select id="kfjl">
                                            ...
                                            <%
                                                ...
                                                if (t != null) {
                                                    for (T7110 entity : t) {
                                            %>
                                            <option value="<%StringHelper.filterHTML(out, entity.F02); %>"><%
                                                StringHelper.filterHTML(out, entity.F02); %></option>
                                            <%
                                                    }
                                                }
                                            %>
