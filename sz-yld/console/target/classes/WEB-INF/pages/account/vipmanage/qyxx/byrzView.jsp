                    ...
                    <div class="border mt20">
                        <div class="tabnav-container">
                            <ul class="clearfix">
                                ...
                                <li><a href="javascript:void(0)" class="tab-btn select-a">必要认证（<%=xyrzTotal.byrztg %>
                                    /<%=xyrzTotal.needAttestation %>）<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                <li>
                                ...
                                <table class="table table-style gray6 tl">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" class="blue tc">
                                                    ...
                                                    <%-- <%
                                                        int num = fileUrls.length;
                                                        for (int a = 0; a < num; a++) {
                                                            String fileUrl = fileUrls[a];
                                                            if (!StringHelper.isEmpty(fileUrl)) {
                                                    %>
                                                    <a href="<%=fileUrl%>" onclick="return hs.expand(this)"
                                                       target="_blank" class="link-blue highslide">查看证件&nbsp;<%=(num==1?"":a + 1)%>
                                                        &nbsp;</a>
                                                    <%
                                                            }
                                                        }
