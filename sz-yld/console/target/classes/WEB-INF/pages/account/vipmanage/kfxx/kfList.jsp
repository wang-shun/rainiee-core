...
<%@page import="com.dimeng.p2p.console.servlets.account.vipmanage.kfxx.HfjlList" %>
<%@page import="com.dimeng.p2p.console.servlets.account.vipmanage.kfxx.AddHfjl" %>
                            ...
                            <div class="con">
                                <div class="admin_input admin_pb">
                                    <p>用户名称：<input type="text" name="userName"
                                                   ...
                                                   class="yhgl_input mr5"/></p>

                                    <p>真实姓名：<input type="text" name="name"
                        ...
                        <div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                                ...
                                <tr class="dhsbg">
                                    ...
                                    <td><%=DateTimeParser.format(user.loginTime)%>
                                    </td>
                                    <td><%=user.status.getChineseName() %>
                                    </td>
                                    <td>
                                        <%if (dimengSession.isAccessableResource(AddHfjl.class)) {%>
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,AddHfjl.class)%>?userId=<%=user.id%>"
                                                class="mr10">新增回访记录</a></span>
                                        <%} else { %>
                                        <span class="disabled">新增回访记录</span>
                                        <%} %>
                                        <%if (dimengSession.isAccessableResource(HfjlList.class)) {%>
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,HfjlList.class)%>?userId=<%=user.id%>"
                                                class="mr10">查看</a></span>
                                        <%} else { %>
