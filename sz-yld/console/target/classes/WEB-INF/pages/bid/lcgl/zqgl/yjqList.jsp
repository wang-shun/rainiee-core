...
<%@page import="com.dimeng.p2p.console.servlets.bid.lcgl.zqgl.YjqExport" %>
...
<%
    ...
    BigDecimal yjqAmountCount = (BigDecimal)request.getAttribute("yjqAmountCount");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, YjqList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">债权人</span>
                                    ...
                                    <li><span class="display-ib mr5">结清时间</span> <input
									...
									<li><span class="display-ib mr5">债权人类型</span>
                                        <select name="creditorType" class="border mr20 h32 mw100">
                                            <option value="">全部</option>
                                            <option value="ZRR" <%if ("ZRR".equals(request.getParameter("creditorType"))) {%>
                                                    selected="selected" <%}%>>个人</option>
                                            <option value="FZRR" <%if ("FZRR".equals(request.getParameter("creditorType"))) {%>
                                                    selected="selected" <%}%>>企业</option>
                                            <option value="FZRRJG" <%if ("FZRRJG".equals(request.getParameter("creditorType"))) {%>
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(YjqExport.class)) {
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">已结清<i
                                        class="icon-i tab-arrowtop-icon"></i></a></li>
                                    <li><a href="<%=controller.getURI(request, YzcList.class)%>"
                            ...
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        %></td>
                                        <td><%StringHelper.filterHTML(out, creditor.creditorType); %></td>
                        ...
                        <div class="mb10">原始债权总金额：
                        	<em class="red"><%=Formater.formatAmount(yjqAmountCount) %></em>元
                        </div>
                        <!--分页-->
                        <%
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, YjqExport.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, YjqList.class)%>";
    }
</script>
</body>
</html>