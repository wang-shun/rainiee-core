                ...
                <div class="home_main">
                    ...
                    <div class="newsbox">
                        <div class="til clearfix">
                            <div class="Menubox">
                                <ul>
                                    ...
                                    <li id="one2"
                                        onclick="window.location.href='<%=controller.getURI(request, ViewTenderRecord.class)%>?transferId=<%=viewTransfer.id%>'">
                                        投资记录
                                    </li>
                                    <li id="one3"
                        ...
                        <div class="border p15-30 Men_bt no_table" id="con_one_1">
                            <div class="pub_title pt15 f16 fB"><span class="fl">用户信息</span><span
                                    class="ml30 f14 gray33">ID:<%=viewLoanRecord.userId %></span></div>
                            ...
                            <div class="plan_tab_con clearfix">
                                <table width="100%" border="0" cellspacing="0">
                                    <tr class="tc">
                                        ...
                                        <td><span
                                                class="fl"><%StringHelper.filterHTML(out, viewTransfer.userName);%></span><%
                                            if (viewLoanRecord.sex != null) {
                                                if (viewLoanRecord.sex.equals(Sex.M)) {
                                        %><i class="ui_plan_bj ui_boy ml10 mt5"></i><%} else { %><i
                                                class="ui_plan_bj ui_girl ml10 mt5"></i><%
                                                }
                                            }
                                        %></td>
                            ...
                            <div class="plan_tab_con01 clearfix">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table mt10">
                                    ...
                                    <%
                                        if (attestationChecks != null) {
                                            for (int i = 0; i < attestationChecks.length; i++) {
                                                AttestationCheck attestationCheck = attestationChecks[i];
                                                if (attestationCheck == null) {
                                                    continue;
                                                }
                                    %>
                                    <tr class="tc">
                                        <td><span class="ml100"><%
                                            StringHelper.filterHTML(out, attestationCheck.shxm); %></span></td>
                                        <td align="center"><i class="ui_plan_bj ui_plan_right tl ml20"></i></td>
                                        <td align="center"><%=TimestampParser.format(attestationCheck.rzsj) %>
                                        </td>
                                    </tr>
                                    <%
                                        }
                                ...
                                <p class="pt10 li30"><span
                                        class=" dian"></span><%=configureProvider.getProperty(SystemVariable.SITE_NAME) %>
                                    及其合作机构将始终秉持客观公正的原则，严控风险，最大程度的尽力确保借入者信息的真实性，<br/>
                                    但不保证审核信息100%无误。<br/>
