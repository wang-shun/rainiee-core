            ...
            <div class="r_main">
                <div class="home_main">
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            ...
                            <div class="contain_main clearfix">
                                <div class="pub_title clearfix"><span class="fl"><span
                                        class="f16 fB"><%StringHelper.filterHTML(out, planMoneyView.planName);%></span></span>
                                </div>
                                <div class="hsxt"></div>
                                <div class="plan_given clearfix">
                                    <ul class="cend w490 fl clearfix">
                                        <li>
                                            <div>计划金额：<%=Formater.formatAmount(planMoneyView.planMoneys) %>元</div>
                                            <div>预期收益：<%=Formater.formatRate(planMoneyView.expectEarnings) %> 每年</div>
                                        </li>
                                        <li>
                                            <div><span
                                                    class="fl">投资范围：</span><%StringHelper.filterHTML(out, planMoneyView.tblxmc); %>
                                            </div>
                                            <div>保障方式：<%=planMoneyView.safeguardWay.getChineseName() %>
                                            </div>
                                        </li>
                                        <li class="mb10">
                                            <div>计划状态：
                                        ...
                                        <li class="mb10">
                                            <div>锁定期限：<%=planMoneyView.lockTime %>个月</div>
                                            <div>锁定结束：<%=DateParser.format(planMoneyView.lockEndTime) %>
                                            </div>
                                        </li>
                                        <div class="cass">
                                            <div>收益处理：<%=planMoneyView.earningsWay.getChineseName()%>
                                            </div>
                                            <div>费率说明：本期计划费用如下</div>
                                        </div>
                                        <li class="mb10" style="border:0">
                                            <div>&nbsp;</div>
                                            <div>
                                                <p class="cen_d">加入费率 <%=Formater.formatRate(planMoneyView.addRate)%>
                                                    <br/>
                                                    服务费率  <%=Formater.formatRate(planMoneyView.serveRate)%><br/>
                                                    退出费率 <%=Formater.formatRate(planMoneyView.quitRate)%>
                                                </p>
                                            </div>
                                        <li>
                                    </ul>
                                    <div class="fr submission mt15">
                                        ...
                                        <div class="text">
                                            <ul class="text_li">
                                                <li>剩余金额：<span
                                                        class="f18 gray3"><%=Formater.formatAmount(planMoneyView.residueMoney) %>元</span>
                                                </li>
                                                <li>每人可加入金额上限：<br/><span
                                                        class="f18 gray3"><%=Formater.formatAmount(planMoneyView.investCeiling) %>元</span>
                                                </li>
                                                <li>每人可加入金额下限：<br/><span
                                                        class="f18 gray3"><%=Formater.formatAmount(planMoneyView.investFloor) %>元</span>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <form id="form1" name="form1" method="post"
                          action="<%=controller.getURI(request, ViewAddRecord.class)%>">
                        ...
                        <div class="newsbox">
                            <div class="til clearfix">
                                <div class="Menubox">
                                    <ul>
                                        <li id="one1"
                                            onclick="window.location.href='<%=controller.getURI(request, ViewPlanMoney.class)%>?planMoneyId=<%=planMoneyView.planMoneyId%>'">
                                            计划介绍
                                        </li>
                            ...
                            <div class="border p15-30 Men_bt li30" id="con_one_2">
                                <div class="fr mb10"><span class="mr10">加入总人次<em
                                        class="f18 orange"><%=pagingResult == null ? 0 : pagingResult.getItemCount() %>
                                </em>人次</span></div>
                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                                    ...
                                    <%
                                        if (pagingResultArray != null) {
                                            for (int i = 0; i < pagingResultArray.length; i++) {
                                                PlanAddRecord planAddRecord = pagingResultArray[i];
                                    ...
                                    <tr class="dhsbg tc">
                                        ...
                                        <td><%=Formater.formatAmount(planAddRecord.addMoney)%>
                                        </td>
                                        <td><%=TimestampParser.format(planAddRecord.investTime) %>
                                        </td>
                                    </tr>
                                    <%
                                        }
