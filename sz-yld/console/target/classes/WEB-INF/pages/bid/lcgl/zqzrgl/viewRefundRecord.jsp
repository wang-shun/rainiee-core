                ...
                <div class="home_main">
                    ...
                    <div class="newsbox">
                        ...
                        <div class="border p15-30 Men_bt no_table" id="con_one_3">
                            <div class="fr mb10"><span class="mr10">已还本息<em
                                    class="f18 orange"><%=refundRecord.alreadyInterest %>
                            </em>元</span> <span class="mr10">待还本息<em class="f18 orange"><%=refundRecord.stayInterest %>
                            </em>元</span></div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc mb15">
                                ...
                                <%
                                    if (refundInfos != null) {
                                        for (int i = 0; i < refundInfos.length; i++) {
                                            RefundInfo refundInfo = refundInfos[i];
                                            if (refundInfo == null) {
                                                continue;
                                            }
                                %>
                                <tr class="tc">
                                    <td><%=TimestampParser.format(refundInfo.contractRefundTime) %>
                                    </td>
                                    <td><%=refundInfo.state.getChineseName()%>
                                    </td>
                                    <td><%=Formater.formatAmount(refundInfo.principalInterest) %>
                                    </td>
                                    <td><%=Formater.formatAmount(refundInfo.defaultInterest) %>
                                    </td>
                                    <td><%=TimestampParser.format(refundInfo.practicalRefundTime) %>
                                    </td>
                                </tr>
                                <%
                                    }
