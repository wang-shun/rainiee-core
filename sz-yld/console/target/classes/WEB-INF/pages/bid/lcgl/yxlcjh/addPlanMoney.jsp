            ...
            <div class="r_main">
                <div class="home_main">
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            <form action="<%=controller.getURI(request, AddPlanMoney.class)%>" method="post"
                                  class="form1">
                                <ul class="cell noborder yxjh ">
                                    <li>
                                        <div class="til"><span class="red">*</span>计划名称：</div>
                                        <div class="info">
                                            <input name="planName" type="text" class="text yhgl_ser required"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("planName"));%>"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input id="investFloor" name="investFloor" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("investFloor"));%>"
                                                   class="text yhgl_ser required lcjexx-size minf-size-<%=configureProvider.getProperty(SystemVariable.YXLCTZXX) %>"
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input id="investCeiling" name="investCeiling" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("investCeiling"));%>"
                                                   class="text yhgl_ser required lcjesx-size minf-size-<%=configureProvider.getProperty(SystemVariable.YXLCTZXX) %>"
                                                   mtest="/^[-\+]?\d+(\.\d+)?$/" mtestmsg="金额格式不正确"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input id="planMoneys" name="planMoneys" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("planMoneys"));%>"
                                                   class="text yhgl_ser required jkje-size minf-size-<%=configureProvider.getProperty(SystemVariable.YXLCTZXX) %>"
                                                   mtest="/^[-\+]?\d+(\.\d+)?$/" mtestmsg="金额格式不正确"/>
                                    ...
                                    <li>
                                        <div class="til"><span class="red">*</span>收益年化利率：</div>
                                        <div class="info">
                                            <input name="earningsYearRate" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("earningsYearRate"));%>"
                                                   class="text yhgl_ser required min-size-0 maxf-size-99.9"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1}))$/"
                                                   mtestmsg="格式不正确,只能有一位小数"/>
                                            <span class="fl">%</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="addYearRate" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("addYearRate"));%>"
                                                   class="text yhgl_ser required min-size-0 maxf-size-99.9"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1}))$/"
                                                   mtestmsg="格式不正确,只能有一位小数"/>
                                            <span class="fl">%</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="serveRate" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("serveRate"));%>"
                                                   class="text yhgl_ser required min-size-0 maxf-size-99.9"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1}))$/"
                                                   mtestmsg="格式不正确,只能有一位小数"/>
                                            <span class="fl">%</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="quitRate" type="text"
                                                   value="<%StringHelper.filterHTML(out, request.getParameter("quitRate"));%>"
                                                   class="text yhgl_ser required min-size-0 maxf-size-99.9"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1}))$/"
                                                   mtestmsg="格式不正确,只能有一位小数"/>
                                            <span class="fl">%</span>
                                    ...
                                    <li>
                                        <div class="til"><span class="red">*</span>投资范围：</div>
                                        <div class="info">
                        	<span class="tir required">
                          		<select name="tenderScope" class="yhgl_sel" style="width:300px;">
                                    ...
                                    %>
                                    <option value="<%=signType.F01%>" <%if (type == signType.F01) {%>
                                            selected="selected" <%} %>><%=signType.F02%>
                                    </option>
                                    <%
                                        }
                                    %>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <select name="lockTime" class="yhgl_sel yw_w3">
                                                ...
                                                %>
                                                <option value="3" <%if (lockTime == 3) {%> selected="selected" <%} %>>
                                                    3个月
                                                </option>
                                                <option value="6" <%if (lockTime == 6) {%> selected="selected" <%} %>>
                                                    6个月
                                                </option>
                                                <option value="9" <%if (lockTime == 9) {%> selected="selected" <%} %>>
                                                    9个月
                                                </option>
                                                <option value="12" <%if (lockTime == 12) {%> selected="selected" <%} %>>
                                                    12个月
                                                </option>
                                                <option value="18" <%if (lockTime == 18) {%> selected="selected" <%} %>>
                                                    18个月
                                                </option>
                                                <option value="24" <%if (lockTime == 24) {%> selected="selected" <%} %>>
                                                    24个月
                                                </option>
                                            </select>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="applyStartTime" id="datepicker1" type="text"
                                                   class="yhgl_ser date required kssj-size"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="applyEndTime" id="datepicker2" type="text"
                                                   class="yhgl_ser date required jzsj-size"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="tir">
                                            <select name="earningsWay" class="yhgl_sel required" style="width:300px;">
                                                ...
                                                %>
                                                <option value="<%=earningsWay.name()%>" <%if (earningsWay.name().equals(request.getParameter("earningsWay"))) { %>
                                                        selected="selected" <%} %>><%=earningsWay.getChineseName()%>
                                                </option>
                                                <%
                                                    }
                                                %>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                        	<textarea name="planDesc" rows="5" cols="10" class="text yhgl_ser required max-length-200"
                                      style="height:100px;">
                        	<%StringHelper.filterHTML(out, request.getParameter("planDesc")); %>
                                ...
                                <div class="tc w220 pt20">
                                    <input type="submit" onclick="return onSubmit();" class="btn4 mr30 sumbitForme"
                                           fromname="form1" value="保存"/>
                                    <input type="button"
                                           onclick="window.location.href='<%=controller.getURI(request, PlanMoneyList.class)%>'"
                                           class="btn4" value="返回"/>
                                </div>
                                <div class="clear"></div>
                            </form>
