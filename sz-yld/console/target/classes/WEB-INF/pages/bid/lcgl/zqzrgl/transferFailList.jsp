...
<%
    ...
    PagingResult<TransferDshEntity> transferZrsbs = (PagingResult<TransferDshEntity>) request.getAttribute("transferZrsbs");
    TransferDshEntity[] transferDshArray = transferZrsbs.getItems();
    TransferDshEntity transferZrsbAmount = (TransferDshEntity)request.getAttribute("transferZrsbAmount");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form2" action="<%=controller.getURI(request, TransferFailList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="<%=controller.getURI(request, TransferFinishList.class)%>" class="tab-btn">已转让</a></li>
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">转让失败<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                </ul>
                            </div>
                        ...
                        <div class="mb10">
                            <span class="mr30">债权价值总金额：<em
                                    class="red"><%=Formater.formatAmount(transferZrsbAmount.F07) %>
                            </em> 元</span>
                            <span class="mr30">转让价格总金额：<em
                                    class="red"><%=Formater.formatAmount(transferZrsbAmount.F08) %>
                            </em> 元</span>
                        </div>
                        <!--分页-->
                        <%
                            AbstractConsoleServlet.rendPagingResult(out, transferZrsbs);
                        %>
                        <!--分页 end-->
