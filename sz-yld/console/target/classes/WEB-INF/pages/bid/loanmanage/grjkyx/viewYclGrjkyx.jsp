                        ...
                        <div class="content-container pl40 pt30 pr40">
                            <ul class="gray6">
                                ...
                                <% } else {%>
                                 ...
                                 <%}%>
                                    <%-- <input type="checkbox" <%if (grjkyx.F15 == T6282_F15.S) { %> checked="checked"<%}%>
                                           disabled/>抵押
                                    <input type="checkbox" <%if (grjkyx.F16 == T6282_F16.S) { %> checked="checked"<%}%>
                                           disabled/>实地认证
                                    <input type="checkbox" <%if (grjkyx.F17 == T6282_F17.S) { %> checked="checked"<%}%>
                                           disabled/>担保 --%>
                                </li>
                                <li class="mb10"><span
                                ...
                                <li class="mb10"><span
                                        class="display-ib w200 tr mr5">处理人：</span><%StringHelper.filterHTML(out, grjkyx.clr);%>
                                </li>
                                <li class="mb10"><span
                                        class="display-ib w200 tr mr5">处理时间：</span><%=TimestampParser.format(grjkyx.F14)%>
                                </li>
                                <li class="mb10"><span
                                        class="display-ib w200 tr mr5">处理结果描述：</span><%StringHelper.filterHTML(out, grjkyx.F18);%>
                                </li>
                                <li class="mb10">
                                    <div class="pl200 ml5">
