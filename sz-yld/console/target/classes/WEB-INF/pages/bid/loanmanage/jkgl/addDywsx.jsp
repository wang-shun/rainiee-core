                        ...
                        <div class="con">
                            ...
                            <form action="<%=controller.getURI(request, AddDywsx.class)%>" method="post" class="form1">
                                ...
                                <ul class="cell xc_jcxx ">
                                    <li>
                                        ...
                                        <div class="info">
                                            <select class="text yhgl_ser" name="F03" id="dywsx" onchange="changeDyw()">
                                                ...
                                                %>
                                                <option value="<%=t6213.F01 %>"
                                                        <%if(type==t6213.F01||t6213.F01==typeId){ %>selected="selected"<%} %>><%
                                                    StringHelper.filterHTML(out, t6213.F02); %></option>
                                                <%
                                                        }
                                                    }
                                                %>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            ...
                                            <textarea cols="40" rows="2" name="t6235s[<%=i %>].F04"><%
                                                StringHelper.format(out, request.getParameter("t6235s[" + i + "].F04"), fileStore); %></textarea>
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    <%
                                ...
                                <div class="tc w220 pt20">
                                    ...
                                    %>
                                    <input type="button"
                                           onclick="location.href='<%=controller.getURI(request, AddDyw.class) %>?loanId=<%=loanId %>&userId=<%=userId %>'"
                                           class="btn4" value="返回"/>
                                </div>
                                <div class="clear"></div>
                            </form>
