...
<%@page import="com.dimeng.p2p.console.servlets.bid.csgl.dhklb.Dcyzyq" %>
...
<%
    ...
    Less30 greater30SearchAmount = (Less30)request.getAttribute("greater30SearchAmount");
                    ...
                    <form id="form1" action="<%=controller.getURI(request, YzyqList.class)%>" method="post">
                        ...
                        <div class="border mt20">
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(Dcyzyq.class)) {
                                        %>
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">严重逾期待还款<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                </ul>
                            </div>
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tbody class="f12">
                                    <%
                                        if (greater30Array != null) {
                                            for (int i = 0; i < greater30Array.length; i++) {
                                                Less30 greater30 = greater30Array[i];
                                                if (greater30 == null) {
                                                    continue;
                                                }
                                    %>
                                    <tr class="dhsbg tc">
                                        <td align="center"><input type="checkbox" name="checkbox" id="checkbox"
                                                                  value="<%=greater30.userId %>,<%=greater30.loanRecordId %>,<%=greater30.collectionId %>,<%=greater30.mobile %>,<%=greater30.email %>"
                                                                  onclick="selectThis()"/></td>
                                        <td><%=i + 1%>
                                        </td>
                                        <td><%
                                            StringHelper.filterHTML(out, StringHelper.truncation(greater30.loanRecordTitle, 10)); %></td>
                                        <td align="center"><%
                                            StringHelper.filterHTML(out, greater30.userName);
                                        %></td>
                                        <td align="center"><%=Formater.formatAmount(greater30.loanAmount)%>
                                        </td>
                                        <td align="center"><%
                                            StringHelper.filterHTML(out, greater30.loandeadline);
                                        %></td>
                                        <td align="center"><%=Formater.formatAmount(greater30.principalAmount)%>
                                        </td>
                                        <td align="center"><%=Formater.formatAmount(greater30.residueAmount)%>
                                        </td>
                                        <td align="center"><%=Formater.formatAmount(greater30.collectionAmount)%>
                                        </td>
                                        <td align="center"><%=greater30.collectionNumber%>天</td>
                                        <td align="center"><%=Formater.formatDate(greater30.refundDay)%>
                                        </td>
                                        <td align="center">
                                            ...
                                            %>
                                            <a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.vipmanage.grxx.JbxxView.class)%>?userId=<%=greater30.userId%>&status=1"
                                            ...
                                            %>
                                            <a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.vipmanage.qyxx.ViewQyxx.class)%>?id=<%=greater30.userId%>&status=1"
                                            ...
                                            %>
                                            <a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.vipmanage.jgxx.ViewJgxx.class)%>?id=<%=greater30.userId%>&status=1"
                                            ...
                                            <a href="javascript:void(0)" onclick="showCs('<%=i %>')"
                                               class="link-blue popup-link mr10" data-wh="800*600">线下催收</a>
                                            <%} else { %>
                                            ...
                                            <a href="javascript:void(0)" onclick="showLh('<%=i %>')" class="link-blue">拉黑</a>
                                            <%} else { %>
                                            <a href="javascript:void(0)" class="disabled">拉黑</a>
                                            <%} %>
                                            <%} else { %>
                                            <a href="javascript:void(0)" class="disabled">拉黑</a>
                                            <%} %>
                        ...
                        <div class="mb10">
                            <span class="mr30">借款总金额：<em
                                    class="red"><%=Formater.formatAmount(greater30SearchAmount.loanAmount) %>
                            </em> 元</span>
                            <span class="mr30">本期应还总金额：<em
                                    class="red"><%=Formater.formatAmount(greater30SearchAmount.principalAmount) %>
                            </em> 元</span>
                            <span class="mr30">剩余应还总额：<em
                                    class="red"><%=Formater.formatAmount(greater30SearchAmount.residueAmount) %>
                            </em> 元</span>
                        </div>
                        <!--分页-->
                        <%
            ...
            <div class="p30">
                <ul class="gray6">
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl">用户名：</span>
                        ...
                        <div class="pl120"><%StringHelper.filterHTML(out, stayRefundInfo.userName); %></div>
                    </li>
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl">姓名：</span>

                        <div class="pl120"><%StringHelper.filterHTML(out, stayRefundInfo.realName); %></div>
                    </li>
                    ...
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl">催收方式：</span>
                        ...
                        <div class="pl120">
                            <label for="Xianxia-tel">
                                <input name="collectionType" type="radio" value="DH" checked="checked" class="mr5"/>
                                电话</label>
                            <label for="Xianxia-tel">
                    ...
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl"><em class="red mr5">*</em>催收时间：</span>
                        ...
                        <div class="pl120">
                            <input readonly="readonly" name="collectionTime" id="tempDatepicker<%=i %>" type="text"
                    ...
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl">备注：</span>
                        ...
                        <div class="pl120">
                            <textarea name="comment" id=comment class="ww60 border max-length-150"></textarea>
                            <span tip>150字以内</span>
                            <span errortip class="red" style="display: none"></span>
                        </div>
                    </li>
                ...
                <div class="tc f16">
                    <input type="submit" value="确定" class="btn-blue2 btn white radius-6 pl20 pr20 sumbitForme"
                           fromname="form<%=i%>"/>
                ...
                <div class="paging clearfix pt20">
                    <div class="page-size fr gray6 mr20 lh30"><span data-bind="text: formatedItemCount">总共<span
        ...
        <form action="<%=controller.getURI(request, Black.class)%>" method="post" class="form<%=i %>">
            ...
            <div class="p30">
                <ul class="gray6">
                    ...
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl"><em class="red mr5">*</em>拉黑说明：</span>

                        <div class="pl120">
                            <textarea name="blacklistDesc" cols="" rows=""
                                      class="ww60 border required max-length-255"></textarea>
                            <span tip>150字以内</span>
                            <span errortip class="red" style="display: none"></span>
                        </div>
                    </li>
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, Dcyzyq.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, YzyqList.class)%>";
    }
