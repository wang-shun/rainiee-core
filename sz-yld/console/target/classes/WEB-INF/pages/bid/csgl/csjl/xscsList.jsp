...
<%@page import="com.dimeng.p2p.console.servlets.bid.csgl.csjl.DcXscsList" %>
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, XscsList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(DcXscsList.class)) {
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    <li><a href="<%=controller.getURI(request, CsList.class)%>"
                                           class="tab-btn ">线下催收</a></li>
                                    <li><a href="javascript:void(0);" class="tab-btn select-a">线上催收<i
    ...
    <div class="popup-content-container-2" style="max-height:550px;">
        <div class="p30">
            <ul class="gray6">
                ...
                <li class="mb15"><span class="display-ib tr mr5 w120 fl">催收人：</span>
                ...
                <li class="mb15"><span class="display-ib tr mr5 w120 fl">催收时间：</span>
                ...
                <%  //如果是邮件，则需要展示标题
                    if(T7152_F04.YJ == entity.F04 || T7152_F04.ZNX == entity.F04 ){%>
                    <li class="mb15"><span class="display-ib tr mr5 w120 fl">标题：</span>
                ...
                <%}%>
                <li class="mb15"><span class="display-ib tr mr5 w120 fl">内容：</span>
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, DcXscsList.class)%>";
        $("#form1").submit();
        document.getElementById("form1").action = "<%=controller.getURI(request, XscsList.class)%>";
    }
</script>
</body>
</html>