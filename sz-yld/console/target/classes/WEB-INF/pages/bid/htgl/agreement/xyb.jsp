...
<%@page import="com.dimeng.p2p.common.entities.DzxyDy"%>
<%@page import="com.dimeng.p2p.console.servlets.bid.htgl.agreement.Xyb" %>
...
<%@page import="com.dimeng.p2p.modules.bid.console.service.entity.CjrList" %>
...
<%
    ...
    DzxyDy dzxyDy = contractManage.getDzxyXy(creditId,0);
