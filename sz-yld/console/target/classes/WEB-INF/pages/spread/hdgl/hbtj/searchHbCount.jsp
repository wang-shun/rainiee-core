...
<%@page import="com.dimeng.p2p.modules.activity.console.service.entity.HbAmountTotalInfo" %>
<%@page import="com.dimeng.util.ObjectHelper" %>
<%@ page import="com.dimeng.p2p.S63.enums.T6342_F04" %>
<%@ page import="com.dimeng.p2p.console.servlets.spread.hdgl.hbtj.ExportHbCount" %>
<html>
<head>
...
<%
    ...
    CURRENT_SUB_CATEGORY = "HBTJ";
    PagingResult<ActivityCountEntity> result = ObjectHelper.convert(request.getAttribute("result"), PagingResult.class);
    HbAmountTotalInfo info = ObjectHelper.convert(request.getAttribute("info"), HbAmountTotalInfo.class);
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, SearchHbCount.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>红包统计
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    <li><span class="display-ib mr5">未使用红包金额总计</span>
                                        <span class="link-blue"><%=info.unUsedAmount%></span>元
                                    </li>
                                    <li class="ml50"><span class="display-ib mr5">已使用红包金额总计</span>
                                        <span class="link-blue"><%=info.usedAmount%></span>元
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="border mt20">
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">红包状态</span>
                                    ...
                                    <li>
                                        <%
                                            if (dimengSession.isAccessableResource(ExportHbCount.class)) {
                                        %>
						...
						<p class="mt5">
                            <span class="mr30">红包总金额：<em class="red"><%=Formater.formatAmount(totalAmount)%>
                            </em> 元</span>
                        </p>
                        <!--分页-->
                        <%
...
<script type="text/javascript">
    ...
    function exportList() {
        var del_url = '<%=controller.getURI(request, ExportHbCount.class)%>';
        var form = document.forms[0];
        form.action = del_url;
        form.submit();
        form.action = '<%=controller.getURI(request, SearchHbCount.class)%>';
    }
</script>
</body>
</html>