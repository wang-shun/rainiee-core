...
<div class="w_main">
    <div class="main clearfix">
        <div class="wrap">
            <div class="r_main">
                <form action="<%=controller.getURI(request, YhzjglList.class) %>" method="post" id="searchForm"
                      name="form1">
                    <div class="home_main">
                        <div class="box box1 mb15">
                            ...
                            <div class="con">
                                ...
                                <ul class="yhxq_li">
                                    <li>
                                        可用金额总额：<span
                                            class="blue"><%=Formater.formatAmount(yhzjgl.usableAmount) %></span>元
                                    </li>
                                </ul>
                                <ul class="yhxq_li">
                                    <li>
                                    ...
                                    <div class="table">
                                        <p>
                                            ...
                                            <input type="text" name="loginName"
                                                   ...
                                                   id="serialNumber" class="yhgl_input"/>
                                        </p>
                                        ...
                                        <p>
                                            ...
                                            <select name="userType" class="yhgl_sel">
                                                ...
                                                %>
                                                <option value="<%=userType.name()%>" <%if (userType.name().equals(request.getParameter("userType"))) {%>
                                                        selected="selected" <%} %>><%=userType.getName() %>
                                                </option>
                                                <%} %>
                                            </select>
                                        </p>
