...
<%@page import="com.dimeng.p2p.console.servlets.finance.zjgl.dfgl.YjqList" %>
<%@page import="com.dimeng.p2p.console.servlets.finance.zjgl.dfgl.DcDfyjq" %>
...
<%
    ...
    DfRecord dfyjqSearchAmount = (DfRecord)request.getAttribute("dfyjqSearchAmount");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" name="form1" action="<%=controller.getURI(request, YjqList.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><a href="javascript:void(0);" onclick="$('#form1').submit();"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                            class="icon-i w30 h30 va-middle search-icon "></i>搜索</a></li>
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DcDfyjq.class)) {%>
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    ...
                                    <li id="one3"><a href="javascript:void(0);" class="tab-btn-click  select-a">已结清<i class="icon-i tab-arrowtop-icon"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <td><%=Formater.formatDateTime(yqddfRecord.jqTime)%>
                                        </td>
                                    </tr>
                                    <%
                                        }
                        ...
                        <div class="mb10">
                            <span class="mr30">借款总金额：<em
                                    class="red"><%=Formater.formatAmount(dfyjqSearchAmount.loanAmount) %>
                            </em> 元</span>
                            <span class="mr30">应还本金总金额：<em
                                    class="red"><%=Formater.formatAmount(dfyjqSearchAmount.dhbj) %>
                            </em> 元</span>
                            <span class="mr30">应还利息总金额：<em
                                    class="red"><%=Formater.formatAmount(dfyjqSearchAmount.dhlx) %>
                            </em> 元</span>
                            <span class="mr30">逾期罚息总金额：<em
                                    class="red"><%=Formater.formatAmount(dfyjqSearchAmount.yuqiAmount) %>
                            </em> 元</span>
                            <span class="mr30">垫付总金额：<em
                                    class="red"><%=Formater.formatAmount(dfyjqSearchAmount.ydfAmount) %>
                            </em> 元</span>
                            <span class="mr30">垫付返还总金额：<em
                                    class="red"><%=Formater.formatAmount(dfyjqSearchAmount.dffhAmount) %>
                            </em> 元</span>
                        </div>
                        <!--分页-->
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form1").action = "<%=controller.getURI(request, DcDfyjq.class)%>";
        $("#form1").submit();
