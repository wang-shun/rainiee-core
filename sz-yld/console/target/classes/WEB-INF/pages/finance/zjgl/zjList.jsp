                    ...
                    <div class="home_main">
                                    ...
                                    <div class="table">
                                        ...
                                        <p>
                                            ...
                                            <select name="zjzhType" class="yhgl_sel">
                                                ...
                                                %>
                                                <option value="<%=zjzhType.name()%>" <%if (zjzhType.name().equals(request.getParameter("zjzhType"))) {%>
                                                        selected="selected" <%}%>><%=zjzhType.getChineseName()%>
                                                </option>
                                                <%
                                                    }
                                                %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                            ...
                            <tr class="dhsbg">
                                ...
                                %></td>
                                <td><%
                                    StringHelper.filterHTML(out, record.userType);
                                %></td>
                                <td><%=Formater.formatAmount(record.F06)%>
                                </td>
                                <%if (T6101_F03.WLZH == record.F03) { %>
                                <td><%=Formater.formatAmount(record.yhsy)%>
                                </td>
                                <%} else { %>
                                <td>-</td>
                                <%} %>
                                <td><%=DateTimeParser.format(record.F07) %>
                                </td>
                                <td class="blue">
                                    <%
