...
<div class="w_main">
    <div class="main clearfix">
        <div class="wrap">
            <div class="r_main">
                <form action="<%=controller.getURI(request, ZJjyList.class)%>" method="post" name="form1"
                      id="searchForm">
                    ...
                    <div class="home_main">
                        <div class="box box1 mb15">
                            ...
                            <div class="con">
                                ...
                                <ul class="yhxq_li">
                                    <li>用户名 ：<span
                                            class="blue"><%StringHelper.filterHTML(out, userTotle.loginName);%></span>
                                    </li>
                                </ul>
                            ...
                            <div class="con">
                                <div class="admin_input admin_pb">
                                    <div class="table top3">
                                        ...
                                        <p>
                                            <span>时间：</span> <input type="text" name="startPayTime" id="datepicker1"
                                                                    readonly="readonly"
                                                                    value="<%StringHelper.filterHTML(out, request.getParameter("startPayTime"));%>"
                                                                    class="yhgl_input date"/>至 <input type="text"
                                                                                                      name="endPayTime"
                                                                                                      id="datepicker2"
                                                                                                      readonly="readonly"
