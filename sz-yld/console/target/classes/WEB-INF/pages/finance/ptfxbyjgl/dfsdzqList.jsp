...
<div class="w_main">
    <div class="main clearfix">
        <div class="wrap">
            <div class="r_main">
                <form action="<%=controller.getURI(request, DfsdzqList.class) %>" name="form1" method="post"
                      id="searchForm">
                    <div class="home_main">
                        <div class="box box1 mb15">
                            ...
                            <div class="con">
                                ...
                                <ul class="yhxq_li">
                                    <li>
                                        垫付总金额：<span
                                            class="blue"><%=Formater.formatAmount(dfsdzq.paymentAmount) %></span>元
                                    </li>
                                </ul>
                                <ul class="yhxq_li">
                                    <li>
                                ...
                                <ul class="yhxq_li">
                                    <li>
                                        待收总金额：<span
                                            class="blue"><%=Formater.formatAmount(dfsdzq.restoreAmount) %></span>元
                                    </li>
                                </ul>
                                <ul class="yhxq_li">
                                    <li>
