...
<%
    ...
    BigDecimal total = ObjectHelper.convert(request.getAttribute("repaymentTotal"), BigDecimal.class);
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form_loan" action="<%=controller.getURI(request, RepaymentStatistics.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>还款中统计表
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(ExportRepaymentStatistics.class)) {%>
                        ...
                        <div class="border mt20">
                        	<div class="tabnav-container">
                                <ul class="clearfix">
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">还款中<i class="icon-i tab-arrowtop-icon"></i></a></li>
...
<script type="text/javascript">
    ...
    function showExport() {
        document.getElementById("form_loan").action = "<%=controller.getURI(request, ExportRepaymentStatistics.class)%>";
        $("#form_loan").submit();
        document.getElementById("form_loan").action = "<%=controller.getURI(request, RepaymentStatistics.class)%>";
    }
</script>
</body>
</html>