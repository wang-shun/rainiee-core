            ...
            <div class="r_main">
                <div class="home_main">
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            <div class="clear"></div>
                            <form action="<%=controller.getURI(request, AddRank.class) %>" onsubmit="return check()"
                        	...
                        	<span class="tir required">
                          		<select name="F02" class="yhgl_sel" style="width:300px;">
                                    ...
                                    <option value="<%=entity.name()%>"><%=entity.getChineseName()%>
                                    </option>
                                    <%}%>
                                </select>
                        	</span>
                        	...
                        	<span class="tir required">
                          		<select name="F03" class="yhgl_sel" style="width:300px;">
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="F05" onblur="check()" type="text" class="text yhgl_ser"
                                                   maxlength="18"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/"
                                                   mtestmsg="必须为数字格式(且是两位小数)"/>
