                    ...
                    <div class="home_main">
                                ...
                                <div class="admin_input admin_pb">
                                    ...
                                    <p>等级类型：
                                        <select name="F02" class="yhgl_sel">
                                            ...
                                            %>
                                            <option value="<%=status.name()%>" <%if (status.name().equals(request.getParameter("F02"))) {%>
                                    ...
                                    <p>状态：
                                        <select name="F06" class="yhgl_sel">
                                            ...
                                            %>
                                            <option value="<%=status.name()%>" <%if (status.name().equals(request.getParameter("F06"))) {%>
                                                    selected="selected" <%}%>><%=status.getChineseName()%>
                                            </option>
                                            <%
                                                }
                                    ...
                                    <div class="mt10">
                                        ...
                                        <a href="<%=controller.getURI(request, AddRank.class)%>" class="btn3 mr10"><span
                        ...
                        <div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                                ...
                                <%
                                    T5127[] ranks = (result == null ? null : result.getItems());
                                    if (ranks != null) {
                                        int index = 1;
                                ...
                                <tr class="dhsbg">
                                    ...
                                    <td><%=rank.F02.getChineseName() %>
                                    </td>
                                    <td><%=rank.F03.getChineseName() %>
                                    </td>
                                    <td><%=rank.F04 %>
                                    </td>
                                    <td><%=rank.F05 %>
                                    </td>
                                    <td><%=rank.F06.getChineseName() %>
                                    </td>
                                    <td>
                                        <%if (dimengSession.isAccessableResource(UpdateRank.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateRank.class)%>?id=<%=rank.F01%>"
                                           class="blue">修改</a>
                                        <%} else { %>
                                        ...
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,EnableRank.class)%>?id=<%=rank.F01%>">启用</a></span>
                                        <%} else { %>
                                        ...
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,DisableRank.class)%>?id=<%=rank.F01%>">停用</a></span>
                                        <%} else { %>
