...
<%
    ...
    PagingResult<T5124> result = ObjectHelper.convert(request.getAttribute("result"), PagingResult.class);
    T5124[] entityArray = (result == null ? null : result.getItems());
%>
                        ...
                        <div class="box box1 mb15">
                            <div class="con">
                                <div class="admin_input admin_pb">
                                    <p>等级名称：<input type="text" name="name" class="yhgl_input"
                                    ...
                                    <p>状态：
                                        <select name="status" class="yhgl_sel">
                                            ...
                                            %>
                                            <option value="<%=t5124_F05.name()%>" <%if (t5124_F05.name().equals(request.getParameter("status"))) {%>
                                                    selected="selected" <%}%>><%=t5124_F05.getChineseName()%>
                                            </option>
                                            <%
                                                }
                                            %>
                                    ...
                                    <div class="mt10">
                                        ...
                                        <a href="javascript:void(0)" name="input"
                                           onclick="window.location.href='<%=controller.getURI(request, AddXydj.class)%>'"
                        ...
                        <div class="newsbox">
                            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                                ...
                                <tr class="dhsbg">
                                    ...
                                    <td><%=t5124.F05.getChineseName()%>
                                    </td>
                                    <td>
                                        <%if (dimengSession.isAccessableResource(ViewXydj.class)) {%>
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,ViewXydj.class)%>?id=<%=t5124.F01%>">修改</a></span>
                                        <%} else { %>
                                        ...
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,QyXydj.class)%>?id=<%=t5124.F01%>">启用</a></span>
                                        <%} else { %>
                                        ...
                                        <span class="blue"><a
                                                href="<%=controller.getURI(request,TyXydj.class)%>?id=<%=t5124.F01%>">停用</a></span>
                                        <%} else { %>
