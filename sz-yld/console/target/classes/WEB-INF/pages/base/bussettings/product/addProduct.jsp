                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增标产品名称
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form
                                    action="<%=controller.getURI(request, AddProduct.class)%>"
                                ...
                                <ul class="cell yw_jcxx">
                                    <li class="mb10">
                                        ...
                                        <input type="text"
                                               class="text yhgl_ser border required max-length-50" name="F02"
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="checkbox" class="mr5" name="F03" value="<%=t6211.F01%>"
                                            <%if(type==t6211.F01){%> checked="checked" <%}%>><%
                                        StringHelper.filterHTML(out, t6211.F02);%>&nbsp;&nbsp;&nbsp;&nbsp;<br/>
                                        <%
                                        } else {
                                        %>
                                        <input type="checkbox" class="mr5" name="F03" value="<%=t6211.F01%>"
                                    ...
                                    <li class="mb10">
                                        ...
                                        <%
                                            int way = IntegerParser.parse(request.getParameter("F11"));
                                        %>
                                        <%
                                            for (T6216_F11 model : T6216_F11.values()) {
                                        %>

                                        <input type="checkbox" class="mr5" <%if(model == T6216_F11.YCFQ){ %>onclick="changeQx(this)" <%} %> name="F11" value="<%=model.name()%>"
                                                <%if (model.name().equals(way)) {%>
                                               checked="checked" <%}%> /><%
                                        StringHelper.filterHTML(out, model.getChineseName());%>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <%
                                            }
                                        %>
                                    ...
                                    <li class="mb10">
                                        ...
                                        -&nbsp; <input type="text"
                                                       ...
                                                       mtest="/^\d+$/" mtestmsg="必须为整数" name="F08" id="maxQx"
                                    ...
                                    <li class="mb10" id="xqDay" style="display: none;">
											<span class="display-ib w200 tr mr5">
												&nbsp;
											</span>
                                        <input type="text"
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text"
                                               ...
                                               name="F12"
                                               value="<%=HighPrecisionFormater.toPlainString(BigDecimalParser.parse(request.getAttribute("bmoneyRate").toString()))%>"
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text"
                                               class="text yhgl_ser border required max-nesize-1 minf-size-0 max-precision-9"
                                               name="F13"
                                               value="<%=HighPrecisionFormater.toPlainString(BigDecimalParser.parse(request.getAttribute("tzRate").toString()))%>"
                                               mtest="/^\d*(\d|(\.[0-9]{1,3}))$/" mtestmsg="只能有三位小数"/>
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text"
                                               ...
                                               mtest="/^\d*(\d|(\.[0-9]{1,3}))$/" mtestmsg="只能有三位小数"
                                               name="F14"
                                               value="<%=HighPrecisionFormater.toPlainString(BigDecimalParser.parse(request.getAttribute("faxiRate").toString()))%>"/>
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text"
                                               ...
                                               value='<%=("0".equals(request.getAttribute("minAmount").toString())?"":HighPrecisionFormater.toPlainString(BigDecimalParser.parse(request.getAttribute("minAmount").toString())))%>'/>元
                                    ...
                                    <li class="mb10">
										...
										<select class="border mr20 h32 mw160" name="F18">
                                            ...
                                            <option value="<%=investLimit.name()%>"><%=investLimit.getChineseName()%></option>
                                            <%}%>
                                        </select>
                                    </li>
                                    <%}%>
