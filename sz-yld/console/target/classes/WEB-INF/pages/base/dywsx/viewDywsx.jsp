...
<%
    ...
    T6214 entity = (T6214) request.getAttribute("entity");
            ...
            <div class="r_main">
                <div class="home_main">
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            <form action="<%=controller.getURI(request, ViewDywsx.class)%>" method="post" class="form1">
                                <ul class="cell noborder yxjh ">
                                    <li>
                                        <div class="til"><span class="red">*</span>抵押物类型：</div>
                                        <div class="info">
                                            <select name="F02" class="text yhgl_ser required">
                                                <%
                                                ...
                                                %>
                                                <option value="<%=dywType.F01%>" <%if (dywType.F01 == entity.F02) {%>
                                                        selected="selected" <%}%>><%
                                                    StringHelper.filterHTML(out, dywType.F02);%></option>
                                                <%
                                                        }
                                                    }
                                                %>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="F03" type="text" maxlength="60" class="text yhgl_ser required"
                                ...
                                <div class="tc w220 pt20">
                                    ...
                                    <input type="button"
                                           onclick="window.location.href='<%=controller.getURI(request, DywsxList.class)%>'"
                                           class="btn4" value="返回"/>
                                </div>
                                <div class="clear"></div>
                            </form>
