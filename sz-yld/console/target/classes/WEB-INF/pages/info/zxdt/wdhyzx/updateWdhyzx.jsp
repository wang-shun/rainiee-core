                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改<%=xcglmanage.getCategoryNameByCode("WDHYZX") %>
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, UpdateWdhyzx.class)%>" class="form1"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
                                        ...
                                        <select name="status" class="text border w300 pl5">
