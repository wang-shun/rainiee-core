...
<%@page import="com.dimeng.p2p.console.servlets.info.zxdt.shzr.UpdateShzr" %>
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改<%=xcglmanage.getCategoryNameByCode("SHZR") %>
                        </div>
                    </div>
                    <div class="content-container pl40 pt40 pr40 pb20">
                        <form name="example" method="post" action="<%=controller.getURI(request, UpdateShzr.class)%>"
                            ...
                            <ul class="gray6 ">
                                ...
                                <li class="mb10">
                                    ...
                                    <span class="mb10"><img src="<%=fileStore.getURL(record.imageCode) %>" width="277"
                                                            height="89"/></span>
                                </li>
                                <li class="mb10">
