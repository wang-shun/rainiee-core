                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改<%=xcglmanage.getCategoryNameByCode("HLWJRYJ") %>
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, UpdateHlwjryj.class)%>" class="form1"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text" readonly="readonly" id="datepicker1" name="publishTime"
                                               ...
                                               value="<%=DateParser.format(record.publishTime)%>" onblur="checkDate()"/>
                                        <span tip></span>
                                        <span errortip class="" style="display: none"></span>
                                    </li>
                                    <li class="mb10">
