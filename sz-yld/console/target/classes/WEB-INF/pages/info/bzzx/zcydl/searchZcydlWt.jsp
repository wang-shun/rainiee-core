...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.AddZcydlWt" %>
...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.UpdateZcydlWt" %>
<%@page import="com.dimeng.p2p.modules.base.console.service.entity.QuestionTypeRecord" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.SearchZcydlWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.DeleteZcydlWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.AddZcydlWt" %>
...
<%
    ...
    QuestionTypeRecord[] questionTypes = manage.getQuestionTypes(T5011_F02.ZCYDL);
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchZcydlWt.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>注册与登录问题
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    <li><span class="display-ib mr5">注册与登录问题：</span>
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddZcydlWt.class)) {%>
                                        <a href="<%=controller.getURI(request, AddZcydlWt.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteZcydlWt.class)) {%>
                                    ...
                                    <li>
                                        <a href="<%=controller.getURI(request, SearchZcydlWtlx.class)%>"
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title tc">
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateZcydlWt.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateZcydlWt.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteZcydlWt.class) %>';
</script>
