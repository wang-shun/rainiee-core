...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.UpdateZcydlWtlx" %>
...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.SearchZcydlWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.DeleteZcydlWtlx" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.AddZcydlWtlx" %>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("ZCYDL");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchZcydlWtlx.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddZcydlWtlx.class)) {%>
                                        <a href="<%=controller.getURI(request, AddZcydlWtlx.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(SearchZcydlWt.class)) {%>
                                        <a href="<%=controller.getURI(request, SearchZcydlWt.class)%>"
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteZcydlWtlx.class)) {%>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title tc">
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateZcydlWtlx.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateZcydlWtlx.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteZcydlWtlx.class) %>';
</script>
...
<script type="text/javascript">
    ...
    var reloadUrl = '<%=controller.getURI(request, SearchZcydlWtlx.class)%>';
    $(function () {
    ...
    function updateNameLol(){
        updateName('ZCYDL')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showBZZXMenu("ZCYDL");
    }
</script>
</body>
</html>