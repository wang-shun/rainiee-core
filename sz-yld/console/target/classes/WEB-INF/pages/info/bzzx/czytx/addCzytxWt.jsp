                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增充值提现问题
                        </div>
                        <div class="content-container pl40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, AddCzytxWt.class)%>" class="form1" onsubmit="return onSubmit();">
                                <ul class="gray6">
                                    <li class="mb10 red">
                                    ...
                                    <li class="mb10">
                                        ...
                                        <br/>
                                        <span class="display-ib w200 tr mr5 fl">&nbsp</span>
