...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.UpdateTzyhkWtlx" %>
...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.DeleteTzyhkWtlx" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.AddTzyhkWtlx" %>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("TZYHK");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <div class="p20">
                    <form action="<%=controller.getURI(request, SearchTzyhkWtlx.class)%>" method="post" id="form1">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddTzyhkWtlx.class)) {%>
                                        <a href="<%=controller.getURI(request, AddTzyhkWtlx.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(SearchTzyhkWt.class)) {%>
                                        <a href="<%=controller.getURI(request, SearchTzyhkWt.class)%>"
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteTzyhkWtlx.class)) {%>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title tc">
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateTzyhkWtlx.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateTzyhkWtlx.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteTzyhkWtlx.class) %>';
</script>
...
<script type="text/javascript">
    ...
    var reloadUrl = '<%=controller.getURI(request, SearchTzyhkWtlx.class)%>';
    $(function () {
    ...
    function updateNameLol(){
        updateName('TZYHK')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showBZZXMenu("TZYHK");
    }
</script>
</body>
</html>