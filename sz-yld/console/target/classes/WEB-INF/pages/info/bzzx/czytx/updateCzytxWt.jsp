                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改充值提现问题
                        </div>
                        <div class="content-container pl40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, UpdateCzytxWt.class)%>" class="form1" onsubmit="return onSubmit();">
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
                                        ...
                                        <select name="questionTypeID" class="yhgl_ser">
                                            <%
                                    ...
                                    <li class="mb10">
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button" value="返回" class="btn btn-blue2 radius-6 pl20 pr20 ml20"
                                                   onclick="window.location.href='<%=controller.getURI(request, SearchCzytxWt.class) %>'">
                                        </div>
                                    </li>
                                </ul>
                            </form>
