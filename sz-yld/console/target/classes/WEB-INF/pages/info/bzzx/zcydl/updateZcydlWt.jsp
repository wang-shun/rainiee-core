                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改注册与登录问题
                        </div>
                        <div class="content-container pl40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, UpdateZcydlWt.class)%>" class="form1"  onsubmit="return onSubmit();">
                                    ...
                                    <li class="mb10">
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button" value="返回" class="btn btn-blue2 radius-6 pl20 pr20 ml20"
                                                   onclick="window.location.href='<%=controller.getURI(request, SearchZcydlWt.class) %>'">
                                        </div>
                                    </li>
                                </ul>
                            </form>
