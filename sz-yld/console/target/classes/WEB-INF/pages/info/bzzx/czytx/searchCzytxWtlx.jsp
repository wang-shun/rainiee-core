...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.UpdateCzytxWtlx" %>
...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.SearchCzytxWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.DeleteCzytxWtlx" %>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("CZYTX");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchCzytxWtlx.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddCzytxWtlx.class)) {%>
                                        <a href="<%=controller.getURI(request, AddCzytxWtlx.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(SearchCzytxWt.class)) {%>
                                        <a href="<%=controller.getURI(request, SearchCzytxWt.class)%>"
                                           class="btn btn-blue2 radius-6 mr5 pl10 pr10 tc">问题列表管理</a>
                                        <%} else { %>
                                        <a href="javascript:void(0)" class="btn btn-gray radius-6 mr5 pl10 pr10 tc">问题列表管理</a>
                                        <%} %>
                                    </li>
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteCzytxWtlx.class)) {%>
                                        <a href="javascript:void(0)" id="delAll"
                                           class="btn btn-blue2 radius-6 mr5 pl10 pr10 tc">批量删除</a>
                                        <%} else { %>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="tc">
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateCzytxWtlx.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateCzytxWtlx.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteCzytxWtlx.class) %>';
</script>
...
<script type="text/javascript">
    ...
    var reloadUrl = '<%=controller.getURI(request, SearchCzytxWtlx.class)%>';
    $(function () {
    ...
    function updateNameLol(){
        updateName('CZYTX')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showBZZXMenu("CZYTX");
    }
</script>
</body>
</html>