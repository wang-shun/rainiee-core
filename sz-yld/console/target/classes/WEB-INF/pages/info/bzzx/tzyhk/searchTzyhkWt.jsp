...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.AddTzyhkWt" %>
...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.SearchTzyhkWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.DeleteTzyhkWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.AddTzyhkWt" %>
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <div class="p20">
                    <form action="<%=controller.getURI(request, SearchTzyhkWt.class)%>" method="post" id="form1">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>投资与回款问题
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    <li><span class="display-ib mr5">投资与回款问题：</span>
                                        <input type="text" name=question id="textfield" class="text border pl5 mr20"
                                               value="<%StringHelper.filterHTML(out, request.getParameter("question"));%>"/></span>
                                    </li>
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddTzyhkWt.class)) {%>
                                        <a href="<%=controller.getURI(request, AddTzyhkWt.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteTzyhkWt.class)) {%>
                                    ...
                                    <li>
                                        <a href="<%=controller.getURI(request, SearchTzyhkWtlx.class)%>"
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title tc">
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateTzyhkWt.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateTzyhkWt.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteTzyhkWt.class) %>';
</script>
