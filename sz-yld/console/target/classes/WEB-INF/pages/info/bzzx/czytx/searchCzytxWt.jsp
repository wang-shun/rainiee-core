...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.UpdateCzytxWt" %>
...
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.DeleteCzytxWt" %>
<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.AddCzytxWt" %>
...
<%
    ...
    QuestionTypeRecord[] questionTypes = manage.getQuestionTypes(T5011_F02.CZYTX);
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchCzytxWt.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>充值与提现问题
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    <li><span class="display-ib mr5">充值与提现问题：</span>
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddCzytxWt.class)) {%>
                                        <a href="<%=controller.getURI(request, AddCzytxWt.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteCzytxWt.class)) {%>
                                    ...
                                    <li>
                                        <a href="<%=controller.getURI(request, SearchCzytxWtlx.class)%>"
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title tc">
                                    ...
                                    <td class="blue">
                                        <%if (dimengSession.isAccessableResource(UpdateCzytxWt.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateCzytxWt.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteCzytxWt.class) %>';
</script>
