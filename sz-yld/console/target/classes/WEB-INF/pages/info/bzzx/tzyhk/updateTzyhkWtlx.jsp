...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <div class="p20">
                    <form name="example" method="post" action="<%=controller.getURI(request, UpdateTzyhkWtlx.class)%>"
                          enctype="multipart/form-data" class="form1">
                        <input type="hidden" value="<%=record.id %>" name="id"/>

                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>修改投资与回款问题类型
                            </div>
