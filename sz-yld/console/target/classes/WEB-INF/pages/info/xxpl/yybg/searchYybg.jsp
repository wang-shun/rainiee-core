...
<%@page import="com.dimeng.p2p.console.servlets.info.xxpl.yybg.UpdateYybg"%>
<%@page import="com.dimeng.p2p.console.servlets.info.xxpl.yybg.DeleteYybg"%>
<%@page import="com.dimeng.p2p.console.servlets.info.xxpl.yybg.SearchYybg"%>
<%@page import="com.dimeng.p2p.modules.base.console.service.entity.OperateReport"%>
...
<%
    ...
    PagingResult<OperateReport> result = ObjectHelper.convert(request.getAttribute("result"), PagingResult.class);
    ArticleManage manage = serviceSession.getService(ArticleManage.class);
    T5010 category = manage.getArticleTypeByCode("YYBG");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchYybg.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                                ...
                                <div class="content-container pl40 pt30 pr40">
                                    <ul class="gray6 input-list-container clearfix">
                                        ...
                                        <li><span class="display-ib mr5">修改时间：</span>
                                            <input type="text" name="lastUpdateTimeStart" readonly="readonly"
                                        ...
                                        <li>
                                            <%if (dimengSession.isAccessableResource(AddYybg.class)) {%>
                                            <a href="<%=controller.getURI(request, AddYybg.class)%>"
                                               class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                        ...
                                        <li>
                                            <%if (dimengSession.isAccessableResource(DeleteYybg.class)) {%>
                                        ...
                                        <li>
                                     <%if (dimengSession.isAccessableResource(SearchYybg.class)) {%>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tbody class="f12">
                                <% OperateReport[] records = result.getItems();
                                    if (records != null && records.length != 0) {
                                        int index = 1;
                                        for (OperateReport record : records) {
                                %>
                                <tr class="title" align="center">
                                    ...
                                    <td>
                                        <%if (dimengSession.isAccessableResource(UpdateYybg.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateYybg.class)%>?id=<%=record.id %>"
                        ...
                        <% SearchYybg.rendPagingResult(out, result);%>
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteYybg.class) %>';
    var upateUrl = '<%=controller.getURI(request, UpdateCategoryName.class)%>';
    var reloadUrl = '<%=controller.getURI(request, SearchYybg.class)%>';
...
<script type="text/javascript">
    function updateNameLol(){
        updateName('YYBG')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showZXDTMenu("YYBG");
    }
</script>
