                    ...
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            ...
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, UpdateYjbg.class)%>" class="form1"
                                ...
                                <ul class="cell xc_jcxx ">
                                    <li>
                                        ...
                                        <div class="info orange">
                                            <p errortip class=""
                                            "><%StringHelper.filterHTML(out, controller.getPrompt(request, response,PromptLevel.ERROR));  %></p>
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="info orange">
                                            <select name="status">
                                                <option value="<%=PerformanceReportPublishStatus.WFB %>"
                                                        <%if(record.publishStatus.equals(PerformanceReportPublishStatus.WFB)){ %>selected="selected"<%} %>><%=PerformanceReportPublishStatus.WFB.getName() %>
                                                </option>
                                                <option value="<%=PerformanceReportPublishStatus.YFB %>"
                                                        <%if(record.publishStatus.equals(PerformanceReportPublishStatus.YFB)){ %>selected="selected"<%} %>><%=PerformanceReportPublishStatus.YFB.getName() %>
                                                </option>
                                            </select>
                                        </div>
                                        <div class="clear"></div>
                                    ...
                                    <li>
                                        ...
                                        <div class="info orange"><input type="file" class="text yhgl_ser yw_w4"
                                                                        name="file"/></div>
                                        <div class="clear"></div>
                                    </li>
