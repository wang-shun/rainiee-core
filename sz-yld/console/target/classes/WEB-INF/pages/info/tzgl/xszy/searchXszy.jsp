...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("XSZY");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchXszy.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        ...
                                        <a href="<%=controller.getURI(request, AddXszy.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                     <%if (dimengSession.isAccessableResource(SearchXszy.class)) {%>
                            ...
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title tc">
                                    ...
                                    <td class="blue">
                                        ...
                                        <a href="<%=controller.getURI(request, UpdateXszy.class)%>?id=<%=record.id %>"
...
<script type="text/javascript">
    ...
    var reloadUrl = '<%=controller.getURI(request, SearchXszy.class)%>';
...
<script type="text/javascript">
    function updateNameLol(){
        updateName('XSZY')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showTZGLMenu("XSZY");
    }
</script>
