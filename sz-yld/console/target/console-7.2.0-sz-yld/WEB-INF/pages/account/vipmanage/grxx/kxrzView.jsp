                    ...
                    <div class="border mt20">
                        <div class="tabnav-container">
                            <ul class="clearfix border-b-s">
                                ...
                                <li><a href="javascript:void(0)" class="tab-btn select-a">可选认证 （<%=kxrztg%>
                                    /<%=basicInfo.notNeedAttestation%>）<i class="icon-i tab-arrowtop-icon"></i></a></li>
                                            ...
                                            <tr class="tc">
                                                ...
                                                <td align="center" class="blue">
                                                    ...
                                                    <a href="<%=controller.getURI(request,Open.class)%>?id=<%=id%>"
                                                       target="_blank"
                                                       class="link-blue mr20">查看证件&nbsp;<%=a+1 %>&nbsp;</a>
                                                    <%
                                                            }
                                                        }
                                                    %> --%>
