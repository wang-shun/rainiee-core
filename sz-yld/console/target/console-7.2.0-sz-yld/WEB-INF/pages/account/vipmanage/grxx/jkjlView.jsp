                ...
                <div class="p20">
                    ...
                    <div class="border mt20">
                        ...
                        <div class="tab-content-container p20">
                            <form id="form1"
                                  action="<%=controller.getURI(request, JkjlView.class)%>?userId=<%=basicInfo.userId%>&operationJK=<%=operationJK%>"
                                  method="post">
                                <div class="tab-item">
                                    <div>
                                        <ul class="gray6 input-list-container clearfix">
                                            ...
                                            <li><span class="display-ib mr5">借款标题</span>
                                                <input type="text" name="loanRecordTitle" class="text border pl5 mr20" value='<%StringHelper.filterHTML(out, request.getParameter("loanRecordTitle"));%>'/>
                                            </li>
                                            ...
                                            <li><span class="display-ib mr5">状态</span>
                                                <select name="state" class="border display-ib mr20 h32">
                                            ...
                                            <li><a class="btn btn-blue radius-6 mr20 pl1 pr15"
                                    ...
                                    <div class="border table-container">
                                        <table class="table table-style gray6 tl">
                                            ...
                                            <tr class="tc">
                                                <td><%=i++%></td>
                                                <td class="tc"><%=loanRecord.loanNum%>
                                                </td>
                                                <td title="<%=loanRecord.loanRecordTitle%>"><%
                                                    StringHelper.filterHTML(out, StringHelper.truncation(loanRecord.loanRecordTitle, 10));%></td>
                                                <td><%=Formater.formatRate(loanRecord.yearRate)%>
                                                </td>
                                                <td><%=Formater.formatAmount(loanRecord.loanAmount)%>元</td>
                                                <td><%=Formater.formatAmount(loanRecord.amount)%>元</td>
                                                <%if (T6231_F21.S == loanRecord.dayBorrowFlg) { %>
                                                <td><%=loanRecord.deadline%>天</td>
                                                <%} else { %>
                                                <td><%=loanRecord.deadline%>个月</td>
                                                <%} %>
                                                <td><%=TimestampParser.format(loanRecord.loanRecordTime)%>
                                                </td>
