                                    ...
                                    <ul class="gray6">
                                        ...
                                        <li class="mb10"><span class="display-ib w200 tr mr5 fl"><em
                                            ...
                                            <textarea name="F04" cols="" rows=""
                                                      class="w400 h120 border p5 required max-length-255"><%StringHelper.format(out, entity.F04, fileStore); %></textarea>
                                            <span tip></span>
                                            <span errortip class="red" style="display: none"></span>
                                        </li>
                                        <li class="mb10"><span class="display-ib w200 tr mr5 fl"><em
                                            ...
                                            <textarea name="F05" cols="" rows=""
                                                      class="w400 h120 border p5 required max-length-255"><%StringHelper.format(out, entity.F05, fileStore); %></textarea>
                                            <span tip></span>
                                            <span errortip class="red" style="display: none"></span>
                                        </li>
                                        <li class="mb10">
                                            <div class="pl200 ml5">
                                            	<input type="button"
                                                       onclick="window.location.href='<%=controller.getURI(request,UpdateDbzz.class)%>?id=<%=request.getParameter("id")%>'"
