...
<%@page import="com.dimeng.p2p.console.servlets.account.vipmanage.qyxx.Rzbtg"%>
<%@page import="com.dimeng.p2p.console.servlets.account.vipmanage.qyxx.Rztg"%>
...
<script type="text/javascript">
    $(function () {
        $("#backBtn").click(function () {
            window.location = "<%=controller.getURI(request, QyList.class)%>";
        });
    });
