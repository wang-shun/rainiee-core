...
<%@page import="com.dimeng.p2p.console.servlets.account.vipmanage.qyxx.dgzh.UpdateDgzh" %>
                    ...
                    <div class="newsbox">
                        <div class="til clearfix">
                            <div class="Menubox">
                                <ul>
                                    <li>
                                        <a href="<%=controller.getURI(request, UpdateJscl.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("id"));%>">介绍资料</a>
                                    </li>
                                    <li>
                                        <a href="<%=controller.getURI(request, UpdateCwzk.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("id"));%>">财务状况</a>
                                    </li>
                                    <li>
                                        <a href="<%=controller.getURI(request, UpdateLxxx.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("id"));%>">联系信息</a>
                                    </li>
                                    <li>
                                        <a href="<%=controller.getURI(request, ListCcxx.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("id"));%>">车产信息</a>
                                    </li>
                                    <li>
                                        <a href="<%=controller.getURI(request, ListFcxx.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("id"));%>">房产信息</a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <select name="F03" class="text yhgl_ser">
                                                ...
                                                %>
                                                <option value="<%=bank.F01%>"><%
                                                    StringHelper.filterHTML(out, bank.F02); %></option>
                                                <%
                                                        }
                                                    }
                                                %>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="F06" maxlength="20" type="text"
                                                   class="text yhgl_ser  required isint textv-a"
                                                   value="<%StringHelper.filterHTML(out,StringHelper.decode(entity.F07)); %>"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="F07" maxlength="20" type="text"
                                                   class="text yhgl_ser required isint textv-b" onpaste="return false"
