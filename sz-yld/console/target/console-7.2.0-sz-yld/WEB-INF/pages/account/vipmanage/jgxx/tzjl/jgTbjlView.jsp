                    ...
                    <div class="border mt20">
                        <div class="tabnav-container">
                            <ul class="clearfix">
                                ...
                                <%} %>
                                <li><a href="javascript:void(0);" class="tab-btn select-a">投资记录</a></li>
                            </ul>
                        </div>
                        <div class="tab-content-container p20">
                            <form id="form1"
                                  action="<%=controller.getURI(request, JgTbjlView.class)%>?userId=<%=request.getParameter("id")%>"
                                  method="post">
                                ...
                                <div class="tab-item">
                                    ...
                                    <div class="border table-container">
                                        <table class="table table-style gray6 tl">
                                            ...
                                            <tr class="tc">
                                                <td><%=i++%></td>
                                                <td><%=tenderRecord.tenderRecordId%>
                                                </td>
                                                ...
                                                <td><%=Formater.formatRate(tenderRecord.yearRate)%>
                                                </td>
                                                ...
                                                <%} %>
                                                <td><%=TimestampParser.format(tenderRecord.tenderTime)%>
                                                </td>
                                                <td><%=tenderRecord.tenderRecordState.getChineseName()%>
                                                </td>
                                            </tr>
                                            <% }
                                            } else {%>
