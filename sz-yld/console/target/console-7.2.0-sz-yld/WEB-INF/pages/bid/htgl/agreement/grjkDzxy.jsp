...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form2" action="<%=controller.getURI(request, GrjkDzxy.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>个人借款协议管理
                            </div>
                        ...
                        <div class="border mt20">
                            <div class="tabnav-container">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="javascript:void(0)" class="tab-btn  select-a">个人借款协议<i class="icon-i tab-arrowtop-icon"></i></a></li>
                            ...
                            <div class=" table-container p20">
                                <table class="table table-style gray6 tl">
                                    ...
                                    <tr class="tc">
                                        ...
                                        <td align="center"><%StringHelper.filterHTML(out, StringHelper.decode(t6141.F07));%></td>
