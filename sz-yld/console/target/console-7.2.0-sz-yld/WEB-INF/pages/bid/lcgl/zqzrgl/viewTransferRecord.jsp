                ...
                <div class="home_main">
                    ...
                    <div class="newsbox">
                        ...
                        <div class="border p15-30 Men_bt no_table" id="con_one_5">
                            <div class="fr mb10"><span class="mr10">交易总金额<em
                                    class="f18 orange"><%=transferRecord.totalDealMoney %>
                            </em></span></div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc mb15">
                                ...
                                <tr class="tc">
                                    ...
                                    <td><%=Formater.formatAmount(transferRecordInfo.dealMoney) %>
                                    </td>
                                    <td><%=TimestampParser.format(transferRecordInfo.dealTime) %>
                                    </td>
                                </tr>
                                <%
                                    }
