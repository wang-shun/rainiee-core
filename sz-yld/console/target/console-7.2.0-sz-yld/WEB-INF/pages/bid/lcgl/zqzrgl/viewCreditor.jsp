...
<%@page import="com.dimeng.p2p.modules.financial.console.service.entity.CreditorInfo" %>
...
<%
    ...
    CreditorInfo[] creditorInfos = ObjectHelper.convertArray(request.getAttribute("creditorInfo"), CreditorInfo.class);
%>
                ...
                <div class="home_main">
                    ...
                    <div class="newsbox">
                        <div class="til clearfix">
                            <div class="Menubox">
                                <ul>
                                    ...
                                    <li id="one4" class="hover">债权信息</li>
                                    <li id="one5"
                        ...
                        <div class="border p15-30 Men_bt no_table" id="con_one_3">
                            <div class="fr mb10"><span class="mr10">持有债权人数<em
                                    class="f18 orange"><%if (creditorInfos != null) {%><%=creditorInfos.length%><%} else { %>
                                0<%} %></em>人</span></div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc mb15">
                                ...
                                <%
                                    if (creditorInfos != null) {
                                        for (int i = 0; i < creditorInfos.length; i++) {
                                            CreditorInfo creditorInfo = creditorInfos[i];
                                ...
                                <tr class="tc">
                                    ...
                                    <td><%StringHelper.filterHTML(out, creditorInfo.userName);%></td>
                                    <td><%=creditorInfo.tenderTime %>
                                    </td>
                                </tr>
                                <%
                                    }
