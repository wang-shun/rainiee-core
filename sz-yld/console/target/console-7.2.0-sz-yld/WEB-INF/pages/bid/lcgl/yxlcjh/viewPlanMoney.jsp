                        ...
                        <div class="til clearfix">
                            <div class="Menubox">
                                <ul>
                                    ...
                                    <li id="one2" style="border-right:1px #d7dfe3 solid;"
                                        onclick="window.location.href='<%=controller.getURI(request, ViewAddRecord.class)%>?planMoneyId=<%=planMoneyView.planMoneyId%>'">
                                        加入记录
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="border p15-30 Men_bt li30"
                             id="con_one_1"><%StringHelper.filterHTML(out, planMoneyView.planMoneyDesc);%>
                        </div>
                        <div class="clear"></div>
                    </div>
