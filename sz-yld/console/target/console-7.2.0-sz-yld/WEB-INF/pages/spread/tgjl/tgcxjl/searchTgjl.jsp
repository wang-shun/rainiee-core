...
<%@page import="com.dimeng.p2p.console.servlets.spread.tgjl.tgcxjl.ExportTgjl" %>
...
<%
    ...
    SpreadList searchSpreadListAmount = (SpreadList)request.getAttribute("searchSpreadListAmount");
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form id="form1" action="<%=controller.getURI(request, SearchTgjl.class)%>" method="post">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>推广持续奖励详情列表
                            </div>
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li><span class="display-ib mr5">被推广人用户名</span>
                                        <input type="text" name="personUserName" id="textfield" class="text border pl5 mr20"
                                               value="<%StringHelper.filterHTML(out, request.getParameter("personUserName")); %>"/>
                                    </li>
                                    <li><span class="display-ib mr5">被推广人姓名</span>
                                        <input type="text" name="personName" id="textfield"
                        ...
                        <p class="mt5">
                            <span class="mr30">推广投资总金额：<em class="red"><%=Formater.formatAmount(searchSpreadListAmount.spreadTotalMoney)%>
                            </em> 元</span>
                            <span class="mr30">持续奖励总金额：<em class="red"><%=Formater.formatAmount(searchSpreadListAmount.rewardMoney)%>
                            </em> 元</span>
                        </p>
                        <!--分页-->
