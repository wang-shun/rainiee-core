...
<%@page import="com.dimeng.p2p.console.servlets.info.zxdt.mtbd.*" %>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("MTBD");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchMtbd.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddMtbd.class)) {%>
                                        <a href="<%=controller.getURI(request, AddMtbd.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteMtbd.class)) {%>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title" align="center">
                                    ...
                                    <td>
                                        <%if (dimengSession.isAccessableResource(UpdateMtbd.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateMtbd.class)%>?id=<%=record.id %>"
                        ...
                        <% SearchMtbd.rendPagingResult(out, result);%>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteMtbd.class) %>';
    var upateUrl = '<%=controller.getURI(request, UpdateCategoryName.class)%>';
    var reloadUrl = '<%=controller.getURI(request, SearchMtbd.class)%>';
...
<script type="text/javascript">
    function updateNameLol(){
        updateName('MTBD')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showZXDTMenu("MTBD");
    }
</script>
