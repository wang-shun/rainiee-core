...
<%@page import="com.dimeng.p2p.console.servlets.info.zxdt.hlwjryj.AddHlwjryj" %>
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增<%=xcglmanage.getCategoryNameByCode("HLWJRYJ") %>
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post"
                                  action="<%=controller.getURI(request, AddHlwjryj.class)%>" class="form1"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
                                        <span class="display-ib w200 tr mr5"><span class="red">*</span>文章标题：</span>
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text" id="datepicker1" readonly="readonly" onblur="checkDate()"
                                    ...
                                    <li class="mb10">
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button"
                                                   onclick="window.location.href='<%=controller.getURI(request, SearchHlwjryj.class) %>'"
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, SearchHlwjryj.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
