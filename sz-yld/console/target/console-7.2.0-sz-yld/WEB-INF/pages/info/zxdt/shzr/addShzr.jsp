                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增<%=xcglmanage.getCategoryNameByCode("SHZR") %>
                        </div>
                    </div>
                    <div class="content-container pl40 pt40 pr40 pb20">
                        <form name="example" method="post" action="<%=controller.getURI(request, AddShzr.class)%>"
                            ...
                            <ul class="gray6 ">
                                ...
                                <li class="mb10">
                                    ...
                                    <input type="file" class="text border w300 pl5" name="image"/><span id="errorImage">&nbsp;</span>
                                </li>
                                <li class="mb10">
                                    <span class="display-ib w200 tr mr5"><span class="red"></span>排序值：</span>
                                    <input type="text" class="text border w300 pl5 isint max-length-10" name="sortIndex"
                                ...
                                <li class="mb10">
                                    ...
                                    <input type="text" readonly="readonly" id="datepicker1" onblur="checkDate()"
                                           name="publishTime" class="text border w300 pl5 date required"
                                ...
                                <li class="mb10">
                                    <div class="pl200 ml5"><input type="submit"
                                        ...
                                        <input type="button" value="取消" class="btn btn-blue2 radius-6 pl20 pr20 ml20"
                                               onclick="window.location.href='<%=controller.getURI(request, SearchShzr.class) %>'"/>
                                    </div>
                                </li>
                            </ul>
                        </form>
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, SearchShzr.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
