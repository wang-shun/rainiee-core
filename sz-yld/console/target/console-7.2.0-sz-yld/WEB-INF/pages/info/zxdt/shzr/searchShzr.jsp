...
<%@page import="com.dimeng.p2p.console.servlets.info.zxdt.shzr.*" %>
...
<%
    ...
    T5010 category = manage.getArticleTypeByCode("SHZR");
%>
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, SearchShzr.class)%>" method="post" id="form1">
                    <div class="p20">
                        <div class="border">
                            ...
                            <div class="content-container pl40 pt30 pr40">
                                <ul class="gray6 input-list-container clearfix">
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(AddShzr.class)) {%>
                                        <a href="<%=controller.getURI(request, AddShzr.class)%>"
                                           class="btn btn-blue radius-6 mr5 pl1 pr15"><i
                                    ...
                                    <li>
                                        <%if (dimengSession.isAccessableResource(DeleteShzr.class)) {%>
                                        <a href="javascript:void(0)" id="delAll"
                                           class="btn btn-blue2 radius-6 mr5 pl10 pr10">批量删除</a>
                                        <%} else { %>
                                        <span class="btn btn-gray radius-6 mr5 pl10 pr10"><span class="ico4"></span>批量删除</span>
                                        <%} %>
                                    </li>
                                    <li>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="title" align="center">
                                    ...
                                    <td>
                                        <%if (dimengSession.isAccessableResource(UpdateShzr.class)) {%>
                                        <a href="<%=controller.getURI(request, UpdateShzr.class)%>?id=<%=record.id %>"
                        ...
                        <% SearchShzr.rendPagingResult(out, result);%>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    var del_url = '<%=controller.getURI(request, DeleteShzr.class) %>';
    var upateUrl = '<%=controller.getURI(request, UpdateCategoryName.class)%>';
    var reloadUrl = '<%=controller.getURI(request, SearchShzr.class)%>';
...
<script type="text/javascript">
    function updateNameLol(){
        updateName('SHZR')
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showZXDTMenu("SHZR");
    }
</script>
