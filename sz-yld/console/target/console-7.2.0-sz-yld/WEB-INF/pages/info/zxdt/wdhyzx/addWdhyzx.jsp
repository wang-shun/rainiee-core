                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增<%=xcglmanage.getCategoryNameByCode("WDHYZX") %>
                        </div>

                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post" action="<%=controller.getURI(request, AddWdhyzx.class)%>"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
                                        ...
                                        <input type="text" readonly="readonly" id="datepicker1" name="publishTime"
                                               class="text border w300 pl5 date required"
                                    ...
                                    <li class="mb10">
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button"
                                                   onclick="window.location.href='<%=controller.getURI(request, SearchWdhyzx.class) %>'"
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, SearchWdhyzx.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
