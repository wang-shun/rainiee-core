                ...
                <div class="r_main">
                        ...
                        <div class="box box1 mb15">
                            ...
                            <div class="con">
                                ...
                                <div class="admin_input admin_pb">
                                    <p>
                                        <span>文章标题：</span><span><input type="text" name="title" id="textfield"
                                                                       class="yhgl_input"
                                                                       value="<%StringHelper.filterHTML(out, request.getParameter("title"));%>"/></span>
                                    </p>
                                    ...
                                    <p>
                                        <span>修改时间：</span><span><input type="text" name="updateTimeStart"
                                                                       readonly="readonly" id="datepicker1"
                                                                       class="yhgl_input date"
                                                                       value="<%StringHelper.filterHTML(out, request.getParameter("updateTimeStart"));%>"/></span>
                                        <span>至</span><span><input type="text" name="updateTimeEnd" readonly="readonly"
                                                                   id="datepicker2" class="yhgl_input date "
                                                                   value="<%StringHelper.filterHTML(out, request.getParameter("updateTimeEnd"));%>"/></span>
                                    </p>
                    ...
                    <span>
                    	<select name="publishStatus">
                            <option>全部</option>
                            <option value="<%=PerformanceReportPublishStatus.WFB %>"
                                    <%if(! StringHelper.isEmpty(request.getParameter("publishStatus")) && request.getParameter("publishStatus").equals(PerformanceReportPublishStatus.WFB.name())){ %>selected="selected"<%} %>><%=PerformanceReportPublishStatus.WFB.getName() %>
                            </option>
                            <option value="<%=PerformanceReportPublishStatus.YFB %>"
                                    <%if(! StringHelper.isEmpty(request.getParameter("publishStatus")) && request.getParameter("publishStatus").equals(PerformanceReportPublishStatus.YFB.name())){ %>selected="selected"<%} %>><%=PerformanceReportPublishStatus.YFB.getName() %>
                            </option>
                        </select>
                    </span>
                                    </p>
                                    ...
                                    <div class="mt10">
                                        ...
                                        <a href="<%=controller.getURI(request, AddYjbg.class)%>" class="btn3 mr10"><span
                                                class="ico3"></span>新增</a>
                                        <%} else { %>
                                        <span class="btn3 btn5 mr10"><span class="ico3"></span>新增</span>
                                        <%} %>
                                        <%if (dimengSession.isAccessableResource(DeleteYjbg.class)) {%>
                                        <a href="javascript:void(0)" id="delAll" class="btn3 mr10"><span
                                                class="ico4"></span>批量删除</a>
                                        <%} else { %>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                                ...
                                <tr class="dhsbg">
                                    ...
                                    <td class="blue">
                                        ...
                                        <%} %>
                                        <%if (dimengSession.isAccessableResource(DeleteYjbg.class)) {%>
                                        <a href="javascript:void(0)" onclick="delThis('<%=record.id %>')">删除</a>
                                        <%} else { %>
