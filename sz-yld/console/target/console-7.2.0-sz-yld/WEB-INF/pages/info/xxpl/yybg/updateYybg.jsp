<%@page import="com.dimeng.p2p.S50.entities.T5011_3"%>
...
<%
    ...
    T5011_3 info = ObjectHelper.convert(request.getAttribute("info"), T5011_3.class);
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改<%=xcglmanage.getCategoryNameByCode("YYBG") %>
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post" enctype="multipart/form-data" 
                                  action="<%=controller.getURI(request, UpdateYybg.class)%>" class="form1"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
	                                    ...
	                                    <input type="text" class="text border w300 pl5 required " maxlength="4" mtest="/^\d{4}/" mtestmsg="必须为4位整数"  name="year" 
	                                           value="<%=info.F06 %>"/>
	                                    <span tip></span>
	                                    <span errortip class="" style="display: none"></span>
	                                    <div class="clear"></div>
