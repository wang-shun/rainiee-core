...
<%
    ...
    CURRENT_SUB_CATEGORY = "PTZH";
    String connent = ObjectHelper.convert(request.getAttribute("content"), String.class);
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增/修改  <%=xcglmanage.getCategoryNameByCode("PTZH") %>
                        </div>
                    </div>
                    <div class="content-container pl40 pt40 pr40 pb20">
                        <form action="<%=controller.getURI(request, UpdatePtzh.class)%>" method="post" name="example"
                            ...
                            <ul class="gray6">
                                ...
                                <li class="mb10">
                                    <div class="pl200 ml5"><input type="submit" class="btn btn-blue2 radius-6 pl20 pr20 sumbitForme"
                                                                  fromname="form1" value="确认"/></div>
                                </li>
                            </ul>
                        </form>
                        <div class="clear"></div>
...
<script type="text/javascript">
    $(function(){
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showTZGLMenu("PTZH");
    });
</script>
<script>
    var editor1;
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, UpdatePtzh.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
