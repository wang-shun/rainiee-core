                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增<%=xcglmanage.getCategoryNameByCode("GLTD") %>
                        </div>

                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form name="example" method="post" action="<%=controller.getURI(request, AddGltd.class)%>"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
											<span class="display-ib w200 tr mr5">
												<span class="red">*</span>团队名称：
											</span>
                                        <input type="text"
                                               class="text border w300 pl5 required max-length-15"
                                               name="title"
                                    ...
                                    <li class="mb10">
											<span class="display-ib w200 tr mr5 fl">
												<span class="red">*</span>团队简介：
											</span>
											<textarea name="content"
                                                      class="w400 h120 border p5 required max-length-140" cols="100"
                                                      rows="8"
                                                      style="width: 700px; height: 200px;"><%StringHelper.format(out, request.getParameter("content"), fileStore); %>
											</textarea>
                                        <br/>
                                    ...
                                    <li class="mb10">
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button"
                                                   onclick="window.location.href='<%=controller.getURI(request, SearchGltd.class) %>'"
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, SearchGltd.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
