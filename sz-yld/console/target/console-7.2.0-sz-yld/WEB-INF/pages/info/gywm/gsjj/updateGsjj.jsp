...
<%@page
        import="com.dimeng.p2p.console.servlets.info.gywm.gsjj.UpdateGsjj" %>
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增/修改 <%=xcglmanage.getCategoryNameByCode("GSJJ") %>
                        </div>

                        <div class="content-container pl40 pt40 pr40 pb20">
                            <%
                                String content = ObjectHelper.convert(request.getAttribute("content"), String.class);
                            	T5010 t5010 = ObjectHelper.convert(request.getAttribute("t5010"), T5010.class);
                            %>
                            <form action="<%=controller.getURI(request, UpdateGsjj.class)%>"
                                ...
                                <ul class="gray6">
                                    ...
                                    <li class="mb10">
										...
										<input type="text"
                                               ...
                                               name="title"
                                               maxlength="8"
                                               value="<%StringHelper.filterHTML(out, t5010.F03);%>"/>
                                    ...
                                    <li class="mb10">
                                        ...
                                        <select name="status"  class="border mr20 h32 required mw100">
                                                ...
                                                <option value="<%=t5010_F04.name()%>"
                                                        <%if(t5010_F04 == t5010.F04) {%>selected="selected"<%} %>><%=t5010_F04.getChineseName() %>
                                                </option>
                                                <%
                                                        }
                                                    }
...
<script type="text/javascript">
    $(function(){
        //保存成功，修改左菜单标题
        parent.frames["leftFrame"].window.showGYWMMenu("GSJJ");
    });
</script>
<script>
    var editor1;
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, UpdateGsjj.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
