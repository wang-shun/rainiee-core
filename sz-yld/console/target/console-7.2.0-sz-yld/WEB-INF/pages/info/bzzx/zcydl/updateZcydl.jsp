<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.zcydl.UpdateZcydl" %>
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增/修改 注册与登录
                        </div>
                    </div>
                    <div class="con">
                        <div class="clear"></div>
                        <form action="<%=controller.getURI(request, UpdateZcydl.class)%>" method="post" name="example"
