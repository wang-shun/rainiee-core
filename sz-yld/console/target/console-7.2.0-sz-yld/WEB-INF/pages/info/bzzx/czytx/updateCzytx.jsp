<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.czytx.UpdateCzytx" %>
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增/修改 充值与提现
                        </div>
                    </div>
                    <div class="con">
                        <div class="clear"></div>
                        <form action="<%=controller.getURI(request, UpdateCzytx.class)%>" method="post" name="example"
