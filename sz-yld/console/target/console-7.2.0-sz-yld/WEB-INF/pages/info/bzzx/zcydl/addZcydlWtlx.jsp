...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <div class="p20">
                    <form name="example" method="post" action="<%=controller.getURI(request, AddZcydlWtlx.class)%>"
                          class="form1" enctype="multipart/form-data" onsubmit="return checkImage();">
                          <%=FormToken.hidden(serviceSession.getSession()) %>
                        <div class="border">
                            <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>新增注册与登录问题类型
                            </div>
                                    ...
                                    <li>
                                        <div class="pl200 ml5">
                                            ...
                                            <input type="button" value="取消" class="btn btn-blue2 radius-6 pl20 pr20 ml20"
                                                   onclick="window.location.href='<%=controller.getURI(request, SearchZcydlWtlx.class) %>'">
                                        </div>
                                </ul>
                            </div>
                        </div>
...
%>
<script type="text/javascript">
    $("#info").html(showSuccInfo("<%=errorMessage%>", "wrong","<%=controller.getURI(request, SearchZcydlWtlx.class)%>"));
    $("div.popup_bg").show();
</script>
<%
    }
