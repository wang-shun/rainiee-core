<%@page import="com.dimeng.p2p.console.servlets.info.bzzx.tzyhk.UpdateTzyhk" %>
                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>新增/修改 投资与回款
                        </div>
                    </div>
                    <div class="con">
                        <div class="clear"></div>
                        ...
                        %>
                        <form action="<%=controller.getURI(request, UpdateTzyhk.class)%>" method="post" name="example"
