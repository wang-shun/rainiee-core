...
<div class="protocol">
    ...
    %><br/><br/>
        ...
        鉴于：<br/>
        1、丁方是一家在深圳市罗湖区合法成立并有效存续的有限责任公司，拥有<%=configureProvider.getProperty(SystemVariable.SITE_DOMAIN)%>
        网站（以下简称“该网站”）的经营权，提供信用咨询，为交易提供信息服务；<br/>
        ...
        】月【<%=calendar.get(Calendar.DAY_OF_MONTH)%>】日 签订如下协议，共同遵照履行：</strong><br/><br/>
        ...
        5、
        无须通知乙方和丙方，甲方可以根据自己的意愿进行本协议下其对乙方债权的转让。在甲方的债权转让后，乙方仍应按照本协议的约定向债权受让人支付每期应还贷款本息，不得以未接到债权转让通知为由拒绝履行还款义务，丙方需对债权受让人继续履行本协议下其对甲方的担保义务。<br/>
        ...
        <p><strong>乙方权利和义务 </strong><br/>
            ...
            3、
            甲乙双方同意丁方有权代甲方在有必要时对乙方或丙方进行贷款的违约提醒及催收工作，包括但不限于电话通知、发律师函、对乙方提起诉讼等。甲方在此确认明确委托丁方为其进行以上工作，并授权丁方可以将此工作委托给其他方进行。乙方和丙方对前述委托的提醒、催收事项已明确知晓并应积极配合。<br/>
