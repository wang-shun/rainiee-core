...
<div class="w_main">
    <div class="main clearfix">
        <div class="wrap">
            <div class="r_main">
                <form action="<%=controller.getURI(request, YwDetail.class)%>" name="form1" method="post"
                      id="searchForm">
                    ...
                    <div class="home_main">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                            ...
                            <tr class="dhsbg">
                                ...
                                <td><%=Formater.formatAmount(record.loanAmount)%>
                                </td>
                                <td><%=Formater.formatAmount(record.proportion)%>
                                </td>
                                <td><%=record.deadline%>
                                </td>
                                <td><%=Formater.formatAmount(record.dfAmount)%>
                                </td>
