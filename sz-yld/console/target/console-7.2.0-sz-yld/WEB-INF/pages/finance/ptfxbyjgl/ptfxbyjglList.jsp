...
<div class="w_main">
    <div class="main clearfix">
        <div class="wrap">
            <div class="r_main">
                <form action="<%=controller.getURI(request, PtfxbyjglList.class) %>" name="form1" method="post"
                      id="searchForm">
                    <div class="home_main">
                        <div class="box box1 mb15">
                            ...
                            <div class="con">
                                ...
                                <ul class="yhxq_li">
                                    <li>
                                        平台风险备用金余额：<span
                                            class="blue"><%=Formater.formatAmount(ptfxbyjgl.riskFund)%></span>元
                                    </li>
                                </ul>
                                <ul class="yhxq_li">
                                    <li>收入总额 ：<span
                                            class="blue"><%=Formater.formatAmount(ptfxbyjgl.totalIncome)%></span>元
                                    </li>
                                </ul>
                                <ul class="yhxq_li">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                            ...
                            <tr class="dhsbg">
                                ...
                                <td><%=DateTimeParser.format(record.playTime, "yyyy-MM-dd HH:mm") %>
                                </td>
                                <td><%if (!StringHelper.isEmpty(record.userName)) {%><%
                                    StringHelper.filterHTML(out, record.userName); %><%} else { %>--<%} %></td>
            ...
            <form action="<%=controller.getURI(request, RechargePtbyj.class)%>" method="post" class="rechargeForm">
                <table class="jgzjcz_table">
                    ...
                    <tr>
                        ...
                        <td><textarea rows="4" cols="40" name="remark" class="border max-length-250"></textarea>
