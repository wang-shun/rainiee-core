...
<%@page import="com.dimeng.p2p.console.servlets.finance.zjgl.txgl.CheckWithdraw" %>
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=configureProvider.format(URLVariable.CHECKWITHDRAW_URL)%>" method="post" id="form1">
                    ...
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>放款审核
                            </div>
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <ul class="gray6">
                                ...
                                <li class="mb10">
                                    <div class="pl200 ml5">
                                        <a href="javascript:void(0)" onclick="check('<%=T6130_F09.YFK.name()%>')"
                                           class="btn btn-blue2 radius-6 pl20 pr20">提现成功</a>
                                        <a href="javascript:void(0)" onclick="check('<%=T6130_F09.TXSB.name()%>')"
                                           class="btn btn-blue2 ml40 radius-6 pl20 pr20">提现失败</a>
                                        <a href="<%=controller.getURI(request, Shtg.class)%>"
