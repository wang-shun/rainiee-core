                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td height="40">
                                            ...
                                            %>
                                            <a href="<%=controller.getURI(request, AddSkin.class)%>"
                                               class="btn3 mr10"><span class="ico1"></span>新增</a>
                                            <%} else {%>
                        ...
                        <div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                                ...
                                <tr class="dhsbg">
                                    ...
                                    <td>
                                        <%
                                            if (skin.location != null) {
                                                StringHelper.filterHTML(out, skin.location.getName());
                                            }
                                        %>
                                    </td>
                                    ...
                                    <td><%=DateTimeParser.format(skin.createTime)%>
                                    </td>
                                    <td><%=DateTimeParser.format(skin.lastUpdateTime)%>
                                    </td>
                                    <td><span>
										<%
                                            if (dimengSession.isAccessableResource(DelSkin.class)) {
                                        %>
										<a href="<%=controller.getURI(request, DelSkin.class)%>?id=<%=skin.id%>"
                                           class="mr10 blue">删除</a>
										<%} else { %>
                                        ...
                                        %>
										<a href="<%=controller.getURI(request, UpdateSkin.class)%>?id=<%=skin.id%>"
                                           class="mr10 blue">修改</a>
										<%
                                        } else {
                                        %>
