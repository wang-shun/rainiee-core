                ...
                <div class="p20">
                    <div class="border">
                        <div class="title-container">
                            <i class="icon-i w30 h30 va-middle title-left-icon"></i>修改信用认证项
                        </div>
                        <div class="content-container pl40 pt40 pr40 pb20">
                            <form action="<%=controller.getURI(request, ViewXyrzx.class)%>"
                                  method="post" class="form1">
                                <input name="F01" type="hidden" value="<%=entity.F01%>"/>
                                <ul class="gray6">
                                    <li class="mb10">
											<span class="display-ib w200 tr mr5">
												<span class="red">*</span>类型名称：
											</span>
                                        <input name="F02" type="text" maxlength="20"
                                    ...
                                    <li class="mb10">
                                     ...
                                     <%-- <li class="mb10">
											<span class="display-ib w200 tr mr5">
												...
												<span class="tir required"> <select name="F06"
                                                                                    class="yhgl_sel border">
                                                    <%
                                                        for (T5123_F06 t5123_F06 : T5123_F06.values()) {
                                                    %>
                                                    <option value="<%=t5123_F06.name()%>"
                                                            <%if (t5123_F06.name().equals(entity.F06.name())) {%>
