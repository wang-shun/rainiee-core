            ...
            <div class="r_main">
                <div class="home_main">
                    <div class="box box1 mb15">
                        ...
                        <div class="con">
                            <div class="clear"></div>
                            <form action="<%=controller.getURI(request, UpdateRank.class) %>" onsubmit="return check()"
                        	...
                        	<span class="tir required">
                          		<select name="F02" class="yhgl_sel" style="width:300px;">
                                    ...
                                    <option value="<%=entity.name()%>"  <%if (rank.F02 == entity) {%>
                                            selected="selected" <%} %>><%=entity.getChineseName()%>
                                    </option>
                                    <%}%>
                                </select>
                        	</span>
                        	...
                        	<span class="tir required">
                          		<select name="F03" class="yhgl_sel" style="width:300px;">
                                    ...
                                    <option value="<%=entity.name()%>" <%if (rank.F03 == entity) {%>
                                            selected="selected" <%} %>><%=entity.getChineseName()%>
                                    </option>
                                    <%}%>
                                </select>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="F04" type="text" class="text yhgl_ser" maxlength="18"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/"
                                                   mtestmsg="必须为数字格式(且是两位小数)" value="<%=rank.F04%>"/>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <input name="F05" type="text" class="text yhgl_ser" maxlength="18"
                                                   mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/"
                                                   mtestmsg="必须为数字格式(且是两位小数)" value="<%=rank.F05%>"/>
                        	...
                        	<span class="tir required">
                          		<select name="F06" class="yhgl_sel" style="width:300px;">
                                    ...
                                    <option value="<%=entity.name()%>" <%if (rank.F06 == entity) {%>
                                            selected="selected" <%} %>><%=entity.getChineseName()%>
                                    </option>
                                    <%}%>
                                </select>
